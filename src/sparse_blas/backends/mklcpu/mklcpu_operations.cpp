...
sycl::event optimize_gemv(sycl::queue& /*queue*/, oneapi::mkl::transpose /*transpose_val*/,
    ...
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "optimize_gemv");
}
...
sycl::event optimize_trmv(sycl::queue& /*queue*/, oneapi::mkl::uplo /*uplo_val*/,
                          ...
                          oneapi::mkl::sparse::detail::matrix_handle* /*handle*/,
                          const std::vector<sycl::event>& /*dependencies*/) {
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "optimize_trmv");
}
...
sycl::event optimize_trsv(sycl::queue& /*queue*/, oneapi::mkl::uplo /*uplo_val*/,
                          ...
                          oneapi::mkl::sparse::detail::matrix_handle* /*handle*/,
                          const std::vector<sycl::event>& /*dependencies*/) {
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "optimize_trsv");
}
...
std::enable_if_t<detail::is_fp_supported_v<fpType>> gemv(
    ...
    oneapi::mkl::sparse::detail::matrix_handle* /*A_handle*/, sycl::buffer<fpType, 1>& /*x*/,
    const fpType /*beta*/, sycl::buffer<fpType, 1>& /*y*/) {
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "gemv");
}

template <typename fpType>
std::enable_if_t<detail::is_fp_supported_v<fpType>, sycl::event> gemv(
    sycl::queue& /*queue*/, oneapi::mkl::transpose /*transpose_val*/, const fpType /*alpha*/,
    oneapi::mkl::sparse::detail::matrix_handle* /*A_handle*/, const fpType* /*x*/,
...
std::enable_if_t<detail::is_fp_supported_v<fpType>> gemvdot(
    ...
    oneapi::mkl::sparse::detail::matrix_handle* /*A_handle*/, sycl::buffer<fpType, 1>& /*x*/,
    fpType /*beta*/, sycl::buffer<fpType, 1>& /*y*/, sycl::buffer<fpType, 1>& /*d*/) {
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "gemvdot");
}

template <typename fpType>
std::enable_if_t<detail::is_fp_supported_v<fpType>, sycl::event> gemvdot(
    sycl::queue& /*queue*/, oneapi::mkl::transpose /*transpose_val*/, fpType /*alpha*/,
    oneapi::mkl::sparse::detail::matrix_handle* /*A_handle*/, fpType* /*x*/, fpType /*beta*/,
    fpType* /*y*/, fpType* /*d*/, const std::vector<sycl::event>& /*dependencies*/) {
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "gemvdot");
}
...
std::enable_if_t<detail::is_fp_supported_v<fpType>> symv(
    ...
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "symv");
}
...
std::enable_if_t<detail::is_fp_supported_v<fpType>> trmv(
    sycl::queue& /*queue*/, oneapi::mkl::uplo /*uplo_val*/,
    oneapi::mkl::transpose /*transpose_val*/, oneapi::mkl::diag /*diag_val*/, fpType /*alpha*/,
    oneapi::mkl::sparse::detail::matrix_handle* /*A_handle*/, sycl::buffer<fpType, 1>& /*x*/,
    fpType /*beta*/, sycl::buffer<fpType, 1>& /*y*/) {
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "trmv");
}
...
std::enable_if_t<detail::is_fp_supported_v<fpType>> trsv(
    ...
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "trsv");
}
...
std::enable_if_t<detail::is_fp_supported_v<fpType>, sycl::event> trsv(
    sycl::queue& /*queue*/, oneapi::mkl::uplo /*uplo_val*/,
    oneapi::mkl::transpose /*transpose_val*/, oneapi::mkl::diag /*diag_val*/,
    oneapi::mkl::sparse::detail::matrix_handle* /*A_handle*/, fpType* /*x*/, fpType* /*y*/,
    const std::vector<sycl::event>& /*dependencies*/) {
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "trsv");
}
...
std::enable_if_t<detail::is_fp_supported_v<fpType>> gemm(
    ...
    const fpType /*alpha*/, oneapi::mkl::sparse::detail::matrix_handle* /*A_handle*/,
    ...
    throw oneapi::mkl::unimplemented("SPARSE_BLAS", "gemm");
}
...
#define INSTANTIATE_OPERATIONS(FP_TYPE)                                                           \
    template std::enable_if_t<detail::is_fp_supported_v<FP_TYPE>> gemv(                           \
        ...
        oneapi::mkl::sparse::detail::matrix_handle* A_handle, sycl::buffer<FP_TYPE, 1>& x,        \
        const FP_TYPE beta, sycl::buffer<FP_TYPE, 1>& y);                                         \
    template std::enable_if_t<detail::is_fp_supported_v<FP_TYPE>, sycl::event> gemv(              \
        sycl::queue& queue, oneapi::mkl::transpose transpose_val, const FP_TYPE alpha,            \
        oneapi::mkl::sparse::detail::matrix_handle* A_handle, const FP_TYPE* x,                   \
        const FP_TYPE beta, const FP_TYPE* y, const std::vector<sycl::event>& dependencies);      \
    template std::enable_if_t<detail::is_fp_supported_v<FP_TYPE>> gemvdot(                        \
        sycl::queue& queue, oneapi::mkl::transpose transpose_val, FP_TYPE alpha,                  \
        oneapi::mkl::sparse::detail::matrix_handle* A_handle, sycl::buffer<FP_TYPE, 1>& x,        \
        FP_TYPE beta, sycl::buffer<FP_TYPE, 1>& y, sycl::buffer<FP_TYPE, 1>& d);                  \
    template std::enable_if_t<detail::is_fp_supported_v<FP_TYPE>, sycl::event> gemvdot(           \
        sycl::queue& queue, oneapi::mkl::transpose transpose_val, FP_TYPE alpha,                  \
        oneapi::mkl::sparse::detail::matrix_handle* A_handle, FP_TYPE* x, FP_TYPE beta,           \
    ...
    template std::enable_if_t<detail::is_fp_supported_v<FP_TYPE>> symv(                           \
        sycl::queue& queue, oneapi::mkl::uplo uplo_val, FP_TYPE alpha,                            \
        oneapi::mkl::sparse::detail::matrix_handle* A_handle, sycl::buffer<FP_TYPE, 1>& x,        \
        FP_TYPE beta, sycl::buffer<FP_TYPE, 1>& y);                                               \
    ...
    template std::enable_if_t<detail::is_fp_supported_v<FP_TYPE>> trmv(                           \
        ...
        oneapi::mkl::diag diag_val, FP_TYPE alpha,                                                \
        oneapi::mkl::sparse::detail::matrix_handle* A_handle, sycl::buffer<FP_TYPE, 1>& x,        \
        FP_TYPE beta, sycl::buffer<FP_TYPE, 1>& y);                                               \
    ...
    template std::enable_if_t<detail::is_fp_supported_v<FP_TYPE>> trsv(                           \
        sycl::queue& queue, oneapi::mkl::uplo uplo_val, oneapi::mkl::transpose transpose_val,     \
        oneapi::mkl::diag diag_val, oneapi::mkl::sparse::detail::matrix_handle* A_handle,         \
        sycl::buffer<FP_TYPE, 1>& x, sycl::buffer<FP_TYPE, 1>& y);                                \
    template std::enable_if_t<detail::is_fp_supported_v<FP_TYPE>, sycl::event> trsv(              \
        sycl::queue& queue, oneapi::mkl::uplo uplo_val, oneapi::mkl::transpose transpose_val,     \
        oneapi::mkl::diag diag_val, oneapi::mkl::sparse::detail::matrix_handle* A_handle,         \
        FP_TYPE* x, FP_TYPE* y, const std::vector<sycl::event>& dependencies);                    \
    template std::enable_if_t<detail::is_fp_supported_v<FP_TYPE>> gemm(                           \
        sycl::queue& queue, oneapi::mkl::layout dense_matrix_layout,                              \
        oneapi::mkl::transpose transpose_A, oneapi::mkl::transpose transpose_B,                   \
        const FP_TYPE alpha, oneapi::mkl::sparse::detail::matrix_handle* A_handle,                \
