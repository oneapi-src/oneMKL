...
/// \p workspace_buffer is an optional buffer given to the functor as a last
/// argument if UseWorkspace=true.
/// \p UseWorkspace must be true to use workspace_buffer.
