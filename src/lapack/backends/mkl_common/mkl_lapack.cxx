...
sycl::event gebrd(sycl::queue &queue, std::int64_t m, std::int64_t n, std::complex<float> *a,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gebrd(queue, m, n, a, lda, d, e, tauq, taup, scratchpad,
...
sycl::event gerqf(sycl::queue &queue, std::int64_t m, std::int64_t n, float *a, std::int64_t lda,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gerqf(queue, m, n, a, lda, tau, scratchpad, scratchpad_size,
                                        dependencies));
}
...
sycl::event geqrf(sycl::queue &queue, std::int64_t m, std::int64_t n, std::complex<float> *a,
                  std::int64_t lda, std::complex<float> *tau, std::complex<float> *scratchpad,
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::geqrf(queue, m, n, a, lda, tau, scratchpad, scratchpad_size,
                                        dependencies));
}
...
sycl::event getrf(sycl::queue &queue, std::int64_t m, std::int64_t n, std::complex<float> *a,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrf(queue, m, n, a, lda, ipiv, scratchpad, scratchpad_size,
                                        dependencies));
}
...
sycl::event getri(sycl::queue &queue, std::int64_t n, std::complex<float> *a, std::int64_t lda,
                  ...
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getri(queue, n, a, lda, ipiv, scratchpad, scratchpad_size,
                                        dependencies));
}
...
sycl::event getrs(sycl::queue &queue, oneapi::math::transpose trans, std::int64_t n,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::getrs(queue, detail::get_onemkl_transpose(trans), n, nrhs, a, lda, ipiv, b, ldb, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event getrs(sycl::queue &queue, oneapi::math::transpose trans, std::int64_t n,
...
sycl::event gesvd(sycl::queue &queue, oneapi::math::jobsvd jobu, oneapi::math::jobsvd jobvt,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::gesvd(queue, detail::get_onemkl_jobsvd(jobu), detail::get_onemkl_jobsvd(jobvt), m, n, a, lda, s, u, ldu, vt, ldvt,
...
sycl::event heevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
                  ...
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::heevd(queue, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, a, lda, w, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event heevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
...
sycl::event hegvd(sycl::queue &queue, std::int64_t itype, oneapi::math::job jobz,
                  ...
                  std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::hegvd(queue, itype, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, a, lda, b, ldb, w, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event hegvd(sycl::queue &queue, std::int64_t itype, oneapi::math::job jobz,
...
sycl::event hetrd(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::hetrd(queue, detail::get_onemkl_uplo(uplo), n, a, lda, d, e, tau, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event hetrd(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
...
sycl::event hetrf(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                  ...
                  std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::hetrf(queue, detail::get_onemkl_uplo(uplo), n, a, lda, ipiv, scratchpad, scratchpad_size,
                                        dependencies));
}
sycl::event hetrf(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
...
sycl::event orgbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgbr(queue, detail::get_onemkl_generate(vec), m, n, k, a, lda, tau, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event orgbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
...
sycl::event orgqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k, double *a,
                  ...
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgqr(queue, m, n, k, a, lda, tau, scratchpad, scratchpad_size,
                                        dependencies));
}
...
sycl::event orgtr(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, float *a,
                  std::int64_t lda, float *tau, float *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::orgtr(queue, detail::get_onemkl_uplo(uplo), n, a, lda, tau, scratchpad, scratchpad_size,
                                        dependencies));
}
...
sycl::event ormtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ormtr(queue, detail::get_onemkl_side(side), detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), m, n, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event ormtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
...
sycl::event ormrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ormrq(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event ormrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
...
sycl::event ormqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  ...
                  double *tau, double *c, std::int64_t ldc, double *scratchpad,
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ormqr(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event ormqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  std::int64_t m, std::int64_t n, std::int64_t k, float *a, std::int64_t lda,
...
sycl::event potrf(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, float *a,
                  ...
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrf(queue, detail::get_onemkl_uplo(uplo), n, a, lda, scratchpad, scratchpad_size,
                                        dependencies));
}
...
sycl::event potri(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, float *a,
                  std::int64_t lda, float *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potri(queue, detail::get_onemkl_uplo(uplo), n, a, lda, scratchpad, scratchpad_size,
                                        dependencies));
}
...
sycl::event potrs(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, std::int64_t nrhs,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::potrs(queue, detail::get_onemkl_uplo(uplo), n, nrhs, a, lda, b, ldb, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event potrs(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, std::int64_t nrhs,
...
sycl::event syevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::syevd(queue, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, a, lda, w, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event syevd(sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
...
sycl::event sygvd(sycl::queue &queue, std::int64_t itype, oneapi::math::job jobz,
                  ...
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sygvd(queue, itype, detail::get_onemkl_job(jobz), detail::get_onemkl_uplo(uplo), n, a, lda, b, ldb, w, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event sygvd(sycl::queue &queue, std::int64_t itype, oneapi::math::job jobz,
...
sycl::event sytrd(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, double *a,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sytrd(queue, detail::get_onemkl_uplo(uplo), n, a, lda, d, e, tau, scratchpad,
                                        scratchpad_size, dependencies));
}
...
sycl::event sytrf(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n, float *a,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::sytrf(queue, detail::get_onemkl_uplo(uplo), n, a, lda, ipiv, scratchpad, scratchpad_size,
                                        dependencies));
}
...
sycl::event trtrs(sycl::queue &queue, oneapi::math::uplo uplo, oneapi::math::transpose trans,
                  ...
                  std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::trtrs(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, nrhs, a, lda, b, ldb,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event trtrs(sycl::queue &queue, oneapi::math::uplo uplo, oneapi::math::transpose trans,
...
sycl::event ungbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
                  ...
                  std::complex<float> *tau, std::complex<float> *scratchpad,
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungbr(queue, detail::get_onemkl_generate(vec), m, n, k, a, lda, tau, scratchpad,
                                        scratchpad_size, dependencies));
}
sycl::event ungbr(sycl::queue &queue, oneapi::math::generate vec, std::int64_t m, std::int64_t n,
...
sycl::event ungqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
                  ...
                  std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungqr(queue, m, n, k, a, lda, tau, scratchpad, scratchpad_size,
                                        dependencies));
}
sycl::event ungqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
...
sycl::event ungtr(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                  ...
                  std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::ungtr(queue, detail::get_onemkl_uplo(uplo), n, a, lda, tau, scratchpad, scratchpad_size,
                                        dependencies));
}
sycl::event ungtr(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                  std::complex<double> *a, std::int64_t lda, std::complex<double> *tau,
...
sycl::event unmrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  ...
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::unmrq(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event unmrq(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
...
sycl::event unmqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  ...
                  std::int64_t ldc, std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::unmqr(queue, detail::get_onemkl_side(side), detail::get_onemkl_transpose(trans), m, n, k, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event unmqr(sycl::queue &queue, oneapi::math::side side, oneapi::math::transpose trans,
                  std::int64_t m, std::int64_t n, std::int64_t k, std::complex<double> *a,
...
sycl::event unmtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
                  ...
                  std::int64_t scratchpad_size, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(::oneapi::mkl::lapack::unmtr(queue, detail::get_onemkl_side(side), detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), m, n, a, lda, tau, c, ldc,
                                        scratchpad, scratchpad_size, dependencies));
}
sycl::event unmtr(sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
                  oneapi::math::transpose trans, std::int64_t m, std::int64_t n,
