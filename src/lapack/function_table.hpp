...
typedef struct {
    ...
    sycl::event (*zgetri_usm_sycl)(sycl::queue &queue, std::int64_t n, std::complex<double> *a,
                                   ...
                                   std::complex<double> *scratchpad, std::int64_t scratchpad_size,
                                   const std::vector<sycl::event> &dependencies);
    sycl::event (*cgetrs_usm_sycl)(sycl::queue &queue, oneapi::math::transpose trans, std::int64_t n,
                                   std::int64_t nrhs, std::complex<float> *a, std::int64_t lda,
                                   std::int64_t *ipiv, std::complex<float> *b, std::int64_t ldb,
                                   std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                                   const std::vector<sycl::event> &dependencies);
    sycl::event (*dgetrs_usm_sycl)(sycl::queue &queue, oneapi::math::transpose trans, std::int64_t n,
                                   ...
                                   const std::vector<sycl::event> &dependencies);
    sycl::event (*sgetrs_usm_sycl)(sycl::queue &queue, oneapi::math::transpose trans, std::int64_t n,
                                   std::int64_t nrhs, float *a, std::int64_t lda,
                                   std::int64_t *ipiv, float *b, std::int64_t ldb,
                                   float *scratchpad, std::int64_t scratchpad_size,
                                   const std::vector<sycl::event> &dependencies);
    sycl::event (*zgetrs_usm_sycl)(sycl::queue &queue, oneapi::math::transpose trans, std::int64_t n,
    ...
    sycl::event (*dorgqr_batch_usm_sycl)(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                         ...
                                         double *scratchpad, std::int64_t scratchpad_size,
                                         const std::vector<sycl::event> &dependencies);
    sycl::event (*spotrf_batch_usm_sycl)(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                                         float *a, std::int64_t lda, std::int64_t stride_a,
                                         std::int64_t batch_size, float *scratchpad,
                                         std::int64_t scratchpad_size,
                                         const std::vector<sycl::event> &dependencies);
    sycl::event (*dpotrf_batch_usm_sycl)(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                                         double *a, std::int64_t lda, std::int64_t stride_a,
                                         std::int64_t batch_size, double *scratchpad,
                                         std::int64_t scratchpad_size,
                                         const std::vector<sycl::event> &dependencies);
    sycl::event (*cpotrf_batch_usm_sycl)(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                                         std::complex<float> *a, std::int64_t lda,
                                         std::int64_t stride_a, std::int64_t batch_size,
                                         std::complex<float> *scratchpad,
                                         std::int64_t scratchpad_size,
                                         const std::vector<sycl::event> &dependencies);
    sycl::event (*zpotrf_batch_usm_sycl)(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                                         std::complex<double> *a, std::int64_t lda,
                                         std::int64_t stride_a, std::int64_t batch_size,
                                         std::complex<double> *scratchpad,
                                         std::int64_t scratchpad_size,
                                         const std::vector<sycl::event> &dependencies);
    sycl::event (*spotrs_batch_usm_sycl)(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                                         std::int64_t nrhs, float *a, std::int64_t lda,
                                         std::int64_t stride_a, float *b, std::int64_t ldb,
                                         std::int64_t stride_b, std::int64_t batch_size,
                                         float *scratchpad, std::int64_t scratchpad_size,
                                         const std::vector<sycl::event> &dependencies);
    sycl::event (*dpotrs_batch_usm_sycl)(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                                         std::int64_t nrhs, double *a, std::int64_t lda,
                                         std::int64_t stride_a, double *b, std::int64_t ldb,
                                         std::int64_t stride_b, std::int64_t batch_size,
                                         double *scratchpad, std::int64_t scratchpad_size,
                                         const std::vector<sycl::event> &dependencies);
    sycl::event (*cpotrs_batch_usm_sycl)(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
                                         ...
                                         std::int64_t scratchpad_size,
                                         const std::vector<sycl::event> &dependencies);
    sycl::event (*zpotrs_batch_usm_sycl)(sycl::queue &queue, oneapi::math::uplo uplo, std::int64_t n,
