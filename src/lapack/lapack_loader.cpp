...
sycl::event gesvd(oneapi::math::device libkey, sycl::queue &queue, oneapi::math::jobsvd jobu,
                  oneapi::math::jobsvd jobvt, std::int64_t m, std::int64_t n, std::complex<float> *a,
...
template <>
std::int64_t trtrs_scratchpad_size<std::complex<double>>(oneapi::math::device libkey,
                                                         sycl::queue &queue, oneapi::math::uplo uplo,
                                                         oneapi::math::transpose trans,
                                                         oneapi::math::diag diag, std::int64_t n,
                                                         std::int64_t nrhs, std::int64_t lda,
...
template <>
std::int64_t unmrq_scratchpad_size<std::complex<double>>(oneapi::math::device libkey,
                                                         sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
...
template <>
std::int64_t unmqr_scratchpad_size<std::complex<double>>(oneapi::math::device libkey,
                                                         sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
...
template <>
std::int64_t unmtr_scratchpad_size<std::complex<double>>(oneapi::math::device libkey,
                                                         sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::uplo uplo,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
