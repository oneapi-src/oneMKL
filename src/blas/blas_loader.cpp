...
void asum(oneapi::math::device libkey, sycl::queue &queue, std::int64_t n, sycl::buffer<float, 1> &x,
...
void axpy(oneapi::math::device libkey, sycl::queue &queue, std::int64_t n, std::complex<float> alpha,
          sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
...
void copy(oneapi::math::device libkey, sycl::queue &queue, std::int64_t n, sycl::buffer<float, 1> &x,
...
void dot(oneapi::math::device libkey, sycl::queue &queue, std::int64_t n, sycl::buffer<double, 1> &x,
...
void nrm2(oneapi::math::device libkey, sycl::queue &queue, std::int64_t n, sycl::buffer<float, 1> &x,
          std::int64_t incx, sycl::buffer<float, 1> &result) {
...
void rot(oneapi::math::device libkey, sycl::queue &queue, std::int64_t n, sycl::buffer<double, 1> &x,
...
void rotm(oneapi::math::device libkey, sycl::queue &queue, std::int64_t n, sycl::buffer<float, 1> &x,
          std::int64_t incx, sycl::buffer<float, 1> &y, std::int64_t incy,
...
void scal(oneapi::math::device libkey, sycl::queue &queue, std::int64_t n, std::complex<float> alpha,
          sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx) {
...
void swap(oneapi::math::device libkey, sycl::queue &queue, std::int64_t n, sycl::buffer<float, 1> &x,
          std::int64_t incx, sycl::buffer<float, 1> &y, std::int64_t incy) {
...
void omatcopy_batch(oneapi::math::device libkey, sycl::queue &queue, transpose trans, std::int64_t m,
                    std::int64_t n, float alpha, sycl::buffer<float, 1> &a, std::int64_t lda,
...
void imatcopy_batch(oneapi::math::device libkey, sycl::queue &queue, transpose trans, std::int64_t m,
...
sycl::event axpy_batch(oneapi::math::device libkey, sycl::queue &queue, std::int64_t n, double alpha,
...
sycl::event gemm(oneapi::math::device libkey, sycl::queue &queue, transpose transa, transpose transb,
...
sycl::event her2k(oneapi::math::device libkey, sycl::queue &queue, uplo upper_lower, transpose trans,
                  std::int64_t n, std::int64_t k, std::complex<float> alpha,
                  const std::complex<float> *a, std::int64_t lda, const std::complex<float> *b,
...
sycl::event syr2k(oneapi::math::device libkey, sycl::queue &queue, uplo upper_lower, transpose trans,
                  std::int64_t n, std::int64_t k, float alpha, const float *a, std::int64_t lda,
                  const float *b, std::int64_t ldb, float beta, float *c, std::int64_t ldc,
                  const std::vector<sycl::event> &dependencies) {
