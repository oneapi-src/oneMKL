...
typedef struct {
    ...
    void (*column_major_sasum_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<float, 1> &x, std::int64_t incx,
                                    sycl::buffer<float, 1> &result);
    void (*column_major_dasum_sycl)(sycl::queue &queue, std::int64_t n,
    ...
    void (*column_major_caxpy_sycl)(sycl::queue &queue, std::int64_t n,
                                    std::complex<float> alpha,
                                    sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                    sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy);
    void (*column_major_zaxpy_sycl)(sycl::queue &queue, std::int64_t n,
                                    std::complex<double> alpha,
                                    sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                    sycl::buffer<std::complex<double>, 1> &y,
                                    std::int64_t incy);
    void (*column_major_saxpy_batch_strided_sycl)(sycl::queue &queue, std::int64_t n,
                                                  float alpha, sycl::buffer<float, 1> &x,
                                                  std::int64_t incx, std::int64_t stridex,
                                                  sycl::buffer<float, 1> &y, std::int64_t incy,
                                                  std::int64_t stridey, std::int64_t batch_size);
    void (*column_major_daxpy_batch_strided_sycl)(sycl::queue &queue, std::int64_t n,
                                                  double alpha, sycl::buffer<double, 1> &x,
                                                  std::int64_t incx, std::int64_t stridex,
                                                  sycl::buffer<double, 1> &y, std::int64_t incy,
                                                  std::int64_t stridey, std::int64_t batch_size);
    ...
    void (*column_major_daxpby_sycl)(sycl::queue &queue, std::int64_t n, double alpha,
                                     ...
                                     sycl::buffer<double, 1> &y, std::int64_t incy);
    void (*column_major_caxpby_sycl)(sycl::queue &queue, std::int64_t n,
                                     std::complex<float> alpha,
                                     sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                     std::complex<float> beta,
                                     sycl::buffer<std::complex<float>, 1> &y,
                                     std::int64_t incy);
    void (*column_major_zaxpby_sycl)(sycl::queue &queue, std::int64_t n,
                                     std::complex<double> alpha,
                                     sycl::buffer<std::complex<double>, 1> &x,
                                     std::int64_t incx, std::complex<double> beta,
                                     sycl::buffer<std::complex<double>, 1> &y,
                                     std::int64_t incy);
    void (*column_major_scopy_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<float, 1> &x, std::int64_t incx,
                                    sycl::buffer<float, 1> &y, std::int64_t incy);
    void (*column_major_dcopy_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<double, 1> &x, std::int64_t incx,
                                    sycl::buffer<double, 1> &y, std::int64_t incy);
    ...
    void (*column_major_zcopy_batch_strided_sycl)(sycl::queue &queue, std::int64_t n,
                                                  ...
                                                  std::int64_t incy, std::int64_t stridey,
                                                  std::int64_t batch_size);
    void (*column_major_sdot_sycl)(sycl::queue &queue, std::int64_t n,
                                   sycl::buffer<float, 1> &x, std::int64_t incx,
                                   sycl::buffer<float, 1> &y, std::int64_t incy,
                                   sycl::buffer<float, 1> &result);
    void (*column_major_ddot_sycl)(sycl::queue &queue, std::int64_t n,
                                   sycl::buffer<double, 1> &x, std::int64_t incx,
                                   sycl::buffer<double, 1> &y, std::int64_t incy,
                                   sycl::buffer<double, 1> &result);
    void (*column_major_dsdot_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<float, 1> &x, std::int64_t incx,
                                    sycl::buffer<float, 1> &y, std::int64_t incy,
                                    sycl::buffer<double, 1> &result);
    ...
    void (*column_major_zdotu_sycl)(sycl::queue &queue, std::int64_t n,
                                    ...
                                    sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy,
                                    sycl::buffer<std::complex<double>, 1> &result);
    void (*column_major_isamin_sycl)(sycl::queue &queue, std::int64_t n,
                                     sycl::buffer<float, 1> &x, std::int64_t incx,
                                     sycl::buffer<std::int64_t, 1> &result);
    void (*column_major_idamin_sycl)(sycl::queue &queue, std::int64_t n,
                                     sycl::buffer<double, 1> &x, std::int64_t incx,
                                     sycl::buffer<std::int64_t, 1> &result);
    ...
    void (*column_major_isamax_sycl)(sycl::queue &queue, std::int64_t n,
                                     sycl::buffer<float, 1> &x, std::int64_t incx,
                                     sycl::buffer<std::int64_t, 1> &result);
    void (*column_major_idamax_sycl)(sycl::queue &queue, std::int64_t n,
                                     sycl::buffer<double, 1> &x, std::int64_t incx,
                                     sycl::buffer<std::int64_t, 1> &result);
    ...
    void (*column_major_dznrm2_sycl)(sycl::queue &queue, std::int64_t n,
                                     sycl::buffer<std::complex<double>, 1> &x,
                                     std::int64_t incx, sycl::buffer<double, 1> &result);
    void (*column_major_snrm2_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<float, 1> &x, std::int64_t incx,
                                    sycl::buffer<float, 1> &result);
    void (*column_major_dnrm2_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<double, 1> &x, std::int64_t incx,
                                    sycl::buffer<double, 1> &result);
    ...
    void (*column_major_drot_sycl)(sycl::queue &queue, std::int64_t n,
                                   ...
                                   sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy,
                                   double c, double s);
    void (*column_major_csrot_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<float, 1> &x, std::int64_t incx,
                                    sycl::buffer<float, 1> &y, std::int64_t incy, float c,
                                    float s);
    void (*column_major_zdrot_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<double, 1> &x, std::int64_t incx,
    ...
    void (*column_major_srotm_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<float, 1> &x, std::int64_t incx,
                                    sycl::buffer<float, 1> &y, std::int64_t incy,
                                    sycl::buffer<float, 1> &param);
    void (*column_major_drotm_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<double, 1> &x, std::int64_t incx,
                                    sycl::buffer<double, 1> &y, std::int64_t incy,
    ...
    void (*column_major_dscal_sycl)(sycl::queue &queue, std::int64_t n, double alpha,
                                    sycl::buffer<double, 1> &x, std::int64_t incx);
    void (*column_major_cscal_sycl)(sycl::queue &queue, std::int64_t n,
                                    std::complex<float> alpha,
                                    sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx);
    void (*column_major_csscal_sycl)(sycl::queue &queue, std::int64_t n,
                                     std::complex<double> alpha,
                                     sycl::buffer<std::complex<double>, 1> &x,
                                     std::int64_t incx);
    ...
    void (*column_major_sdsdot_sycl)(sycl::queue &queue, std::int64_t n, float sb,
                                     ...
                                     sycl::buffer<float, 1> &y, std::int64_t incy,
                                     sycl::buffer<float, 1> &result);
    void (*column_major_sswap_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<float, 1> &x, std::int64_t incx,
                                    sycl::buffer<float, 1> &y, std::int64_t incy);
    void (*column_major_dswap_sycl)(sycl::queue &queue, std::int64_t n,
                                    sycl::buffer<double, 1> &x, std::int64_t incx,
                                    sycl::buffer<double, 1> &y, std::int64_t incy);
    ...
    void (*column_major_sgbmv_sycl)(sycl::queue &queue, oneapi::mkl::transpose trans,
                                    ...
                                    std::int64_t lda, sycl::buffer<float, 1> &x,
    ...
    void (*column_major_zgemv_sycl)(sycl::queue &queue, oneapi::mkl::transpose trans,
                                    ...
                                    sycl::buffer<std::complex<double>, 1> &y,
                                    std::int64_t incy);
    void (*column_major_sgemv_batch_strided_sycl)(
        ...
        std::int64_t batch_size);
    void (*column_major_dgemv_batch_strided_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
    ...
    void (*column_major_zgemv_batch_strided_sycl)(
        ...
        std::int64_t batch_size);
    void (*column_major_sdgmm_batch_strided_sycl)(sycl::queue &queue,
                                                  oneapi::mkl::side left_right, std::int64_t m,
    ...
    void (*column_major_ddgmm_batch_strided_sycl)(sycl::queue &queue,
                                                  oneapi::mkl::side left_right, std::int64_t m,
    ...
    void (*column_major_zdgmm_batch_strided_sycl)(
        ...
        std::int64_t batch_size);
    void (*column_major_sger_sycl)(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                   float alpha, sycl::buffer<float, 1> &x, std::int64_t incx,
                                   sycl::buffer<float, 1> &y, std::int64_t incy,
                                   sycl::buffer<float, 1> &a, std::int64_t lda);
    void (*column_major_dger_sycl)(sycl::queue &queue, std::int64_t m, std::int64_t n,
    ...
    void (*column_major_sgemm_sycl)(sycl::queue &queue, oneapi::mkl::transpose transa,
                                    ...
                                    std::int64_t lda, sycl::buffer<float, 1> &b,
    ...
    void (*column_major_dgemm_sycl)(sycl::queue &queue, oneapi::mkl::transpose transa,
                                    ...
                                    std::int64_t lda, sycl::buffer<double, 1> &b,
    ...
    sycl::event (*column_major_scasum_usm_sycl)(
    ...
    sycl::event (*column_major_dzasum_usm_sycl)(
    ...
    sycl::event (*column_major_sasum_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const float *x, std::int64_t incx, float *result,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dasum_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const double *x, std::int64_t incx, double *result,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_saxpy_usm_sycl)(
    ...
    sycl::event (*column_major_daxpy_usm_sycl)(
    ...
    sycl::event (*column_major_caxpy_usm_sycl)(
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zaxpy_usm_sycl)(
    ...
    sycl::event (*column_major_daxpy_batch_group_usm_sycl)(
        sycl::queue &queue, std::int64_t *n, double *alpha, const double **x,
    ...
    sycl::event (*column_major_scopy_batch_strided_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const float *x, std::int64_t incx,
        std::int64_t stridex, float *y, std::int64_t incy, std::int64_t stridey,
        std::int64_t batch_size, const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*column_major_zcopy_batch_strided_usm_sycl)(
        ...
        std::int64_t batch_size, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sdot_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                  const float *x, std::int64_t incx, const float *y,
                                                  std::int64_t incy, float *result,
                                                  const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ddot_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                  const double *x, std::int64_t incx,
                                                  const double *y, std::int64_t incy,
                                                  double *result,
                                                  const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dsdot_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const float *x, std::int64_t incx, const float *y,
        std::int64_t incy, double *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_cdotc_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const std::complex<float> *x, std::int64_t incx,
        const std::complex<float> *y, std::int64_t incy, std::complex<float> *result,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zdotc_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const std::complex<double> *x, std::int64_t incx,
        const std::complex<double> *y, std::int64_t incy, std::complex<double> *result,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_cdotu_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const std::complex<float> *x, std::int64_t incx,
        const std::complex<float> *y, std::int64_t incy, std::complex<float> *result,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zdotu_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const std::complex<double> *x, std::int64_t incx,
        const std::complex<double> *y, std::int64_t incy, std::complex<double> *result,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_isamin_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const float *x, std::int64_t incx,
        std::int64_t *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_idamin_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const double *x, std::int64_t incx,
        std::int64_t *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_icamin_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const std::complex<float> *x, std::int64_t incx,
        std::int64_t *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_izamin_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const std::complex<double> *x, std::int64_t incx,
        std::int64_t *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_isamax_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const float *x, std::int64_t incx,
        std::int64_t *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_idamax_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const double *x, std::int64_t incx,
        std::int64_t *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_icamax_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const std::complex<float> *x, std::int64_t incx,
        std::int64_t *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_izamax_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const std::complex<double> *x, std::int64_t incx,
        std::int64_t *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_scnrm2_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const std::complex<float> *x, std::int64_t incx,
        float *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dznrm2_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const std::complex<double> *x, std::int64_t incx,
        double *result, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_snrm2_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const float *x, std::int64_t incx, float *result,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dnrm2_usm_sycl)(
        sycl::queue &queue, std::int64_t n, const double *x, std::int64_t incx, double *result,
        const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*column_major_drot_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                  ...
                                                  double c, double s,
                                                  const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_csrot_usm_sycl)(
        sycl::queue &queue, std::int64_t n, float *x, std::int64_t incx, float *y,
        std::int64_t incy, float c, float s, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zdrot_usm_sycl)(
        sycl::queue &queue, std::int64_t n, double *x, std::int64_t incx, double *y,
        std::int64_t incy, double c, double s, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_srotg_usm_sycl)(
        sycl::queue &queue, float *a, float *b, float *c, float *s,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_drotg_usm_sycl)(
        sycl::queue &queue, double *a, double *b, double *c, double *s,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_crotg_usm_sycl)(
        sycl::queue &queue, std::complex<float> *a, std::complex<float> *b, float *c,
        std::complex<float> *s, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zrotg_usm_sycl)(
        sycl::queue &queue, std::complex<double> *a, std::complex<double> *b, double *c,
        std::complex<double> *s, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_srotm_usm_sycl)(
        sycl::queue &queue, std::int64_t n, float *x, std::int64_t incx, float *y,
        std::int64_t incy, float *param, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_drotm_usm_sycl)(
        sycl::queue &queue, std::int64_t n, double *x, std::int64_t incx, double *y,
        std::int64_t incy, double *param, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_srotmg_usm_sycl)(
        sycl::queue &queue, float *d1, float *d2, float *x1, float y1, float *param,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_drotmg_usm_sycl)(
        sycl::queue &queue, double *d1, double *d2, double *x1, double y1, double *param,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sscal_usm_sycl)(
        sycl::queue &queue, std::int64_t n, float alpha, float *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dscal_usm_sycl)(
        sycl::queue &queue, std::int64_t n, double alpha, double *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_cscal_usm_sycl)(
        sycl::queue &queue, std::int64_t n, std::complex<float> alpha, std::complex<float> *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_csscal_usm_sycl)(
        sycl::queue &queue, std::int64_t n, std::complex<double> alpha, std::complex<double> *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zscal_usm_sycl)(
        sycl::queue &queue, std::int64_t n, float alpha, std::complex<float> *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zdscal_usm_sycl)(
        sycl::queue &queue, std::int64_t n, double alpha, std::complex<double> *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sdsdot_usm_sycl)(
        sycl::queue &queue, std::int64_t n, float sb, const float *x, std::int64_t incx,
        const float *y, std::int64_t incy, float *result,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sswap_usm_sycl)(
        sycl::queue &queue, std::int64_t n, float *x, std::int64_t incx, float *y,
        std::int64_t incy, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dswap_usm_sycl)(
        sycl::queue &queue, std::int64_t n, double *x, std::int64_t incx, double *y,
        std::int64_t incy, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_cswap_usm_sycl)(
        sycl::queue &queue, std::int64_t n, std::complex<float> *x, std::int64_t incx,
        std::complex<float> *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zswap_usm_sycl)(
        sycl::queue &queue, std::int64_t n, std::complex<double> *x, std::int64_t incx,
        std::complex<double> *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sgbmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dgbmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
    ...
    sycl::event (*column_major_cgbmv_usm_sycl)(
        ...
        std::complex<float> *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zgbmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sgemv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
        float alpha, const float *a, std::int64_t lda, const float *x, std::int64_t incx,
        float beta, float *y, std::int64_t incy, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dgemv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
    ...
    sycl::event (*column_major_zdgmm_batch_group_usm_sycl)(
        ...
        std::int64_t *group_size, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sger_usm_sycl)(sycl::queue &queue, std::int64_t m,
                                                  std::int64_t n, float alpha, const float *x,
                                                  std::int64_t incx, const float *y,
                                                  std::int64_t incy, float *a, std::int64_t lda,
                                                  const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dger_usm_sycl)(sycl::queue &queue, std::int64_t m,
                                                  std::int64_t n, double alpha, const double *x,
                                                  std::int64_t incx, const double *y,
                                                  std::int64_t incy, double *a, std::int64_t lda,
                                                  const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_cgerc_usm_sycl)(
        sycl::queue &queue, std::int64_t m, std::int64_t n, std::complex<float> alpha,
        const std::complex<float> *x, std::int64_t incx, const std::complex<float> *y,
        std::int64_t incy, std::complex<float> *a, std::int64_t lda,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zgerc_usm_sycl)(
        sycl::queue &queue, std::int64_t m, std::int64_t n, std::complex<double> alpha,
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_cgeru_usm_sycl)(
        sycl::queue &queue, std::int64_t m, std::int64_t n, std::complex<float> alpha,
        const std::complex<float> *x, std::int64_t incx, const std::complex<float> *y,
        std::int64_t incy, std::complex<float> *a, std::int64_t lda,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zgeru_usm_sycl)(
        sycl::queue &queue, std::int64_t m, std::int64_t n, std::complex<double> alpha,
        const std::complex<double> *x, std::int64_t incx, const std::complex<double> *y,
        std::int64_t incy, std::complex<double> *a, std::int64_t lda,
        const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*column_major_zhbmv_usm_sycl)(
        ...
        std::complex<double> *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_chemv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, std::int64_t n,
        std::complex<float> alpha, const std::complex<float> *a, std::int64_t lda,
        const std::complex<float> *x, std::int64_t incx, std::complex<float> beta,
        std::complex<float> *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zhemv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, std::int64_t n,
        std::complex<double> alpha, const std::complex<double> *a, std::int64_t lda,
        const std::complex<double> *x, std::int64_t incx, std::complex<double> beta,
        std::complex<double> *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_cher_usm_sycl)(sycl::queue &queue,
                                                  oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                  float alpha, const std::complex<float> *x,
                                                  std::int64_t incx, std::complex<float> *a,
                                                  std::int64_t lda,
                                                  const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zher_usm_sycl)(sycl::queue &queue,
                                                  oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                  double alpha, const std::complex<double> *x,
                                                  std::int64_t incx, std::complex<double> *a,
                                                  std::int64_t lda,
                                                  const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_cher2_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, std::int64_t n,
    ...
    sycl::event (*column_major_zher2_usm_sycl)(
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_chpmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, std::int64_t n,
    ...
    sycl::event (*column_major_zhpmv_usm_sycl)(
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_chpr_usm_sycl)(sycl::queue &queue,
                                                  oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                  float alpha, const std::complex<float> *x,
                                                  std::int64_t incx, std::complex<float> *a,
                                                  const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zhpr_usm_sycl)(sycl::queue &queue,
                                                  oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                  double alpha, const std::complex<double> *x,
                                                  std::int64_t incx, std::complex<double> *a,
                                                  const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_chpr2_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, std::int64_t n,
        std::complex<float> alpha, const std::complex<float> *x, std::int64_t incx,
        const std::complex<float> *y, std::int64_t incy, std::complex<float> *a,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zhpr2_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, std::int64_t n,
        std::complex<double> alpha, const std::complex<double> *x, std::int64_t incx,
        const std::complex<double> *y, std::int64_t incy, std::complex<double> *a,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ssbmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, std::int64_t n, std::int64_t k,
        float alpha, const float *a, std::int64_t lda, const float *x, std::int64_t incx,
        float beta, float *y, std::int64_t incy, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dsbmv_usm_sycl)(
        ...
        double beta, double *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sspmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, std::int64_t n, float alpha,
        const float *a, const float *x, std::int64_t incx, float beta, float *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dspmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, std::int64_t n, double alpha,
        const double *a, const double *x, std::int64_t incx, double beta, double *y,
        std::int64_t incy, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sspr_usm_sycl)(sycl::queue &queue,
                                                  oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                  float alpha, const float *x, std::int64_t incx,
                                                  float *a,
                                                  const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dspr_usm_sycl)(sycl::queue &queue,
                                                  oneapi::mkl::uplo upper_lower, std::int64_t n,
    ...
    sycl::event (*column_major_ctbmv_usm_sycl)(
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ztbmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_stbsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, std::int64_t k, const float *a,
        std::int64_t lda, float *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dtbsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, std::int64_t k, const double *a,
        std::int64_t lda, double *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ctbsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, std::int64_t k, const std::complex<float> *a,
        std::int64_t lda, std::complex<float> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ztbsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, std::int64_t k, const std::complex<double> *a,
        std::int64_t lda, std::complex<double> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_stpmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const float *a, float *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dtpmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const double *a, double *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ctpmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const std::complex<float> *a,
        std::complex<float> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ztpmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const std::complex<double> *a,
        std::complex<double> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_stpsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const float *a, float *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dtpsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const double *a, double *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ctpsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const std::complex<float> *a,
        std::complex<float> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ztpsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const std::complex<double> *a,
        std::complex<double> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_strmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const float *a, std::int64_t lda, float *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dtrmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const double *a, std::int64_t lda, double *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ctrmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const std::complex<float> *a, std::int64_t lda,
        std::complex<float> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ztrmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const std::complex<double> *a,
        std::int64_t lda, std::complex<double> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_strsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const float *a, std::int64_t lda, float *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dtrsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const double *a, std::int64_t lda, double *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ctrsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const std::complex<float> *a, std::int64_t lda,
        std::complex<float> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ztrsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const std::complex<double> *a,
        std::int64_t lda, std::complex<double> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sgemm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose transa, oneapi::mkl::transpose transb,
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dgemm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose transa, oneapi::mkl::transpose transb,
    ...
    sycl::event (*column_major_zgemm_usm_sycl)(
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_hgemm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose transa, oneapi::mkl::transpose transb,
    ...
    sycl::event (*column_major_zhemm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_cherk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zherk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
    ...
    sycl::event (*column_major_zher2k_usm_sycl)(
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ssymm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dsymm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
    ...
    sycl::event (*column_major_csymm_usm_sycl)(
        ...
        std::int64_t lda, const std::complex<float> *b, std::int64_t ldb, std::complex<float> beta,
        std::complex<float> *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zsymm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        std::int64_t m, std::int64_t n, std::complex<double> alpha, const std::complex<double> *a,
        std::int64_t lda, const std::complex<double> *b, std::int64_t ldb,
        std::complex<double> beta, std::complex<double> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ssyrk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
    ...
    sycl::event (*column_major_dsyrk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, double alpha, const double *a, std::int64_t lda,
        double beta, double *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_csyrk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, std::complex<float> alpha, const std::complex<float> *a,
        std::int64_t lda, std::complex<float> beta, std::complex<float> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zsyrk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, std::complex<double> alpha, const std::complex<double> *a,
    ...
    sycl::event (*column_major_zsyrk_batch_strided_usm_sycl)(
        ...
        std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_ssyr2k_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, float alpha, const float *a, std::int64_t lda,
        const float *b, std::int64_t ldb, float beta, float *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dsyr2k_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, double alpha, const double *a, std::int64_t lda,
        const double *b, std::int64_t ldb, double beta, double *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_csyr2k_usm_sycl)(
        ...
        std::int64_t lda, const std::complex<float> *b, std::int64_t ldb, std::complex<float> beta,
        std::complex<float> *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_zsyr2k_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, std::complex<double> alpha, const std::complex<double> *a,
        std::int64_t lda, const std::complex<double> *b, std::int64_t ldb,
        std::complex<double> beta, std::complex<double> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_strmm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        oneapi::mkl::transpose trans, oneapi::mkl::diag unit_diag, std::int64_t m, std::int64_t n,
        float alpha, const float *a, std::int64_t lda, float *b, std::int64_t ldb,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dtrmm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        oneapi::mkl::transpose trans, oneapi::mkl::diag unit_diag, std::int64_t m, std::int64_t n,
    ...
    sycl::event (*column_major_ztrmm_usm_sycl)(
        ...
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_strsm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        oneapi::mkl::transpose trans, oneapi::mkl::diag unit_diag, std::int64_t m, std::int64_t n,
        float alpha, const float *a, std::int64_t lda, float *b, std::int64_t ldb,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dtrsm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        oneapi::mkl::transpose trans, oneapi::mkl::diag unit_diag, std::int64_t m, std::int64_t n,
        double alpha, const double *a, std::int64_t lda, double *b, std::int64_t ldb,
        const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*column_major_hgemm_batch_strided_usm_sycl)(
        ...
        std::int64_t stride_c, std::int64_t batch_size,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_sgemmt_usm_sycl)(
        ...
        std::int64_t lda, const float *b, std::int64_t ldb, float beta, float *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*column_major_dgemmt_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose transa,
    ...
    void (*row_major_dzasum_sycl)(sycl::queue &queue, std::int64_t n,
                                  sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                  sycl::buffer<double, 1> &result);
    void (*row_major_sasum_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<float, 1> &x, std::int64_t incx,
                                 sycl::buffer<float, 1> &result);
    void (*row_major_dasum_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<double, 1> &x, std::int64_t incx,
                                 sycl::buffer<double, 1> &result);
    ...
    void (*row_major_caxpby_sycl)(sycl::queue &queue, std::int64_t n, std::complex<float> alpha,
                                  ...
                                  std::complex<float> beta,
                                  sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy);
    void (*row_major_zaxpby_sycl)(sycl::queue &queue, std::int64_t n,
                                  std::complex<double> alpha,
                                  sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                  std::complex<double> beta,
                                  sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy);
    void (*row_major_scopy_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<float, 1> &x, std::int64_t incx,
                                 sycl::buffer<float, 1> &y, std::int64_t incy);
    void (*row_major_dcopy_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<double, 1> &x, std::int64_t incx,
                                 sycl::buffer<double, 1> &y, std::int64_t incy);
    ...
    void (*row_major_zcopy_batch_strided_sycl)(sycl::queue &queue, std::int64_t n,
                                               ...
                                               std::int64_t incy, std::int64_t stridey,
                                               std::int64_t batch_size);
    void (*row_major_sdot_sycl)(sycl::queue &queue, std::int64_t n,
                                sycl::buffer<float, 1> &x, std::int64_t incx,
                                sycl::buffer<float, 1> &y, std::int64_t incy,
                                sycl::buffer<float, 1> &result);
    void (*row_major_ddot_sycl)(sycl::queue &queue, std::int64_t n,
                                sycl::buffer<double, 1> &x, std::int64_t incx,
                                sycl::buffer<double, 1> &y, std::int64_t incy,
                                sycl::buffer<double, 1> &result);
    void (*row_major_dsdot_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<float, 1> &x, std::int64_t incx,
                                 sycl::buffer<float, 1> &y, std::int64_t incy,
                                 sycl::buffer<double, 1> &result);
    ...
    void (*row_major_zdotu_sycl)(sycl::queue &queue, std::int64_t n,
                                 ...
                                 sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy,
                                 sycl::buffer<std::complex<double>, 1> &result);
    void (*row_major_isamin_sycl)(sycl::queue &queue, std::int64_t n,
                                  sycl::buffer<float, 1> &x, std::int64_t incx,
                                  sycl::buffer<std::int64_t, 1> &result);
    void (*row_major_idamin_sycl)(sycl::queue &queue, std::int64_t n,
                                  sycl::buffer<double, 1> &x, std::int64_t incx,
                                  sycl::buffer<std::int64_t, 1> &result);
    ...
    void (*row_major_izamin_sycl)(sycl::queue &queue, std::int64_t n,
                                  sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                  sycl::buffer<std::int64_t, 1> &result);
    void (*row_major_isamax_sycl)(sycl::queue &queue, std::int64_t n,
                                  sycl::buffer<float, 1> &x, std::int64_t incx,
                                  sycl::buffer<std::int64_t, 1> &result);
    void (*row_major_idamax_sycl)(sycl::queue &queue, std::int64_t n,
                                  sycl::buffer<double, 1> &x, std::int64_t incx,
                                  sycl::buffer<std::int64_t, 1> &result);
    ...
    void (*row_major_dznrm2_sycl)(sycl::queue &queue, std::int64_t n,
                                  sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                  sycl::buffer<double, 1> &result);
    void (*row_major_snrm2_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<float, 1> &x, std::int64_t incx,
                                 sycl::buffer<float, 1> &result);
    void (*row_major_dnrm2_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<double, 1> &x, std::int64_t incx,
                                 sycl::buffer<double, 1> &result);
    ...
    void (*row_major_drot_sycl)(sycl::queue &queue, std::int64_t n,
                                ...
                                sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy,
                                double c, double s);
    void (*row_major_csrot_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<float, 1> &x, std::int64_t incx,
                                 sycl::buffer<float, 1> &y, std::int64_t incy, float c,
                                 float s);
    void (*row_major_zdrot_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<double, 1> &x, std::int64_t incx,
                                 sycl::buffer<double, 1> &y, std::int64_t incy, double c,
                                 double s);
    ...
    void (*row_major_drotg_sycl)(sycl::queue &queue, sycl::buffer<double, 1> &a,
                                 sycl::buffer<double, 1> &b, sycl::buffer<double, 1> &c,
                                 sycl::buffer<double, 1> &s);
    void (*row_major_crotg_sycl)(sycl::queue &queue,
                                 sycl::buffer<std::complex<float>, 1> &a,
                                 sycl::buffer<std::complex<float>, 1> &b,
                                 sycl::buffer<float, 1> &c,
                                 sycl::buffer<std::complex<float>, 1> &s);
    void (*row_major_zrotg_sycl)(sycl::queue &queue,
                                 sycl::buffer<std::complex<double>, 1> &a,
                                 sycl::buffer<std::complex<double>, 1> &b,
                                 sycl::buffer<double, 1> &c,
                                 sycl::buffer<std::complex<double>, 1> &s);
    void (*row_major_srotm_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<float, 1> &x, std::int64_t incx,
                                 sycl::buffer<float, 1> &y, std::int64_t incy,
                                 sycl::buffer<float, 1> &param);
    void (*row_major_drotm_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<double, 1> &x, std::int64_t incx,
                                 sycl::buffer<double, 1> &y, std::int64_t incy,
                                 sycl::buffer<double, 1> &param);
    ...
    void (*row_major_cscal_sycl)(sycl::queue &queue, std::int64_t n, std::complex<float> alpha,
                                 sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx);
    void (*row_major_csscal_sycl)(sycl::queue &queue, std::int64_t n,
                                  std::complex<double> alpha,
                                  sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx);
    ...
    void (*row_major_sdsdot_sycl)(sycl::queue &queue, std::int64_t n, float sb,
                                  ...
                                  sycl::buffer<float, 1> &y, std::int64_t incy,
                                  sycl::buffer<float, 1> &result);
    void (*row_major_sswap_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<float, 1> &x, std::int64_t incx,
                                 sycl::buffer<float, 1> &y, std::int64_t incy);
    void (*row_major_dswap_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<double, 1> &x, std::int64_t incx,
                                 sycl::buffer<double, 1> &y, std::int64_t incy);
    ...
    void (*row_major_zswap_sycl)(sycl::queue &queue, std::int64_t n,
                                 sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                 sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy);
    void (*row_major_sgbmv_sycl)(sycl::queue &queue, oneapi::mkl::transpose trans,
                                 std::int64_t m, std::int64_t n, std::int64_t kl, std::int64_t ku,
                                 float alpha, sycl::buffer<float, 1> &a, std::int64_t lda,
                                 sycl::buffer<float, 1> &x, std::int64_t incx, float beta,
                                 sycl::buffer<float, 1> &y, std::int64_t incy);
    void (*row_major_dgbmv_sycl)(sycl::queue &queue, oneapi::mkl::transpose trans,
                                 std::int64_t m, std::int64_t n, std::int64_t kl, std::int64_t ku,
                                 double alpha, sycl::buffer<double, 1> &a, std::int64_t lda,
                                 sycl::buffer<double, 1> &x, std::int64_t incx, double beta,
                                 sycl::buffer<double, 1> &y, std::int64_t incy);
    void (*row_major_cgbmv_sycl)(sycl::queue &queue, oneapi::mkl::transpose trans,
                                 std::int64_t m, std::int64_t n, std::int64_t kl, std::int64_t ku,
                                 std::complex<float> alpha,
                                 sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda,
                                 sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                 std::complex<float> beta,
                                 sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy);
    void (*row_major_zgbmv_sycl)(sycl::queue &queue, oneapi::mkl::transpose trans,
                                 std::int64_t m, std::int64_t n, std::int64_t kl, std::int64_t ku,
                                 std::complex<double> alpha,
                                 sycl::buffer<std::complex<double>, 1> &a, std::int64_t lda,
                                 sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                 std::complex<double> beta,
                                 sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy);
    void (*row_major_sgemv_sycl)(sycl::queue &queue, oneapi::mkl::transpose trans,
                                 std::int64_t m, std::int64_t n, float alpha,
                                 sycl::buffer<float, 1> &a, std::int64_t lda,
                                 sycl::buffer<float, 1> &x, std::int64_t incx, float beta,
                                 sycl::buffer<float, 1> &y, std::int64_t incy);
    void (*row_major_dgemv_sycl)(sycl::queue &queue, oneapi::mkl::transpose trans,
                                 std::int64_t m, std::int64_t n, double alpha,
                                 sycl::buffer<double, 1> &a, std::int64_t lda,
                                 sycl::buffer<double, 1> &x, std::int64_t incx, double beta,
                                 sycl::buffer<double, 1> &y, std::int64_t incy);
    void (*row_major_cgemv_sycl)(sycl::queue &queue, oneapi::mkl::transpose trans,
                                 std::int64_t m, std::int64_t n, std::complex<float> alpha,
                                 sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda,
                                 sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                 std::complex<float> beta,
                                 sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy);
    void (*row_major_zgemv_sycl)(sycl::queue &queue, oneapi::mkl::transpose trans,
                                 std::int64_t m, std::int64_t n, std::complex<double> alpha,
                                 sycl::buffer<std::complex<double>, 1> &a, std::int64_t lda,
                                 sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                 std::complex<double> beta,
    ...
    void (*row_major_sger_sycl)(sycl::queue &queue, std::int64_t m, std::int64_t n, float alpha,
                                ...
                                sycl::buffer<float, 1> &y, std::int64_t incy,
                                sycl::buffer<float, 1> &a, std::int64_t lda);
    void (*row_major_dger_sycl)(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                double alpha, sycl::buffer<double, 1> &x, std::int64_t incx,
                                sycl::buffer<double, 1> &y, std::int64_t incy,
                                sycl::buffer<double, 1> &a, std::int64_t lda);
    ...
    void (*row_major_zgeru_sycl)(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                 ...
                                 sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy,
                                 sycl::buffer<std::complex<double>, 1> &a, std::int64_t lda);
    void (*row_major_chbmv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::int64_t k, std::complex<float> alpha,
                                 sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda,
                                 sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                 std::complex<float> beta,
                                 sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy);
    void (*row_major_zhbmv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::int64_t k, std::complex<double> alpha,
                                 sycl::buffer<std::complex<double>, 1> &a, std::int64_t lda,
                                 sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                 std::complex<double> beta,
                                 sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy);
    void (*row_major_chemv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::complex<float> alpha,
                                 sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda,
                                 sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                 std::complex<float> beta,
                                 sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy);
    void (*row_major_zhemv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::complex<double> alpha,
                                 sycl::buffer<std::complex<double>, 1> &a, std::int64_t lda,
                                 sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                 std::complex<double> beta,
                                 sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy);
    void (*row_major_cher_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                std::int64_t n, float alpha,
                                sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda);
    void (*row_major_zher_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                std::int64_t n, double alpha,
                                sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                sycl::buffer<std::complex<double>, 1> &a, std::int64_t lda);
    void (*row_major_cher2_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::complex<float> alpha,
                                 sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                 sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
                                 sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda);
    void (*row_major_zher2_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::complex<double> alpha,
                                 sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                 sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy,
                                 sycl::buffer<std::complex<double>, 1> &a, std::int64_t lda);
    void (*row_major_chpmv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::complex<float> alpha,
                                 sycl::buffer<std::complex<float>, 1> &a,
                                 sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                 std::complex<float> beta,
                                 sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy);
    void (*row_major_zhpmv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::complex<double> alpha,
                                 sycl::buffer<std::complex<double>, 1> &a,
                                 sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                 std::complex<double> beta,
                                 sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy);
    void (*row_major_chpr_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                std::int64_t n, float alpha,
                                sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                sycl::buffer<std::complex<float>, 1> &a);
    void (*row_major_zhpr_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                std::int64_t n, double alpha,
                                sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                sycl::buffer<std::complex<double>, 1> &a);
    void (*row_major_chpr2_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::complex<float> alpha,
                                 sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                                 sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
                                 sycl::buffer<std::complex<float>, 1> &a);
    void (*row_major_zhpr2_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::complex<double> alpha,
                                 sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
                                 sycl::buffer<std::complex<double>, 1> &y, std::int64_t incy,
                                 sycl::buffer<std::complex<double>, 1> &a);
    void (*row_major_ssbmv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::int64_t k, float alpha,
                                 sycl::buffer<float, 1> &a, std::int64_t lda,
                                 sycl::buffer<float, 1> &x, std::int64_t incx, float beta,
                                 sycl::buffer<float, 1> &y, std::int64_t incy);
    void (*row_major_dsbmv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, std::int64_t k, double alpha,
                                 sycl::buffer<double, 1> &a, std::int64_t lda,
                                 sycl::buffer<double, 1> &x, std::int64_t incx, double beta,
                                 sycl::buffer<double, 1> &y, std::int64_t incy);
    void (*row_major_sspmv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, float alpha, sycl::buffer<float, 1> &a,
                                 sycl::buffer<float, 1> &x, std::int64_t incx, float beta,
                                 sycl::buffer<float, 1> &y, std::int64_t incy);
    void (*row_major_dspmv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 ...
                                 sycl::buffer<double, 1> &x, std::int64_t incx, double beta,
                                 sycl::buffer<double, 1> &y, std::int64_t incy);
    void (*row_major_sspr_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
                                std::int64_t incx, sycl::buffer<float, 1> &a);
    void (*row_major_dspr_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                std::int64_t n, double alpha, sycl::buffer<double, 1> &x,
                                std::int64_t incx, sycl::buffer<double, 1> &a);
    void (*row_major_sspr2_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
                                 std::int64_t incx, sycl::buffer<float, 1> &y,
                                 std::int64_t incy, sycl::buffer<float, 1> &a);
    void (*row_major_dspr2_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, double alpha, sycl::buffer<double, 1> &x,
                                 std::int64_t incx, sycl::buffer<double, 1> &y,
                                 std::int64_t incy, sycl::buffer<double, 1> &a);
    void (*row_major_ssymv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, float alpha, sycl::buffer<float, 1> &a,
                                 std::int64_t lda, sycl::buffer<float, 1> &x, std::int64_t incx,
                                 float beta, sycl::buffer<float, 1> &y, std::int64_t incy);
    void (*row_major_dsymv_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, double alpha, sycl::buffer<double, 1> &a,
                                 std::int64_t lda, sycl::buffer<double, 1> &x,
                                 std::int64_t incx, double beta, sycl::buffer<double, 1> &y,
                                 std::int64_t incy);
    void (*row_major_ssyr_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
                                std::int64_t incx, sycl::buffer<float, 1> &a, std::int64_t lda);
    void (*row_major_dsyr_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                std::int64_t n, double alpha, sycl::buffer<double, 1> &x,
                                std::int64_t incx, sycl::buffer<double, 1> &a,
                                std::int64_t lda);
    void (*row_major_ssyr2_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
                                 std::int64_t incx, sycl::buffer<float, 1> &y,
                                 std::int64_t incy, sycl::buffer<float, 1> &a,
                                 std::int64_t lda);
    void (*row_major_dsyr2_sycl)(sycl::queue &queue, oneapi::mkl::uplo upper_lower,
                                 std::int64_t n, double alpha, sycl::buffer<double, 1> &x,
                                 std::int64_t incx, sycl::buffer<double, 1> &y,
                                 std::int64_t incy, sycl::buffer<double, 1> &a,
                                 std::int64_t lda);
    ...
    sycl::event (*row_major_dzasum_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                 ...
                                                 double *result,
                                                 const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_sasum_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                const float *x, std::int64_t incx, float *result,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dasum_usm_sycl)(sycl::queue &queue, std::int64_t n,
    ...
    sycl::event (*row_major_saxpy_usm_sycl)(sycl::queue &queue, std::int64_t n, float alpha,
                                                ...
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_daxpy_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                double alpha, const double *x, std::int64_t incx,
    ...
    sycl::event (*row_major_zaxpy_batch_strided_usm_sycl)(
        ...
        std::complex<double> *y, std::int64_t incy, std::int64_t stridey, std::int64_t batch_size,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_saxpby_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                 float alpha, const float *x, std::int64_t incx,
                                                 const float beta, float *y, std::int64_t incy,
                                                 const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_daxpby_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                 double alpha, const double *x, std::int64_t incx,
                                                 const double beta, double *y, std::int64_t incy,
                                                 const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*row_major_zaxpby_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                 ...
                                                 std::complex<double> *y, std::int64_t incy,
                                                 const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_scopy_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                const float *x, std::int64_t incx, float *y,
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dcopy_usm_sycl)(sycl::queue &queue, std::int64_t n,
    ...
    sycl::event (*row_major_zcopy_batch_strided_usm_sycl)(
        ...
        std::int64_t stridex, std::complex<double> *y, std::int64_t incy, std::int64_t stridey,
        std::int64_t batch_size, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_sdot_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                               const float *x, std::int64_t incx, const float *y,
                                               std::int64_t incy, float *result,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ddot_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                               const double *x, std::int64_t incx, const double *y,
                                               std::int64_t incy, double *result,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dsdot_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                const float *x, std::int64_t incx, const float *y,
                                                std::int64_t incy, double *result,
                                                const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*row_major_zdotu_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                ...
                                                std::complex<double> *result,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_isamin_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                 const float *x, std::int64_t incx,
                                                 std::int64_t *result,
                                                 const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_idamin_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                 const double *x, std::int64_t incx,
                                                 std::int64_t *result,
                                                 const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*row_major_izamin_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                 ...
                                                 std::int64_t *result,
                                                 const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_isamax_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                 const float *x, std::int64_t incx,
                                                 std::int64_t *result,
                                                 const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_idamax_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                 const double *x, std::int64_t incx,
                                                 std::int64_t *result,
                                                 const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*row_major_dznrm2_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                 ...
                                                 double *result,
                                                 const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_snrm2_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                const float *x, std::int64_t incx, float *result,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dnrm2_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                const double *x, std::int64_t incx, double *result,
                                                const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*row_major_zdrot_usm_sycl)(sycl::queue &queue, std::int64_t n, double *x,
                                                ...
                                                double c, double s,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_srotg_usm_sycl)(sycl::queue &queue, float *a, float *b,
                                                float *c, float *s,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_drotg_usm_sycl)(sycl::queue &queue, double *a, double *b,
                                                double *c, double *s,
                                                const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*row_major_drotm_usm_sycl)(sycl::queue &queue, std::int64_t n, double *x,
                                                ...
                                                double *param,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_srotmg_usm_sycl)(sycl::queue &queue, float *d1, float *d2,
                                                 float *x1, float y1, float *param,
                                                 const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_drotmg_usm_sycl)(sycl::queue &queue, double *d1, double *d2,
    ...
    sycl::event (*row_major_sscal_usm_sycl)(sycl::queue &queue, std::int64_t n, float alpha,
                                                ...
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dscal_usm_sycl)(sycl::queue &queue, std::int64_t n,
    ...
    sycl::event (*row_major_zscal_usm_sycl)(sycl::queue &queue, std::int64_t n, float alpha,
                                                std::complex<float> *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zdscal_usm_sycl)(sycl::queue &queue, std::int64_t n,
    ...
    sycl::event (*row_major_zswap_usm_sycl)(sycl::queue &queue, std::int64_t n,
                                                ...
                                                std::complex<double> *y, std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_sgbmv_usm_sycl)(sycl::queue &queue,
                                                ...
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dgbmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::transpose trans, std::int64_t m,
                                                std::int64_t n, std::int64_t kl, std::int64_t ku,
    ...
    sycl::event (*row_major_cgbmv_usm_sycl)(
        ...
        std::complex<float> *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zgbmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
        std::int64_t kl, std::int64_t ku, std::complex<double> alpha, const std::complex<double> *a,
        std::int64_t lda, const std::complex<double> *x, std::int64_t incx,
        std::complex<double> beta, std::complex<double> *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_sgemv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::transpose trans, std::int64_t m,
                                                std::int64_t n, float alpha, const float *a,
                                                std::int64_t lda, const float *x, std::int64_t incx,
                                                float beta, float *y, std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dgemv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::transpose trans, std::int64_t m,
                                                ...
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_cgemv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::transpose trans, std::int64_t m,
                                                std::int64_t n, std::complex<float> alpha,
                                                ...
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zgemv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::transpose trans, std::int64_t m,
                                                std::int64_t n, std::complex<double> alpha,
    ...
    sycl::event (*row_major_zdgmm_batch_group_usm_sycl)(
        ...
        std::int64_t *incx, std::complex<double> **c, std::int64_t *ldc, std::int64_t group_count,
        std::int64_t *group_size, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_sger_usm_sycl)(sycl::queue &queue, std::int64_t m,
                                               std::int64_t n, float alpha, const float *x,
                                               std::int64_t incx, const float *y, std::int64_t incy,
                                               float *a, std::int64_t lda,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dger_usm_sycl)(sycl::queue &queue, std::int64_t m,
                                               std::int64_t n, double alpha, const double *x,
                                               std::int64_t incx, const double *y,
                                               std::int64_t incy, double *a, std::int64_t lda,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_cgerc_usm_sycl)(sycl::queue &queue, std::int64_t m,
                                                std::int64_t n, std::complex<float> alpha,
                                                const std::complex<float> *x, std::int64_t incx,
                                                const std::complex<float> *y, std::int64_t incy,
                                                std::complex<float> *a, std::int64_t lda,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zgerc_usm_sycl)(sycl::queue &queue, std::int64_t m,
                                                std::int64_t n, std::complex<double> alpha,
                                                const std::complex<double> *x, std::int64_t incx,
                                                const std::complex<double> *y, std::int64_t incy,
                                                std::complex<double> *a, std::int64_t lda,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_cgeru_usm_sycl)(sycl::queue &queue, std::int64_t m,
                                                std::int64_t n, std::complex<float> alpha,
                                                const std::complex<float> *x, std::int64_t incx,
                                                const std::complex<float> *y, std::int64_t incy,
                                                std::complex<float> *a, std::int64_t lda,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zgeru_usm_sycl)(sycl::queue &queue, std::int64_t m,
                                                std::int64_t n, std::complex<double> alpha,
                                                const std::complex<double> *x, std::int64_t incx,
                                                const std::complex<double> *y, std::int64_t incy,
                                                std::complex<double> *a, std::int64_t lda,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_chbmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                std::int64_t k, std::complex<float> alpha,
                                                const std::complex<float> *a, std::int64_t lda,
                                                const std::complex<float> *x, std::int64_t incx,
                                                ...
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zhbmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                std::int64_t k, std::complex<double> alpha,
                                                const std::complex<double> *a, std::int64_t lda,
                                                const std::complex<double> *x, std::int64_t incx,
                                                ...
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_chemv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                std::complex<float> alpha,
                                                const std::complex<float> *a, std::int64_t lda,
                                                const std::complex<float> *x, std::int64_t incx,
                                                ...
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zhemv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                std::complex<double> alpha,
                                                const std::complex<double> *a, std::int64_t lda,
                                                const std::complex<double> *x, std::int64_t incx,
                                                ...
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_cher_usm_sycl)(sycl::queue &queue,
                                               oneapi::mkl::uplo upper_lower, std::int64_t n,
                                               float alpha, const std::complex<float> *x,
                                               std::int64_t incx, std::complex<float> *a,
                                               std::int64_t lda,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zher_usm_sycl)(sycl::queue &queue,
                                               oneapi::mkl::uplo upper_lower, std::int64_t n,
                                               double alpha, const std::complex<double> *x,
                                               std::int64_t incx, std::complex<double> *a,
                                               std::int64_t lda,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_cher2_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                std::complex<float> alpha,
                                                const std::complex<float> *x, std::int64_t incx,
                                                const std::complex<float> *y, std::int64_t incy,
                                                std::complex<float> *a, std::int64_t lda,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zher2_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                std::complex<double> alpha,
                                                const std::complex<double> *x, std::int64_t incx,
                                                const std::complex<double> *y, std::int64_t incy,
                                                std::complex<double> *a, std::int64_t lda,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_chpmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, std::int64_t n,
        std::complex<float> alpha, const std::complex<float> *a, const std::complex<float> *x,
        std::int64_t incx, std::complex<float> beta, std::complex<float> *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zhpmv_usm_sycl)(
        ...
        std::int64_t incx, std::complex<double> beta, std::complex<double> *y, std::int64_t incy,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_chpr_usm_sycl)(sycl::queue &queue,
                                               oneapi::mkl::uplo upper_lower, std::int64_t n,
                                               float alpha, const std::complex<float> *x,
                                               std::int64_t incx, std::complex<float> *a,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zhpr_usm_sycl)(sycl::queue &queue,
                                               oneapi::mkl::uplo upper_lower, std::int64_t n,
                                               double alpha, const std::complex<double> *x,
                                               std::int64_t incx, std::complex<double> *a,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_chpr2_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                std::complex<float> alpha,
                                                const std::complex<float> *x, std::int64_t incx,
                                                const std::complex<float> *y, std::int64_t incy,
                                                std::complex<float> *a,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zhpr2_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                std::complex<double> alpha,
                                                const std::complex<double> *x, std::int64_t incx,
                                                const std::complex<double> *y, std::int64_t incy,
                                                ...
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ssbmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                std::int64_t k, float alpha, const float *a,
                                                std::int64_t lda, const float *x, std::int64_t incx,
                                                float beta, float *y, std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dsbmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                ...
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_sspmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                float alpha, const float *a, const float *x,
                                                std::int64_t incx, float beta, float *y,
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dspmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                double alpha, const double *a, const double *x,
                                                std::int64_t incx, double beta, double *y,
                                                std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_sspr_usm_sycl)(sycl::queue &queue,
                                               oneapi::mkl::uplo upper_lower, std::int64_t n,
                                               float alpha, const float *x, std::int64_t incx,
                                               float *a,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dspr_usm_sycl)(sycl::queue &queue,
                                               oneapi::mkl::uplo upper_lower, std::int64_t n,
                                               double alpha, const double *x, std::int64_t incx,
                                               double *a,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_sspr2_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                float alpha, const float *x, std::int64_t incx,
                                                const float *y, std::int64_t incy, float *a,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dspr2_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                double alpha, const double *x, std::int64_t incx,
                                                const double *y, std::int64_t incy, double *a,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ssymv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                float alpha, const float *a, std::int64_t lda,
                                                const float *x, std::int64_t incx, float beta,
                                                float *y, std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dsymv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                double alpha, const double *a, std::int64_t lda,
                                                const double *x, std::int64_t incx, double beta,
                                                double *y, std::int64_t incy,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ssyr_usm_sycl)(sycl::queue &queue,
                                               oneapi::mkl::uplo upper_lower, std::int64_t n,
                                               float alpha, const float *x, std::int64_t incx,
                                               float *a, std::int64_t lda,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dsyr_usm_sycl)(sycl::queue &queue,
                                               oneapi::mkl::uplo upper_lower, std::int64_t n,
                                               double alpha, const double *x, std::int64_t incx,
                                               double *a, std::int64_t lda,
                                               const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ssyr2_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                float alpha, const float *x, std::int64_t incx,
                                                const float *y, std::int64_t incy, float *a,
                                                std::int64_t lda,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dsyr2_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower, std::int64_t n,
                                                double alpha, const double *x, std::int64_t incx,
                                                const double *y, std::int64_t incy, double *a,
                                                std::int64_t lda,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_stbmv_usm_sycl)(sycl::queue &queue,
                                                ...
                                                float *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dtbmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                ...
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ctbmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, std::int64_t k, const std::complex<float> *a,
        std::int64_t lda, std::complex<float> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ztbmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, std::int64_t k, const std::complex<double> *a,
        std::int64_t lda, std::complex<double> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_stbsv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                std::int64_t k, const float *a, std::int64_t lda,
                                                float *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dtbsv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                std::int64_t k, const double *a, std::int64_t lda,
                                                double *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ctbsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, std::int64_t k, const std::complex<float> *a,
        std::int64_t lda, std::complex<float> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ztbsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, std::int64_t k, const std::complex<double> *a,
        std::int64_t lda, std::complex<double> *x, std::int64_t incx,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_stpmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                const float *a, float *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dtpmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                const double *a, double *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ctpmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                ...
                                                std::complex<float> *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ztpmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                ...
                                                std::complex<double> *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_stpsv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                const float *a, float *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dtpsv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                const double *a, double *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ctpsv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                const std::complex<float> *a,
                                                std::complex<float> *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ztpsv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                const std::complex<double> *a,
                                                std::complex<double> *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_strmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const float *a, std::int64_t lda, float *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dtrmv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const double *a, std::int64_t lda, double *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ctrmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                const std::complex<float> *a, std::int64_t lda,
                                                std::complex<float> *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ztrmv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                const std::complex<double> *a, std::int64_t lda,
                                                std::complex<double> *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_strsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const float *a, std::int64_t lda, float *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dtrsv_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        oneapi::mkl::diag unit_diag, std::int64_t n, const double *a, std::int64_t lda, double *x,
        std::int64_t incx, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ctrsv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                const std::complex<float> *a, std::int64_t lda,
                                                std::complex<float> *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ztrsv_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::uplo upper_lower,
                                                oneapi::mkl::transpose trans,
                                                oneapi::mkl::diag unit_diag, std::int64_t n,
                                                const std::complex<double> *a, std::int64_t lda,
                                                std::complex<double> *x, std::int64_t incx,
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_sgemm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose transa, oneapi::mkl::transpose transb,
        std::int64_t m, std::int64_t n, std::int64_t k, float alpha, const float *a,
        std::int64_t lda, const float *b, std::int64_t ldb, float beta, float *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dgemm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose transa, oneapi::mkl::transpose transb,
        std::int64_t m, std::int64_t n, std::int64_t k, double alpha, const double *a,
        std::int64_t lda, const double *b, std::int64_t ldb, double beta, double *c,
        std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_cgemm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose transa, oneapi::mkl::transpose transb,
        std::int64_t m, std::int64_t n, std::int64_t k, std::complex<float> alpha,
        const std::complex<float> *a, std::int64_t lda, const std::complex<float> *b,
        std::int64_t ldb, std::complex<float> beta, std::complex<float> *c, std::int64_t ldc,
    ...
    sycl::event (*row_major_zgemm_usm_sycl)(
        ...
        std::int64_t ldb, std::complex<double> beta, std::complex<double> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_hgemm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::transpose transa, oneapi::mkl::transpose transb,
        std::int64_t m, std::int64_t n, std::int64_t k, sycl::half alpha, const sycl::half *a,
        std::int64_t lda, const sycl::half *b, std::int64_t ldb, sycl::half beta, sycl::half *c,
        std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*row_major_chemm_usm_sycl)(
        ...
        std::int64_t lda, const std::complex<float> *b, std::int64_t ldb, std::complex<float> beta,
        std::complex<float> *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zhemm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        std::int64_t m, std::int64_t n, std::complex<double> alpha, const std::complex<double> *a,
        std::int64_t lda, const std::complex<double> *b, std::int64_t ldb,
        std::complex<double> beta, std::complex<double> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_cherk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, float alpha, const std::complex<float> *a, std::int64_t lda,
        float beta, std::complex<float> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zherk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, double alpha, const std::complex<double> *a,
        std::int64_t lda, double beta, std::complex<double> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_cher2k_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, std::complex<float> alpha, const std::complex<float> *a,
        std::int64_t lda, const std::complex<float> *b, std::int64_t ldb, float beta,
        std::complex<float> *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zher2k_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, std::complex<double> alpha, const std::complex<double> *a,
        std::int64_t lda, const std::complex<double> *b, std::int64_t ldb, double beta,
        std::complex<double> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ssymm_usm_sycl)(sycl::queue &queue,
                                                ...
                                                const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dsymm_usm_sycl)(sycl::queue &queue,
                                                oneapi::mkl::side left_right,
                                                oneapi::mkl::uplo upper_lower, std::int64_t m,
                                                std::int64_t n, double alpha, const double *a,
    ...
    sycl::event (*row_major_csymm_usm_sycl)(
        ...
        std::int64_t lda, const std::complex<float> *b, std::int64_t ldb, std::complex<float> beta,
        std::complex<float> *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zsymm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        std::int64_t m, std::int64_t n, std::complex<double> alpha, const std::complex<double> *a,
        std::int64_t lda, const std::complex<double> *b, std::int64_t ldb,
        std::complex<double> beta, std::complex<double> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ssyrk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, float alpha, const float *a, std::int64_t lda, float beta,
        float *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dsyrk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, double alpha, const double *a, std::int64_t lda,
        double beta, double *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_csyrk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, std::complex<float> alpha, const std::complex<float> *a,
        std::int64_t lda, std::complex<float> beta, std::complex<float> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zsyrk_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, std::complex<double> alpha, const std::complex<double> *a,
        std::int64_t lda, std::complex<double> beta, std::complex<double> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*row_major_zsyrk_batch_strided_usm_sycl)(
        ...
        std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_ssyr2k_usm_sycl)(sycl::queue &queue,
                                                 oneapi::mkl::uplo upper_lower,
                                                 ...
                                                 float beta, float *c, std::int64_t ldc,
                                                 const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dsyr2k_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, double alpha, const double *a, std::int64_t lda,
        const double *b, std::int64_t ldb, double beta, double *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_csyr2k_usm_sycl)(
        ...
        std::int64_t lda, const std::complex<float> *b, std::int64_t ldb, std::complex<float> beta,
        std::complex<float> *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_zsyr2k_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose trans,
        std::int64_t n, std::int64_t k, std::complex<double> alpha, const std::complex<double> *a,
        std::int64_t lda, const std::complex<double> *b, std::int64_t ldb,
        std::complex<double> beta, std::complex<double> *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_strmm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        oneapi::mkl::transpose trans, oneapi::mkl::diag unit_diag, std::int64_t m, std::int64_t n,
        float alpha, const float *a, std::int64_t lda, float *b, std::int64_t ldb,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dtrmm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        oneapi::mkl::transpose trans, oneapi::mkl::diag unit_diag, std::int64_t m, std::int64_t n,
        double alpha, const double *a, std::int64_t lda, double *b, std::int64_t ldb,
        const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*row_major_ztrmm_usm_sycl)(
        ...
        std::complex<double> *b, std::int64_t ldb,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_strsm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        oneapi::mkl::transpose trans, oneapi::mkl::diag unit_diag, std::int64_t m, std::int64_t n,
        float alpha, const float *a, std::int64_t lda, float *b, std::int64_t ldb,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dtrsm_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::side left_right, oneapi::mkl::uplo upper_lower,
        oneapi::mkl::transpose trans, oneapi::mkl::diag unit_diag, std::int64_t m, std::int64_t n,
        double alpha, const double *a, std::int64_t lda, double *b, std::int64_t ldb,
        const std::vector<sycl::event> &dependencies);
    ...
    sycl::event (*row_major_hgemm_batch_strided_usm_sycl)(
        ...
        std::int64_t stride_c, std::int64_t batch_size,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_sgemmt_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose transa,
        oneapi::mkl::transpose transb, std::int64_t n, std::int64_t k, float alpha, const float *a,
        std::int64_t lda, const float *b, std::int64_t ldb, float beta, float *c, std::int64_t ldc,
        const std::vector<sycl::event> &dependencies);
    sycl::event (*row_major_dgemmt_usm_sycl)(
        sycl::queue &queue, oneapi::mkl::uplo upper_lower, oneapi::mkl::transpose transa,
        oneapi::mkl::transpose transb, std::int64_t n, std::int64_t k, double alpha,
        const double *a, std::int64_t lda, const double *b, std::int64_t ldb, double beta,
        double *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies);
