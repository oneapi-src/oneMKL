...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_sgemm>(cgh, [=]() {
            ::cblas_sgemm((CBLAS_LAYOUT)MKL_COL_MAJOR, transa_, transb_, m, n, k, alpha,
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dgemm>(cgh, [=]() {
            ::cblas_dgemm((CBLAS_LAYOUT)MKL_COL_MAJOR, transa_, transb_, m, n, k, alpha,
                          accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                          accessor_c.get_pointer(), ldc);
        });
    });
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cgemm>(cgh, [=]() {
            ...
            ::cblas_cgemm((CBLAS_LAYOUT)MKL_COL_MAJOR, transa_, transb_, m, n, k,
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zgemm>(cgh, [=]() {
            ...
            ::cblas_zgemm((CBLAS_LAYOUT)MKL_COL_MAJOR, transa_, transb_, m, n, k,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_hgemm>(cgh, [=]() {
            ...
            ::cblas_sgemm((CBLAS_LAYOUT)MKL_COL_MAJOR, transa_, transb_, m, n, k, f32_alpha, f32_a,
                          lda, f32_b, ldb, f32_beta, f32_c, ldc);
            // copy C back to half
            fp16 co = 0.0f;
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_gemm_f16f16f32>(cgh, [=]() {
            ...
            copy_mat(accessor_a, MKL_COL_MAJOR, transa, m, k, lda, 0.0f, f32_a);
            copy_mat(accessor_b, MKL_COL_MAJOR, transb, k, n, ldb, 0.0f, f32_b);
            ::cblas_sgemm((CBLAS_LAYOUT)MKL_COL_MAJOR, transa_, transb_, m, n, k, alpha, f32_a, lda,
                          f32_b, ldb, beta, accessor_c.get_pointer(), ldc);
            ::free(f32_a);
            ::free(f32_b);
        });
    });
...
void hemm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        CBLAS_SIDE left_right_ = (CBLAS_SIDE)cblas_convert(left_right);
        ...
        host_task<class mkl_kernel_chemm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_chemm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, m, n,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void hemm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zhemm>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zhemm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, m, n,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void herk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cherk>(cgh, [=]() {
            ::cblas_cherk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha,
...
void herk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zherk>(cgh, [=]() {
            ::cblas_zherk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha,
                          accessor_a.get_pointer(), lda, beta, accessor_c.get_pointer(), ldc);
        });
    });
}
...
void her2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cher2k>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            ::cblas_cher2k((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, beta, accessor_c.get_pointer(), ldc);
        });
    });
}
...
void her2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zher2k>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            ::cblas_zher2k((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, beta, accessor_c.get_pointer(), ldc);
        });
    });
...
void symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ssymm>(cgh, [=]() {
            ::cblas_ssymm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, m, n, alpha,
                          accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                          accessor_c.get_pointer(), ldc);
        });
    });
...
void symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dsymm>(cgh, [=]() {
            ::cblas_dsymm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, m, n, alpha,
                          accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                          accessor_c.get_pointer(), ldc);
        });
    });
...
void symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_csymm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_csymm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, m, n,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zsymm>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zsymm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, m, n,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ssyrk>(cgh, [=]() {
            ::cblas_ssyrk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha,
                          accessor_a.get_pointer(), lda, beta, accessor_c.get_pointer(), ldc);
        });
    });
}
...
void syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dsyrk>(cgh, [=]() {
            ::cblas_dsyrk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha,
                          accessor_a.get_pointer(), lda, beta, accessor_c.get_pointer(), ldc);
        });
    });
}
...
void syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_csyrk>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_csyrk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
...
void syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zsyrk>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zsyrk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          (const void *)&beta_, accessor_c.get_pointer(), ldc);
        });
    });
...
void syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ssyr2k>(cgh, [=]() {
            ::cblas_ssyr2k((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha,
                           accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                           accessor_c.get_pointer(), ldc);
        });
    });
...
void syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dsyr2k>(cgh, [=]() {
            ::cblas_dsyr2k((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha,
                           accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                           accessor_c.get_pointer(), ldc);
        });
    });
...
void syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_csyr2k>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_csyr2k((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, (const void *)&beta_,
                           accessor_c.get_pointer(), ldc);
        });
...
void syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zsyr2k>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zsyr2k((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, (const void *)&beta_,
                           accessor_c.get_pointer(), ldc);
        });
...
void trmm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_strmm>(cgh, [=]() {
            ::cblas_strmm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, alpha, accessor_a.get_pointer(), lda,
...
void trmm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dtrmm>(cgh, [=]() {
            ::cblas_dtrmm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, alpha, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trmm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ctrmm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            ::cblas_ctrmm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
}
...
void trmm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ztrmm>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            ::cblas_ztrmm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trsm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_strsm>(cgh, [=]() {
            ::cblas_strsm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, alpha, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trsm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dtrsm>(cgh, [=]() {
            ::cblas_dtrsm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, alpha, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trsm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ctrsm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            ::cblas_ctrsm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trsm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ztrsm>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            ::cblas_ztrsm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
cl::sycl::event gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_sgemm_usm>(cgh, [=]() {
            ::cblas_sgemm((CBLAS_LAYOUT)MKL_COL_MAJOR, transa_, transb_, m, n, k, alpha, a, lda, b,
                          ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dgemm_usm>(cgh, [=]() {
            ::cblas_dgemm((CBLAS_LAYOUT)MKL_COL_MAJOR, transa_, transb_, m, n, k, alpha, a, lda, b,
                          ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event herk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cherk_usm>(cgh, [=]() {
            ::cblas_cherk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                          beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event herk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zherk_usm>(cgh, [=]() {
            ::cblas_zherk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                          beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event her2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cher2k_usm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            ::cblas_cher2k((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k,
                           (const void *)&alpha_, a, lda, b, ldb, beta, c, ldc);
        });
    });
    return done;
}
...
cl::sycl::event symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ssymm_usm>(cgh, [=]() {
            ::cblas_ssymm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, m, n, alpha, a,
...
cl::sycl::event symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dsymm_usm>(cgh, [=]() {
            ::cblas_dsymm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, m, n, alpha, a,
                          lda, b, ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ssyrk_usm>(cgh, [=]() {
            ::cblas_ssyrk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                          beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dsyrk_usm>(cgh, [=]() {
            ::cblas_dsyrk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                          beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_csyrk_usm>(cgh, [=]() {
            ...
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_csyrk((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k,
                          (const void *)&alpha_, a, lda, (const void *)&beta_, c, ldc);
        });
    });
    return done;
}
...
cl::sycl::event syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ssyr2k_usm>(cgh, [=]() {
            ::cblas_ssyr2k((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                           b, ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dsyr2k_usm>(cgh, [=]() {
            ::cblas_dsyr2k((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                           b, ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event trmm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_strmm_usm>(cgh, [=]() {
            ::cblas_strmm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, alpha, a, lda, b, ldb);
        });
    });
    return done;
}
...
cl::sycl::event trmm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ctrmm_usm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            ::cblas_ctrmm((CBLAS_LAYOUT)MKL_COL_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, (const void *)&alpha_, a, lda, b, ldb);
        });
    });
    return done;
}
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_sgemm>(cgh, [=]() {
            ::cblas_sgemm((CBLAS_LAYOUT)MKL_ROW_MAJOR, transa_, transb_, m, n, k, alpha,
                          accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                          accessor_c.get_pointer(), ldc);
        });
    });
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_dgemm>(cgh, [=]() {
            ::cblas_dgemm((CBLAS_LAYOUT)MKL_ROW_MAJOR, transa_, transb_, m, n, k, alpha,
                          accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                          accessor_c.get_pointer(), ldc);
        });
    });
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cgemm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_cgemm((CBLAS_LAYOUT)MKL_ROW_MAJOR, transa_, transb_, m, n, k,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zgemm>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zgemm((CBLAS_LAYOUT)MKL_ROW_MAJOR, transa_, transb_, m, n, k,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_hgemm>(cgh, [=]() {
            ...
            ::cblas_sgemm((CBLAS_LAYOUT)MKL_ROW_MAJOR, transa_, transb_, m, n, k, f32_alpha, f32_a,
                          lda, f32_b, ldb, f32_beta, f32_c, ldc);
            // copy C back to half
            fp16 co = 0.0f;
...
void gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_gemm_f16f16f32>(cgh, [=]() {
            ...
            copy_mat(accessor_a, MKL_ROW_MAJOR, transa, m, k, lda, 0.0f, f32_a);
            copy_mat(accessor_b, MKL_ROW_MAJOR, transb, k, n, ldb, 0.0f, f32_b);
            ::cblas_sgemm((CBLAS_LAYOUT)MKL_ROW_MAJOR, transa_, transb_, m, n, k, alpha, f32_a, lda,
                          f32_b, ldb, beta, accessor_c.get_pointer(), ldc);
            ::free(f32_a);
            ::free(f32_b);
        });
...
void hemm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_chemm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_chemm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, m, n,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void hemm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zhemm>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zhemm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, m, n,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void herk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_cherk>(cgh, [=]() {
            ::cblas_cherk((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha,
                          accessor_a.get_pointer(), lda, beta, accessor_c.get_pointer(), ldc);
        });
    });
}
...
void herk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_zherk>(cgh, [=]() {
            ::cblas_zherk((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha,
                          accessor_a.get_pointer(), lda, beta, accessor_c.get_pointer(), ldc);
        });
    });
}
...
void her2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cher2k>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            ::cblas_cher2k((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, beta, accessor_c.get_pointer(), ldc);
        });
    });
...
void her2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zher2k>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            ::cblas_zher2k((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, beta, accessor_c.get_pointer(), ldc);
        });
    });
...
void symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_ssymm>(cgh, [=]() {
            ::cblas_ssymm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, m, n, alpha,
                          accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                          accessor_c.get_pointer(), ldc);
        });
    });
...
void symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_dsymm>(cgh, [=]() {
            ::cblas_dsymm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, m, n, alpha,
                          accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                          accessor_c.get_pointer(), ldc);
        });
    });
...
void symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_csymm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_csymm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, m, n,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zsymm>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zsymm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, m, n,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb, (const void *)&beta_,
                          accessor_c.get_pointer(), ldc);
        });
...
void syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_ssyrk>(cgh, [=]() {
            ::cblas_ssyrk((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha,
                          accessor_a.get_pointer(), lda, beta, accessor_c.get_pointer(), ldc);
        });
    });
}
...
void syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_dsyrk>(cgh, [=]() {
            ::cblas_dsyrk((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha,
                          accessor_a.get_pointer(), lda, beta, accessor_c.get_pointer(), ldc);
        });
    });
}
...
void syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_csyrk>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_csyrk((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          (const void *)&beta_, accessor_c.get_pointer(), ldc);
        });
    });
...
void syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zsyrk>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zsyrk((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k,
                          (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          (const void *)&beta_, accessor_c.get_pointer(), ldc);
        });
    });
...
void syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_ssyr2k>(cgh, [=]() {
            ::cblas_ssyr2k((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha,
                           accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                           accessor_c.get_pointer(), ldc);
        });
    });
...
void syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_dsyr2k>(cgh, [=]() {
            ::cblas_dsyr2k((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha,
                           accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                           accessor_c.get_pointer(), ldc);
        });
    });
...
void syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_csyr2k>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_csyr2k((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, (const void *)&beta_,
                           accessor_c.get_pointer(), ldc);
        });
...
void syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n, int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zsyr2k>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zsyr2k((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, (const void *)&beta_,
                           accessor_c.get_pointer(), ldc);
        });
...
void trmm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_b = b.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_strmm>(cgh, [=]() {
            ::cblas_strmm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, alpha, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trmm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_b = b.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_dtrmm>(cgh, [=]() {
            ::cblas_dtrmm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, alpha, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trmm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ctrmm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            ::cblas_ctrmm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trmm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ztrmm>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            ::cblas_ztrmm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trsm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_b = b.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_strsm>(cgh, [=]() {
            ::cblas_strsm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, alpha, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trsm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_b = b.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_dtrsm>(cgh, [=]() {
            ::cblas_dtrsm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, alpha, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trsm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ctrsm>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            ::cblas_ctrsm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
void trsm(cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_ztrsm>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            ::cblas_ztrsm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, transa_,
                          unit_diag_, m, n, (const void *)&alpha_, accessor_a.get_pointer(), lda,
                          accessor_b.get_pointer(), ldb);
        });
    });
...
cl::sycl::event gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_TRANSPOSE transb_ = (CBLAS_TRANSPOSE)cblas_convert(transb);
        host_task<class mkl_kernel_sgemm_usm>(cgh, [=]() {
            ::cblas_sgemm((CBLAS_LAYOUT)MKL_ROW_MAJOR, transa_, transb_, m, n, k, alpha, a, lda, b,
                          ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event gemm(cl::sycl::queue &queue, transpose transa, transpose transb, int64_t m,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_TRANSPOSE transb_ = (CBLAS_TRANSPOSE)cblas_convert(transb);
        host_task<class mkl_kernel_dgemm_usm>(cgh, [=]() {
            ::cblas_dgemm((CBLAS_LAYOUT)MKL_ROW_MAJOR, transa_, transb_, m, n, k, alpha, a, lda, b,
                          ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event herk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_TRANSPOSE trans_ = (CBLAS_TRANSPOSE)cblas_convert(trans);
        host_task<class mkl_kernel_cherk_usm>(cgh, [=]() {
            ::cblas_cherk((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                          beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event herk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_TRANSPOSE trans_ = (CBLAS_TRANSPOSE)cblas_convert(trans);
        host_task<class mkl_kernel_zherk_usm>(cgh, [=]() {
            ::cblas_zherk((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                          beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_UPLO upper_lower_ = (CBLAS_UPLO)cblas_convert(upper_lower);
        host_task<class mkl_kernel_ssymm_usm>(cgh, [=]() {
            ::cblas_ssymm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, m, n, alpha, a,
                          lda, b, ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event symm(cl::sycl::queue &queue, side left_right, uplo upper_lower, int64_t m,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_UPLO upper_lower_ = (CBLAS_UPLO)cblas_convert(upper_lower);
        host_task<class mkl_kernel_dsymm_usm>(cgh, [=]() {
            ::cblas_dsymm((CBLAS_LAYOUT)MKL_ROW_MAJOR, left_right_, upper_lower_, m, n, alpha, a,
                          lda, b, ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_TRANSPOSE trans_ = (CBLAS_TRANSPOSE)cblas_convert(trans);
        host_task<class mkl_kernel_ssyrk_usm>(cgh, [=]() {
            ::cblas_ssyrk((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                          beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event syrk(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_TRANSPOSE trans_ = (CBLAS_TRANSPOSE)cblas_convert(trans);
        host_task<class mkl_kernel_dsyrk_usm>(cgh, [=]() {
            ::cblas_dsyrk((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                          beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_TRANSPOSE trans_ = (CBLAS_TRANSPOSE)cblas_convert(trans);
        host_task<class mkl_kernel_ssyr2k_usm>(cgh, [=]() {
            ::cblas_ssyr2k((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                           b, ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event syr2k(cl::sycl::queue &queue, uplo upper_lower, transpose trans, int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_TRANSPOSE trans_ = (CBLAS_TRANSPOSE)cblas_convert(trans);
        host_task<class mkl_kernel_dsyr2k_usm>(cgh, [=]() {
            ::cblas_dsyr2k((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, trans_, n, k, alpha, a, lda,
                           b, ldb, beta, c, ldc);
        });
    });
    return done;
