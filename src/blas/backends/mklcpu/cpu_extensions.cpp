...
void gemm_bias(cl::sycl::queue &queue, transpose transa, transpose transb, offset offsetc,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_gemm_s8u8s32>(cgh, [=]() {
            ...
            ::cblas_gemm_s8u8s32(CblasColMajor, transa_, transb_, offsetc_, m, n, k, alpha, a_mat,
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_sgemmt>(cgh, [=]() {
            ::cblas_sgemmt(CblasColMajor, upper_lower_, transa_, transb_, n, k, alpha,
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dgemmt>(cgh, [=]() {
            ::cblas_dgemmt(CblasColMajor, upper_lower_, transa_, transb_, n, k, alpha,
                           accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                           accessor_c.get_pointer(), ldc);
        });
    });
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cgemmt>(cgh, [=]() {
            ...
            ::cblas_cgemmt(CblasColMajor, upper_lower_, transa_, transb_, n, k,
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zgemmt>(cgh, [=]() {
            ...
            ::cblas_zgemmt(CblasColMajor, upper_lower_, transa_, transb_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, (const void *)&beta_,
                           accessor_c.get_pointer(), ldc);
        });
...
cl::sycl::event gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_sgemmt_usm>(cgh, [=]() {
            ::cblas_sgemmt(CblasColMajor, upper_lower_, transa_, transb_, n, k, alpha, a, lda, b,
                           ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dgemmt_usm>(cgh, [=]() {
            ::cblas_dgemmt(CblasColMajor, upper_lower_, transa_, transb_, n, k, alpha, a, lda, b,
                           ldb, beta, c, ldc);
        });
    });
    return done;
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_sgemmt>(cgh, [=]() {
            ::cblas_sgemmt(CblasRowMajor, upper_lower_, transa_, transb_, n, k, alpha,
                           accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                           accessor_c.get_pointer(), ldc);
        });
    });
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_dgemmt>(cgh, [=]() {
            ::cblas_dgemmt(CblasRowMajor, upper_lower_, transa_, transb_, n, k, alpha,
                           accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                           accessor_c.get_pointer(), ldc);
        });
    });
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cgemmt>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_cgemmt(CblasRowMajor, upper_lower_, transa_, transb_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, (const void *)&beta_,
                           accessor_c.get_pointer(), ldc);
        });
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zgemmt>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zgemmt(CblasRowMajor, upper_lower_, transa_, transb_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, (const void *)&beta_,
                           accessor_c.get_pointer(), ldc);
        });
...
cl::sycl::event gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_TRANSPOSE transb_ = cblas_convert(transb);
        host_task<class mkl_kernel_sgemmt_usm>(cgh, [=]() {
            ::cblas_sgemmt(CblasRowMajor, upper_lower_, transa_, transb_, n, k, alpha, a, lda, b,
                           ldb, beta, c, ldc);
        });
    });
    return done;
...
cl::sycl::event gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_TRANSPOSE transb_ = cblas_convert(transb);
        host_task<class mkl_kernel_dgemmt_usm>(cgh, [=]() {
            ::cblas_dgemmt(CblasRowMajor, upper_lower_, transa_, transb_, n, k, alpha, a, lda, b,
                           ldb, beta, c, ldc);
        });
    });
    return done;
