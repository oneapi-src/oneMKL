...
void gemm_bias(cl::sycl::queue &queue, transpose transa, transpose transb, offset offsetc,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        CBLAS_OFFSET offsetc_ = (CBLAS_OFFSET)cblas_convert(offsetc);
        ...
        host_task<class mkl_kernel_gemm_s8u8s32>(cgh, [=]() {
            ...
            ::cblas_gemm_s8u8s32((CBLAS_LAYOUT)MKL_COL_MAJOR, transa_, transb_, offsetc_, m, n, k,
                                 alpha, a_mat, lda, ao_internal, b_mat, ldb, bo_internal, beta,
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_sgemmt>(cgh, [=]() {
            ::cblas_sgemmt((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, transa_, transb_, n, k, alpha,
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_dgemmt>(cgh, [=]() {
            ::cblas_dgemmt((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, transa_, transb_, n, k, alpha,
                           accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                           accessor_c.get_pointer(), ldc);
        });
    });
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cgemmt>(cgh, [=]() {
            ...
            ::cblas_cgemmt((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, transa_, transb_, n, k,
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zgemmt>(cgh, [=]() {
            ...
            ::cblas_zgemmt((CBLAS_LAYOUT)MKL_COL_MAJOR, upper_lower_, transa_, transb_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, (const void *)&beta_,
                           accessor_c.get_pointer(), ldc);
        });
...
void gemm_bias(cl::sycl::queue &queue, transpose transa, transpose transb, offset offsetc,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_gemm_s8u8s32>(cgh, [=]() {
            ...
            MKL_UINT8 *b_mat =
                static_cast<MKL_UINT8 *>(static_cast<void *>(accessor_b.get_pointer()));
            MKL_UINT8 bo_internal = -bo;
            MKL_INT8 ao_internal = -ao;
            ::cblas_gemm_s8u8s32((CBLAS_LAYOUT)MKL_ROW_MAJOR, transa_, transb_, offsetc_, m, n, k,
                                 alpha, a_mat, lda, ao_internal, b_mat, ldb, bo_internal, beta,
                                 (MKL_INT32 *)accessor_c.get_pointer(), ldc,
                                 (const MKL_INT32 *)accessor_co.get_pointer());
        });
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_sgemmt>(cgh, [=]() {
            ::cblas_sgemmt((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, transa_, transb_, n, k, alpha,
                           accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                           accessor_c.get_pointer(), ldc);
        });
    });
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        auto accessor_c = c.get_access<cl::sycl::access::mode::read_write>(cgh);
        host_task<class mkl_kernel_dgemmt>(cgh, [=]() {
            ::cblas_dgemmt((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, transa_, transb_, n, k, alpha,
                           accessor_a.get_pointer(), lda, accessor_b.get_pointer(), ldb, beta,
                           accessor_c.get_pointer(), ldc);
        });
    });
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_cgemmt>(cgh, [=]() {
            MKL_Complex8 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex8 beta_ = { beta_real, beta_imag };
            ::cblas_cgemmt((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, transa_, transb_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, (const void *)&beta_,
                           accessor_c.get_pointer(), ldc);
        });
...
void gemmt(cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb, int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        host_task<class mkl_kernel_zgemmt>(cgh, [=]() {
            MKL_Complex16 alpha_ = { alpha_real, alpha_imag };
            MKL_Complex16 beta_ = { beta_real, beta_imag };
            ::cblas_zgemmt((CBLAS_LAYOUT)MKL_ROW_MAJOR, upper_lower_, transa_, transb_, n, k,
                           (const void *)&alpha_, accessor_a.get_pointer(), lda,
                           accessor_b.get_pointer(), ldb, (const void *)&beta_,
                           accessor_c.get_pointer(), ldc);
        });
