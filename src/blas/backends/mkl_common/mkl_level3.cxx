...
void gemm(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
          ...
          std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::gemm(queue, detail::get_onemkl_transpose(transa), detail::get_onemkl_transpose(transb), m, n, k, alpha, a, lda, b, ldb, beta, c, ldc));
}
...
void symm(sycl::queue &queue, side left_right, uplo upper_lower, std::int64_t m, std::int64_t n,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::symm(queue, detail::get_onemkl_side(left_right), detail::get_onemkl_uplo(upper_lower), m, n, alpha, a, lda, b, ldb, beta, c, ldc));
}
...
void hemm(sycl::queue &queue, side left_right, uplo upper_lower, std::int64_t m, std::int64_t n,
          ...
          sycl::buffer<std::complex<float>, 1> &b, std::int64_t ldb, std::complex<float> beta,
          sycl::buffer<std::complex<float>, 1> &c, std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::hemm(queue, detail::get_onemkl_side(left_right), detail::get_onemkl_uplo(upper_lower), m, n, alpha, a, lda, b, ldb, beta, c, ldc));
}
...
void syrk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n, std::int64_t k,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::syrk(queue, detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(trans), n, k, alpha, a, lda, beta, c, ldc));
}
...
void herk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n, std::int64_t k,
          ...
          sycl::buffer<std::complex<float>, 1> &c, std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::herk(queue, detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(trans), n, k, alpha, a, lda, beta, c, ldc));
}
...
void syr2k(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n, std::int64_t k,
           float alpha, sycl::buffer<float, 1> &a, std::int64_t lda, sycl::buffer<float, 1> &b,
           std::int64_t ldb, float beta, sycl::buffer<float, 1> &c, std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::syr2k(queue, detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(trans), n, k, alpha, a, lda, b, ldb, beta, c, ldc));
}
...
void her2k(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n, std::int64_t k,
           ...
           sycl::buffer<std::complex<float>, 1> &c, std::int64_t ldc) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::her2k(queue, detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(trans), n, k, alpha, a, lda, b, ldb, beta, c, ldc));
}
...
void trmm(sycl::queue &queue, side left_right, uplo upper_lower, transpose transa, diag unit_diag,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::trmm(queue, detail::get_onemkl_side(left_right), detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(transa), detail::get_onemkl_diag(unit_diag), m, n, alpha, a, lda, b,
                     ldb));
}
...
void trsm(sycl::queue &queue, side left_right, uplo upper_lower, transpose transa, diag unit_diag,
          std::int64_t m, std::int64_t n, float alpha, sycl::buffer<float, 1> &a, std::int64_t lda,
          sycl::buffer<float, 1> &b, std::int64_t ldb) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::trsm(queue, detail::get_onemkl_side(left_right), detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(transa), detail::get_onemkl_diag(unit_diag), m, n, alpha, a, lda, b,
                     ldb));
}
...
sycl::event gemm(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::gemm(queue, detail::get_onemkl_transpose(transa), detail::get_onemkl_transpose(transb), m, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                            dependencies));
}
...
sycl::event symm(sycl::queue &queue, side left_right, uplo upper_lower, std::int64_t m,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::symm(queue, detail::get_onemkl_side(left_right), detail::get_onemkl_uplo(upper_lower), m, n, alpha, a, lda, b, ldb, beta, c,
                            ldc, dependencies));
}
...
sycl::event hemm(sycl::queue &queue, side left_right, uplo upper_lower, std::int64_t m,
                 ...
                 std::complex<float> beta, std::complex<float> *c, std::int64_t ldc,
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::hemm(queue, detail::get_onemkl_side(left_right), detail::get_onemkl_uplo(upper_lower), m, n, alpha, a, lda, b, ldb, beta, c,
                            ldc, dependencies));
}
...
sycl::event syrk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::syrk(queue, detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(trans), n, k, alpha, a, lda, beta, c, ldc,
                            dependencies));
}
...
sycl::event herk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::herk(queue, detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(trans), n, k, alpha, a, lda, beta, c, ldc,
                            dependencies));
}
...
sycl::event syr2k(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                  ...
                  std::int64_t ldb, float beta, float *c, std::int64_t ldc,
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::syr2k(queue, detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(trans), n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                             dependencies));
}
...
sycl::event her2k(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                  ...
                  const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::her2k(queue, detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(trans), n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                             dependencies));
}
...
sycl::event trmm(sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::trmm(queue, detail::get_onemkl_side(left_right), detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(transa), detail::get_onemkl_diag(unit_diag), m, n, alpha, a, lda,
                            b, ldb, dependencies));
}
...
sycl::event trsm(sycl::queue &queue, side left_right, uplo upper_lower, transpose transa,
                 ...
                 std::int64_t lda, float *b, std::int64_t ldb,
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::trsm(queue, detail::get_onemkl_side(left_right), detail::get_onemkl_uplo(upper_lower), detail::get_onemkl_transpose(transa), detail::get_onemkl_diag(unit_diag), m, n, alpha, a, lda,
                            b, ldb, dependencies));
}
