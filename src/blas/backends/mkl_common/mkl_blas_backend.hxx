...
sycl::event gemm(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                 std::int64_t n, std::int64_t k, ONEMKL_SCALAR(float) alpha, const float *a,
                 std::int64_t lda, const float *b, std::int64_t ldb, ONEMKL_SCALAR(float) beta,
                 float *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event gemm(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                 std::int64_t n, std::int64_t k, ONEMKL_SCALAR(double) alpha, const double *a,
                 std::int64_t lda, const double *b, std::int64_t ldb, ONEMKL_SCALAR(double) beta,
                 double *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event gemm(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                 std::int64_t n, std::int64_t k, ONEMKL_SCALAR(std::complex<float>) alpha,
                 const std::complex<float> *a, std::int64_t lda, const std::complex<float> *b,
                 std::int64_t ldb, ONEMKL_SCALAR(std::complex<float>) beta, std::complex<float> *c,
                 std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event gemm(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                 std::int64_t n, std::int64_t k, ONEMKL_SCALAR(std::complex<double>) alpha,
                 const std::complex<double> *a, std::int64_t lda, const std::complex<double> *b,
                 std::int64_t ldb, ONEMKL_SCALAR(std::complex<double>) beta,
...
sycl::event gemm(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                 std::int64_t n, std::int64_t k, ONEMKL_SCALAR(float) alpha, const sycl::half *a,
                 std::int64_t lda, const sycl::half *b, std::int64_t ldb, ONEMKL_SCALAR(float) beta,
                 float *c, std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});
...
sycl::event gemm(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                 ...
                 ONEMKL_SCALAR(float) beta, std::int32_t *c, std::int64_t ldc,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event gemm(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                 std::int64_t n, std::int64_t k, ONEMKL_SCALAR(float) alpha, const std::int8_t *a,
                 std::int64_t lda, const std::int8_t *b, std::int64_t ldb,
                 ONEMKL_SCALAR(float) beta, float *c, std::int64_t ldc,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event symm(sycl::queue &queue, side left_right, uplo upper_lower, std::int64_t m,
                 std::int64_t n, ONEMKL_SCALAR(float) alpha, const float *a, std::int64_t lda,
                 const float *b, std::int64_t ldb, ONEMKL_SCALAR(float) beta, float *c,
                 std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event symm(sycl::queue &queue, side left_right, uplo upper_lower, std::int64_t m,
                 std::int64_t n, ONEMKL_SCALAR(double) alpha, const double *a, std::int64_t lda,
                 const double *b, std::int64_t ldb, ONEMKL_SCALAR(double) beta, double *c,
                 std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event symm(sycl::queue &queue, side left_right, uplo upper_lower, std::int64_t m,
                 std::int64_t n, ONEMKL_SCALAR(std::complex<float>) alpha,
                 const std::complex<float> *a, std::int64_t lda, const std::complex<float> *b,
                 std::int64_t ldb, ONEMKL_SCALAR(std::complex<float>) beta, std::complex<float> *c,
                 std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event symm(sycl::queue &queue, side left_right, uplo upper_lower, std::int64_t m,
                 std::int64_t n, ONEMKL_SCALAR(std::complex<double>) alpha,
                 const std::complex<double> *a, std::int64_t lda, const std::complex<double> *b,
                 std::int64_t ldb, ONEMKL_SCALAR(std::complex<double>) beta,
                 std::complex<double> *c, std::int64_t ldc,
                 const std::vector<sycl::event> &dependencies = {});
...
sycl::event syrk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                 std::int64_t k, ONEMKL_SCALAR(float) alpha, const float *a, std::int64_t lda,
                 ONEMKL_SCALAR(float) beta, float *c, std::int64_t ldc,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event syrk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                 std::int64_t k, ONEMKL_SCALAR(double) alpha, const double *a, std::int64_t lda,
                 ONEMKL_SCALAR(double) beta, double *c, std::int64_t ldc,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event syrk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                 std::int64_t k, ONEMKL_SCALAR(std::complex<float>) alpha,
                 const std::complex<float> *a, std::int64_t lda,
                 ONEMKL_SCALAR(std::complex<float>) beta, std::complex<float> *c, std::int64_t ldc,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event syrk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                 std::int64_t k, ONEMKL_SCALAR(std::complex<double>) alpha,
                 const std::complex<double> *a, std::int64_t lda,
                 ONEMKL_SCALAR(std::complex<double>) beta, std::complex<double> *c,
                 std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event herk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                 std::int64_t k, ONEMKL_SCALAR(float) alpha, const std::complex<float> *a,
                 std::int64_t lda, ONEMKL_SCALAR(float) beta, std::complex<float> *c,
                 std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event herk(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                 std::int64_t k, ONEMKL_SCALAR(double) alpha, const std::complex<double> *a,
                 std::int64_t lda, ONEMKL_SCALAR(double) beta, std::complex<double> *c,
                 std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});
...
sycl::event her2k(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                  std::int64_t k, ONEMKL_SCALAR(std::complex<float>) alpha,
                  const std::complex<float> *a, std::int64_t lda, const std::complex<float> *b,
                  std::int64_t ldb, ONEMKL_SCALAR(float) beta, std::complex<float> *c,
                  std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event her2k(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                  std::int64_t k, ONEMKL_SCALAR(std::complex<double>) alpha,
                  const std::complex<double> *a, std::int64_t lda, const std::complex<double> *b,
                  std::int64_t ldb, ONEMKL_SCALAR(double) beta, std::complex<double> *c,
                  std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event trmm(sycl::queue &queue, side left_right, uplo upper_lower, transpose trans,
                 diag unit_diag, std::int64_t m, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                 const float *a, std::int64_t lda, float *b, std::int64_t ldb,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event trmm(sycl::queue &queue, side left_right, uplo upper_lower, transpose trans,
                 diag unit_diag, std::int64_t m, std::int64_t n, ONEMKL_SCALAR(double) alpha,
                 const double *a, std::int64_t lda, double *b, std::int64_t ldb,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event trmm(sycl::queue &queue, side left_right, uplo upper_lower, transpose trans,
                 diag unit_diag, std::int64_t m, std::int64_t n,
                 ONEMKL_SCALAR(std::complex<float>) alpha, const std::complex<float> *a,
                 std::int64_t lda, std::complex<float> *b, std::int64_t ldb,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event trmm(sycl::queue &queue, side left_right, uplo upper_lower, transpose trans,
                 diag unit_diag, std::int64_t m, std::int64_t n,
                 ONEMKL_SCALAR(std::complex<double>) alpha, const std::complex<double> *a,
...
sycl::event gemv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                 ONEMKL_SCALAR(float) alpha, const float *a, std::int64_t lda, const float *x,
                 std::int64_t incx, ONEMKL_SCALAR(float) beta, float *y, std::int64_t incy,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event gemv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                 ONEMKL_SCALAR(double) alpha, const double *a, std::int64_t lda, const double *x,
                 std::int64_t incx, ONEMKL_SCALAR(double) beta, double *y, std::int64_t incy,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event gemv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                 ONEMKL_SCALAR(std::complex<float>) alpha, const std::complex<float> *a,
                 std::int64_t lda, const std::complex<float> *x, std::int64_t incx,
                 ONEMKL_SCALAR(std::complex<float>) beta, std::complex<float> *y, std::int64_t incy,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event gemv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                 ONEMKL_SCALAR(std::complex<double>) alpha, const std::complex<double> *a,
                 std::int64_t lda, const std::complex<double> *x, std::int64_t incx,
                 ONEMKL_SCALAR(std::complex<double>) beta, std::complex<double> *y,
...
sycl::event gbmv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                 std::int64_t kl, std::int64_t ku, ONEMKL_SCALAR(float) alpha, const float *a,
                 std::int64_t lda, const float *x, std::int64_t incx, ONEMKL_SCALAR(float) beta,
                 float *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});

sycl::event gbmv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                 std::int64_t kl, std::int64_t ku, ONEMKL_SCALAR(double) alpha, const double *a,
                 std::int64_t lda, const double *x, std::int64_t incx, ONEMKL_SCALAR(double) beta,
                 double *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});

sycl::event gbmv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                 std::int64_t kl, std::int64_t ku, ONEMKL_SCALAR(std::complex<float>) alpha,
                 const std::complex<float> *a, std::int64_t lda, const std::complex<float> *x,
                 std::int64_t incx, ONEMKL_SCALAR(std::complex<float>) beta, std::complex<float> *y,
                 std::int64_t incy, const std::vector<sycl::event> &dependencies = {});

sycl::event gbmv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                 std::int64_t kl, std::int64_t ku, ONEMKL_SCALAR(std::complex<double>) alpha,
                 const std::complex<double> *a, std::int64_t lda, const std::complex<double> *x,
                 std::int64_t incx, ONEMKL_SCALAR(std::complex<double>) beta,
                 std::complex<double> *y, std::int64_t incy,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event ger(sycl::queue &queue, std::int64_t m, std::int64_t n, ONEMKL_SCALAR(float) alpha,
...
sycl::event ger(sycl::queue &queue, std::int64_t m, std::int64_t n, ONEMKL_SCALAR(double) alpha,
...
sycl::event gerc(sycl::queue &queue, std::int64_t m, std::int64_t n,
                 ONEMKL_SCALAR(std::complex<float>) alpha, const std::complex<float> *x,
                 std::int64_t incx, const std::complex<float> *y, std::int64_t incy,
                 std::complex<float> *a, std::int64_t lda,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event gerc(sycl::queue &queue, std::int64_t m, std::int64_t n,
                 ONEMKL_SCALAR(std::complex<double>) alpha, const std::complex<double> *x,
...
sycl::event her(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                const std::complex<float> *x, std::int64_t incx, std::complex<float> *a,
                std::int64_t lda, const std::vector<sycl::event> &dependencies = {});

sycl::event her(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(double) alpha,
...
sycl::event hpr(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                const std::complex<float> *x, std::int64_t incx, std::complex<float> *a,
                const std::vector<sycl::event> &dependencies = {});

sycl::event hpr(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(double) alpha,
                const std::complex<double> *x, std::int64_t incx, std::complex<double> *a,
                const std::vector<sycl::event> &dependencies = {});
...
sycl::event symv(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                 const float *a, std::int64_t lda, const float *x, std::int64_t incx,
                 ONEMKL_SCALAR(float) beta, float *y, std::int64_t incy,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event symv(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(double) alpha,
                 const double *a, std::int64_t lda, const double *x, std::int64_t incx,
                 ONEMKL_SCALAR(double) beta, double *y, std::int64_t incy,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event syr(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                const float *x, std::int64_t incx, float *a, std::int64_t lda,
                const std::vector<sycl::event> &dependencies = {});

sycl::event syr(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(double) alpha,
                const double *x, std::int64_t incx, double *a, std::int64_t lda,
                const std::vector<sycl::event> &dependencies = {});

sycl::event syr2(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                 const float *x, std::int64_t incx, const float *y, std::int64_t incy, float *a,
                 std::int64_t lda, const std::vector<sycl::event> &dependencies = {});

sycl::event syr2(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(double) alpha,
                 const double *x, std::int64_t incx, const double *y, std::int64_t incy, double *a,
                 std::int64_t lda, const std::vector<sycl::event> &dependencies = {});

sycl::event spmv(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                 const float *a, const float *x, std::int64_t incx, ONEMKL_SCALAR(float) beta,
                 float *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});

sycl::event spmv(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(double) alpha,
                 const double *a, const double *x, std::int64_t incx, ONEMKL_SCALAR(double) beta,
                 double *y, std::int64_t incy, const std::vector<sycl::event> &dependencies = {});

sycl::event spr(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                const float *x, std::int64_t incx, float *a,
                const std::vector<sycl::event> &dependencies = {});

sycl::event spr(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(double) alpha,
                const double *x, std::int64_t incx, double *a,
                const std::vector<sycl::event> &dependencies = {});

sycl::event spr2(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                 const float *x, std::int64_t incx, const float *y, std::int64_t incy, float *a,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event spr2(sycl::queue &queue, uplo upper_lower, std::int64_t n, ONEMKL_SCALAR(double) alpha,
                 const double *x, std::int64_t incx, const double *y, std::int64_t incy, double *a,
                 const std::vector<sycl::event> &dependencies = {});
...
sycl::event axpy(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(float) alpha, const float *x,
                 std::int64_t incx, float *y, std::int64_t incy,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event axpy(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(double) alpha, const double *x,
                 std::int64_t incx, double *y, std::int64_t incy,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event axpy(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(std::complex<float>) alpha,
                 const std::complex<float> *x, std::int64_t incx, std::complex<float> *y,
                 std::int64_t incy, const std::vector<sycl::event> &dependencies = {});

sycl::event axpy(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(std::complex<double>) alpha,
                 const std::complex<double> *x, std::int64_t incx, std::complex<double> *y,
                 std::int64_t incy, const std::vector<sycl::event> &dependencies = {});

sycl::event axpby(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(float) alpha, const float *x,
                  std::int64_t incx, const ONEMKL_SCALAR(float) beta, float *y, std::int64_t incy,
                  const std::vector<sycl::event> &dependencies = {});

sycl::event axpby(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(double) alpha, const double *x,
                  std::int64_t incx, const ONEMKL_SCALAR(double) beta, double *y, std::int64_t incy,
                  const std::vector<sycl::event> &dependencies = {});

sycl::event axpby(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(std::complex<float>) alpha,
                  const std::complex<float> *x, std::int64_t incx,
                  const ONEMKL_SCALAR(std::complex<float>) beta, std::complex<float> *y,
                  std::int64_t incy, const std::vector<sycl::event> &dependencies = {});

sycl::event axpby(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(std::complex<double>) alpha,
                  const std::complex<double> *x, std::int64_t incx,
                  const ONEMKL_SCALAR(std::complex<double>) beta, std::complex<double> *y,
                  std::int64_t incy, const std::vector<sycl::event> &dependencies = {});
...
sycl::event scal(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(double) alpha, double *x,
                 std::int64_t incx, const std::vector<sycl::event> &dependencies = {});

sycl::event scal(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(std::complex<float>) alpha,
                 std::complex<float> *x, std::int64_t incx,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event scal(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(std::complex<double>) alpha,
                 std::complex<double> *x, std::int64_t incx,
                 const std::vector<sycl::event> &dependencies = {});

sycl::event scal(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                 std::complex<float> *x, std::int64_t incx,
                 const std::vector<sycl::event> &dependencies = {});
...
sycl::event gemm_bias(sycl::queue &queue, transpose transa, transpose transb, offset offsetc,
                      std::int64_t m, std::int64_t n, std::int64_t k, ONEMKL_SCALAR(float) alpha,
                      const std::int8_t *a, std::int64_t lda, std::int8_t ao, const std::uint8_t *b,
                      std::int64_t ldb, std::uint8_t bo, ONEMKL_SCALAR(float) beta, std::int32_t *c,
...
sycl::event gemm_bias(sycl::queue &queue, transpose transa, transpose transb, offset offsetc,
                      ...
                      std::int64_t ldb, std::int8_t bo, ONEMKL_SCALAR(float) beta, std::int32_t *c,
                      std::int64_t ldc, const std::int32_t *co,
                      const std::vector<sycl::event> &dependencies = {});
...
sycl::event syrk_batch(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                       std::int64_t k, ONEMKL_SCALAR(float) alpha, const float *a, std::int64_t lda,
                       std::int64_t stride_a, ONEMKL_SCALAR(float) beta, float *c, std::int64_t ldc,
                       std::int64_t stride_c, std::int64_t batch_size,
                       const std::vector<sycl::event> &dependencies = {});
sycl::event syrk_batch(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                       std::int64_t k, ONEMKL_SCALAR(double) alpha, const double *a,
                       std::int64_t lda, std::int64_t stride_a, ONEMKL_SCALAR(double) beta,
...
sycl::event syrk_batch(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                       ...
                       ONEMKL_SCALAR(std::complex<float>) beta, std::complex<float> *c,
                       std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size,
                       const std::vector<sycl::event> &dependencies = {});
sycl::event syrk_batch(sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
                       std::int64_t k, ONEMKL_SCALAR(std::complex<double>) alpha,
...
sycl::event gemv_batch(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                       ONEMKL_SCALAR(float) alpha, const float *a, std::int64_t lda,
                       std::int64_t stridea, const float *x, std::int64_t incx,
                       std::int64_t stridex, ONEMKL_SCALAR(float) beta, float *y, std::int64_t incy,
                       std::int64_t stridey, std::int64_t batch_size,
                       const std::vector<sycl::event> &dependencies = {});

sycl::event gemv_batch(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                       ONEMKL_SCALAR(double) alpha, const double *a, std::int64_t lda,
                       std::int64_t stridea, const double *x, std::int64_t incx,
                       std::int64_t stridex, ONEMKL_SCALAR(double) beta, double *y,
                       std::int64_t incy, std::int64_t stridey, std::int64_t batch_size,
                       const std::vector<sycl::event> &dependencies = {});
...
sycl::event gemv_batch(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                       ...
                       ONEMKL_SCALAR(std::complex<float>) beta, std::complex<float> *y,
                       std::int64_t incy, std::int64_t stridey, std::int64_t batch_size,
                       const std::vector<sycl::event> &dependencies = {});
...
sycl::event axpy_batch(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(float) alpha,
                       const float *x, std::int64_t incx, std::int64_t stridex, float *y,
                       std::int64_t incy, std::int64_t stridey, std::int64_t batch_size,
                       const std::vector<sycl::event> &dependencies = {});

sycl::event axpy_batch(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(double) alpha,
                       const double *x, std::int64_t incx, std::int64_t stridex, double *y,
                       std::int64_t incy, std::int64_t stridey, std::int64_t batch_size,
                       const std::vector<sycl::event> &dependencies = {});

sycl::event axpy_batch(sycl::queue &queue, std::int64_t n, ONEMKL_SCALAR(std::complex<float>) alpha,
                       const std::complex<float> *x, std::int64_t incx, std::int64_t stridex,
...
sycl::event gemm_batch(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                       ...
                       std::int64_t stride_b, ONEMKL_SCALAR(float) beta, float *c, std::int64_t ldc,
                       std::int64_t stride_c, std::int64_t batch_size,
                       const std::vector<sycl::event> &dependencies = {});
...
sycl::event gemm_batch(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                       ...
                       std::int64_t stride_b, ONEMKL_SCALAR(double) beta, double *c,
                       std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size,
                       const std::vector<sycl::event> &dependencies = {});
...
sycl::event imatcopy_batch(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                           ONEMKL_SCALAR(float) alpha, float *ab, std::int64_t lda,
                           std::int64_t ldb, std::int64_t stride, std::int64_t batch_size,
                           const std::vector<sycl::event> &dependencies = {});

sycl::event imatcopy_batch(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                           ONEMKL_SCALAR(double) alpha, double *ab, std::int64_t lda,
                           std::int64_t ldb, std::int64_t stride, std::int64_t batch_size,
                           const std::vector<sycl::event> &dependencies = {});

sycl::event imatcopy_batch(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                           ONEMKL_SCALAR(std::complex<float>) alpha, std::complex<float> *ab,
                           std::int64_t lda, std::int64_t ldb, std::int64_t stride,
                           std::int64_t batch_size,
                           const std::vector<sycl::event> &dependencies = {});

sycl::event imatcopy_batch(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                           ONEMKL_SCALAR(std::complex<double>) alpha, std::complex<double> *ab,
                           std::int64_t lda, std::int64_t ldb, std::int64_t stride,
                           std::int64_t batch_size,
                           const std::vector<sycl::event> &dependencies = {});

sycl::event omatadd_batch(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                          std::int64_t n, ONEMKL_SCALAR(float) alpha, const float *a,
                          std::int64_t lda, std::int64_t stride_a, ONEMKL_SCALAR(float) beta,
                          const float *b, std::int64_t ldb, std::int64_t stride_b, float *c,
                          std::int64_t ldc, std::int64_t stride_c, std::int64_t batch_size,
                          const std::vector<sycl::event> &dependencies = {});

sycl::event omatadd_batch(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                          std::int64_t n, ONEMKL_SCALAR(double) alpha, const double *a,
                          std::int64_t lda, std::int64_t stride_a, ONEMKL_SCALAR(double) beta,
...
sycl::event omatadd_batch(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                          std::int64_t n, ONEMKL_SCALAR(std::complex<float>) alpha,
                          const std::complex<float> *a, std::int64_t lda, std::int64_t stride_a,
                          ONEMKL_SCALAR(std::complex<float>) beta, const std::complex<float> *b,
...
sycl::event omatadd_batch(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                          std::int64_t n, ONEMKL_SCALAR(std::complex<double>) alpha,
                          const std::complex<double> *a, std::int64_t lda, std::int64_t stride_a,
                          ONEMKL_SCALAR(std::complex<double>) beta, const std::complex<double> *b,
...
sycl::event omatcopy(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                     ONEMKL_SCALAR(float) alpha, const float *a, std::int64_t lda, float *b,
                     std::int64_t ldb, const std::vector<sycl::event> &dependencies = {});

sycl::event omatcopy(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                     ONEMKL_SCALAR(double) alpha, const double *a, std::int64_t lda, double *b,
                     std::int64_t ldb, const std::vector<sycl::event> &dependencies = {});
...
sycl::event imatcopy(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                     ONEMKL_SCALAR(float) alpha, float *ab, std::int64_t lda, std::int64_t ldb,
                     const std::vector<sycl::event> &dependencies = {});

sycl::event imatcopy(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                     ONEMKL_SCALAR(double) alpha, double *ab, std::int64_t lda, std::int64_t ldb,
                     const std::vector<sycl::event> &dependencies = {});
...
sycl::event omatadd(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                    std::int64_t n, ONEMKL_SCALAR(float) alpha, const float *a, std::int64_t lda,
                    ONEMKL_SCALAR(float) beta, const float *b, std::int64_t ldb, float *c,
                    std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});

sycl::event omatadd(sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                    std::int64_t n, ONEMKL_SCALAR(double) alpha, const double *a, std::int64_t lda,
                    ONEMKL_SCALAR(double) beta, const double *b, std::int64_t ldb, double *c,
                    std::int64_t ldc, const std::vector<sycl::event> &dependencies = {});
