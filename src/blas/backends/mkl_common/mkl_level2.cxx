...
void gemv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n, float alpha,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::gemv(queue, detail::get_onemkl_transpose(trans), m, n, alpha, a, lda, x, incx, beta, y, incy));
}
...
void gbmv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n, std::int64_t kl,
          ...
          std::int64_t incy) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::gbmv(queue, detail::get_onemkl_transpose(trans), m, n, kl, ku, alpha, a, lda, x, incx, beta, y, incy));
}
...
void hbmv(sycl::queue &queue, uplo uplo, std::int64_t n, std::int64_t k, std::complex<float> alpha,
          ...
          sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx, std::complex<float> beta,
          sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::hbmv(queue, detail::get_onemkl_uplo(uplo), n, k, alpha, a, lda, x, incx, beta, y, incy));
}
...
void hemv(sycl::queue &queue, uplo uplo, std::int64_t n, std::complex<float> alpha,
          ...
          sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx, std::complex<float> beta,
          sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::hemv(queue, detail::get_onemkl_uplo(uplo), n, alpha, a, lda, x, incx, beta, y, incy));
}
...
void her(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha,
         sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
         sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::her(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, a, lda));
}
...
void her2(sycl::queue &queue, uplo uplo, std::int64_t n, std::complex<float> alpha,
          ...
          sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
          sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::her2(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, y, incy, a, lda));
}
...
void hpmv(sycl::queue &queue, uplo uplo, std::int64_t n, std::complex<float> alpha,
          ...
          std::int64_t incy) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::hpmv(queue, detail::get_onemkl_uplo(uplo), n, alpha, a, x, incx, beta, y, incy));
}
...
void hpr(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::hpr(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, a));
}
...
void hpr2(sycl::queue &queue, uplo uplo, std::int64_t n, std::complex<float> alpha,
          ...
          sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
          sycl::buffer<std::complex<float>, 1> &a) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::hpr2(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, y, incy, a));
}
...
void sbmv(sycl::queue &queue, uplo uplo, std::int64_t n, std::int64_t k, float alpha,
          sycl::buffer<float, 1> &a, std::int64_t lda, sycl::buffer<float, 1> &x, std::int64_t incx,
          float beta, sycl::buffer<float, 1> &y, std::int64_t incy) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::sbmv(queue, detail::get_onemkl_uplo(uplo), n, k, alpha, a, lda, x, incx, beta, y, incy));
}
...
void spmv(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, sycl::buffer<float, 1> &a,
          sycl::buffer<float, 1> &x, std::int64_t incx, float beta, sycl::buffer<float, 1> &y,
          std::int64_t incy) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::spmv(queue, detail::get_onemkl_uplo(uplo), n, alpha, a, x, incx, beta, y, incy));
}
...
void spr(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::spr(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, a));
}
...
void spr2(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::spr2(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, y, incy, a));
}
...
void symv(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, sycl::buffer<float, 1> &a,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::symv(queue, detail::get_onemkl_uplo(uplo), n, alpha, a, lda, x, incx, beta, y, incy));
}
...
void syr(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::syr(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, a, lda));
}
...
void syr2(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::syr2(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, y, incy, a, lda));
}
...
void tbmv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n, std::int64_t k,
          ...
          std::int64_t incx) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::tbmv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, k, a, lda, x, incx));
}
...
void tbsv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n, std::int64_t k,
          sycl::buffer<float, 1> &a, std::int64_t lda, sycl::buffer<float, 1> &x,
          std::int64_t incx) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::tbsv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, k, a, lda, x, incx));
}
...
void tpmv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n,
    ...
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::tpmv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, a, x, incx));
}
...
void tpsv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n,
          sycl::buffer<float, 1> &a, sycl::buffer<float, 1> &x, std::int64_t incx) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::tpsv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, a, x, incx));
}
...
void trmv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n,
          sycl::buffer<float, 1> &a, std::int64_t lda, sycl::buffer<float, 1> &x,
          std::int64_t incx) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::trmv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, a, lda, x, incx));
}
...
void trsv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n,
          sycl::buffer<float, 1> &a, std::int64_t lda, sycl::buffer<float, 1> &x,
          std::int64_t incx) {
    RETHROW_ONEMKL_EXCEPTIONS(blas_major::trsv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, a, lda, x, incx));
}
...
sycl::event gemv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n, float alpha,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::gemv(queue, detail::get_onemkl_transpose(trans), m, n, alpha, a, lda, x, incx, beta, y, incy,
                            dependencies));
}
...
sycl::event gbmv(sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::gbmv(queue, detail::get_onemkl_transpose(trans), m, n, kl, ku, alpha, a, lda, x, incx, beta, y, incy,
                            dependencies));
}
...
sycl::event ger(sycl::queue &queue, std::int64_t m, std::int64_t n, float alpha, const float *x,
                ...
                const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::ger(queue, m, n, alpha, x, incx, y, incy, a, lda, dependencies));
}
...
sycl::event gerc(sycl::queue &queue, std::int64_t m, std::int64_t n, std::complex<float> alpha,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::gerc(queue, m, n, alpha, x, incx, y, incy, a, lda, dependencies));
}
...
sycl::event geru(sycl::queue &queue, std::int64_t m, std::int64_t n, std::complex<float> alpha,
                 ...
                 std::int64_t incy, std::complex<float> *a, std::int64_t lda,
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::geru(queue, m, n, alpha, x, incx, y, incy, a, lda, dependencies));
}
...
sycl::event hbmv(sycl::queue &queue, uplo uplo, std::int64_t n, std::int64_t k,
                 ...
                 std::complex<float> *y, std::int64_t incy,
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::hbmv(queue, detail::get_onemkl_uplo(uplo), n, k, alpha, a, lda, x, incx, beta, y, incy, dependencies));
}
...
sycl::event hemv(sycl::queue &queue, uplo uplo, std::int64_t n, std::complex<float> alpha,
                 ...
                 std::int64_t incx, std::complex<float> beta, std::complex<float> *y,
                 std::int64_t incy, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::hemv(queue, detail::get_onemkl_uplo(uplo), n, alpha, a, lda, x, incx, beta, y, incy, dependencies));
}
...
sycl::event her(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::her(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, a, lda, dependencies));
}
...
sycl::event her2(sycl::queue &queue, uplo uplo, std::int64_t n, std::complex<float> alpha,
                 ...
                 std::int64_t incy, std::complex<float> *a, std::int64_t lda,
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::her2(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, y, incy, a, lda, dependencies));
}
...
sycl::event hpmv(sycl::queue &queue, uplo uplo, std::int64_t n, std::complex<float> alpha,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::hpmv(queue, detail::get_onemkl_uplo(uplo), n, alpha, a, x, incx, beta, y, incy, dependencies));
}
...
sycl::event hpr(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha,
                const std::complex<float> *x, std::int64_t incx, std::complex<float> *a,
                const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::hpr(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, a, dependencies));
}
...
sycl::event hpr2(sycl::queue &queue, uplo uplo, std::int64_t n, std::complex<float> alpha,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::hpr2(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, y, incy, a, dependencies));
}
...
sycl::event sbmv(sycl::queue &queue, uplo uplo, std::int64_t n, std::int64_t k, float alpha,
                 const float *a, std::int64_t lda, const float *x, std::int64_t incx, float beta,
                 float *y, std::int64_t incy, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::sbmv(queue, detail::get_onemkl_uplo(uplo), n, k, alpha, a, lda, x, incx, beta, y, incy, dependencies));
}
...
sycl::event spmv(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, const float *a,
                 const float *x, std::int64_t incx, float beta, float *y, std::int64_t incy,
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::spmv(queue, detail::get_onemkl_uplo(uplo), n, alpha, a, x, incx, beta, y, incy, dependencies));
}
...
sycl::event spr(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, const float *x,
    ...
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::spr(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, a, dependencies));
}
...
sycl::event spr2(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, const float *x,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::spr2(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, y, incy, a, dependencies));
}
...
sycl::event symv(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, const float *a,
                 ...
                 std::int64_t incy, const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::symv(queue, detail::get_onemkl_uplo(uplo), n, alpha, a, lda, x, incx, beta, y, incy, dependencies));
}
...
sycl::event syr(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, const float *x,
                ...
                const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::syr(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, a, lda, dependencies));
}
...
sycl::event syr2(sycl::queue &queue, uplo uplo, std::int64_t n, float alpha, const float *x,
                 std::int64_t incx, const float *y, std::int64_t incy, float *a, std::int64_t lda,
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::syr2(queue, detail::get_onemkl_uplo(uplo), n, alpha, x, incx, y, incy, a, lda, dependencies));
}
...
sycl::event tbmv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::tbmv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, k, a, lda, x, incx, dependencies));
}
...
sycl::event tbsv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n,
                 std::int64_t k, const float *a, std::int64_t lda, float *x, std::int64_t incx,
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::tbsv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, k, a, lda, x, incx, dependencies));
}
...
sycl::event tpmv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::tpmv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, a, x, incx, dependencies));
}
...
sycl::event tpsv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n,
                 const float *a, float *x, std::int64_t incx,
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::tpsv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, a, x, incx, dependencies));
}
...
sycl::event trmv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n,
                 ...
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::trmv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, a, lda, x, incx, dependencies));
}
...
sycl::event trsv(sycl::queue &queue, uplo uplo, transpose trans, diag diag, std::int64_t n,
                 const float *a, std::int64_t lda, float *x, std::int64_t incx,
                 const std::vector<sycl::event> &dependencies) {
    RETHROW_ONEMKL_EXCEPTIONS_RET(blas_major::trsv(queue, detail::get_onemkl_uplo(uplo), detail::get_onemkl_transpose(trans), detail::get_onemkl_diag(diag), n, a, lda, x, incx, dependencies));
}
