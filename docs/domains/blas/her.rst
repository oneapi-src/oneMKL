...
.. container::
   ...
   .. container:: section
      ...
      .. cpp:function:: void oneapi::mkl::blas::her(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, sycl::buffer<T,1> &x, std::int64_t incx, sycl::buffer<T,1> &a, std::int64_t lda)
.. container:: section
...
.. container::
   ...
   .. container:: section
      ...
      .. container:: dlsyntaxpara
         ...
         .. cpp:function::  sycl::event oneapi::mkl::blas::her(sycl::queue &queue, uplo upper_lower, std::int64_t n, T alpha, const T *x, std::int64_t incx, T *a, std::int64_t lda, const sycl::vector_class<sycl::event> &dependencies = {})
   .. container:: section
