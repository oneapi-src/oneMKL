...
#else
        TEST_RUN_LAPACK_CT_SELECT(queue, oneapi::math::lapack::unmtr, side, uplo, trans, m, n, A_dev,
...
bool usm_dependency(const sycl::device& dev, oneapi::math::uplo uplo, int64_t m, int64_t n,
    ...
    bool result;
    {
        ...
        TEST_RUN_LAPACK_CT_SELECT(queue, func_event = oneapi::math::lapack::unmtr, side, uplo, trans,
