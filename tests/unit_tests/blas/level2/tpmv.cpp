    ...
    try {
        ...
        switch (layout) {
            case oneapi::math::layout::col_major:
                oneapi::math::blas::column_major::tpmv(main_queue, upper_lower, transa, unit_nonunit,
                                                      n, A_buffer, x_buffer, incx);
                break;
            case oneapi::math::layout::row_major:
                oneapi::math::blas::row_major::tpmv(main_queue, upper_lower, transa, unit_nonunit, n,
