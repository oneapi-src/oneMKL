    ...
    try {
        ...
        switch (layout) {
            case oneapi::math::layout::col_major:
                oneapi::math::blas::column_major::tbsv(main_queue, upper_lower, transa, unit_nonunit,
                                                      n, k, A_buffer, lda, x_buffer, incx);
                break;
            case oneapi::math::layout::row_major:
                oneapi::math::blas::row_major::tbsv(main_queue, upper_lower, transa, unit_nonunit, n,
