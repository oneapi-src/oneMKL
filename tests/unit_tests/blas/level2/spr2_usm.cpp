...
int test(device* dev, oneapi::mkl::layout layout, oneapi::mkl::uplo upper_lower, int n,
    ...
    try {
        ...
        switch (layout) {
            case oneapi::mkl::layout::column_major:
                TEST_RUN_CT(main_queue, oneapi::mkl::blas::column_major::spr2,
                            (main_queue, upper_lower, n, alpha, x.data(), incx, y.data(), incy,
                             A.data(), dependencies));
                break;
            case oneapi::mkl::layout::row_major:
                TEST_RUN_CT(main_queue, oneapi::mkl::blas::row_major::spr2,
                            (main_queue, upper_lower, n, alpha, x.data(), incx, y.data(), incy,
                             A.data(), dependencies));
                break;
            default: break;
