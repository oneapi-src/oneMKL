    ...
    try {
        ...
        switch (layout) {
            case oneapi::math::layout::col_major:
                oneapi::math::blas::column_major::trmv(main_queue, upper_lower, transa, unit_nonunit,
                                                      n, A_buffer, lda, x_buffer, incx);
                break;
            case oneapi::math::layout::row_major:
                oneapi::math::blas::row_major::trmv(main_queue, upper_lower, transa, unit_nonunit, n,
        ...
        switch (layout) {
            case oneapi::math::layout::col_major:
                ...
                break;
            case oneapi::math::layout::row_major:
                TEST_RUN_BLAS_CT_SELECT(main_queue, oneapi::math::blas::row_major::trmv, upper_lower,
