...
inline void axpy_batch_precondition(cl::sycl::queue &queue, std::int64_t n, std::complex<float> alpha,
...
inline void axpy_batch_postcondition(cl::sycl::queue &queue, std::int64_t n, std::complex<float> alpha,
                cl::sycl::buffer<std::complex<float>,1> &x, std::int64_t incx, std::int64_t stridex,
                cl::sycl::buffer<std::complex<float>,1> &y, std::int64_t incy, std::int64_t stridey,
                std::int64_t batch_size) {
#ifndef ONEMKL_DISABLE_PREDICATES
...
inline void axpy_batch_precondition(cl::sycl::queue &queue, std::int64_t n, std::complex<double> alpha,
...
inline void axpy_batch_postcondition(cl::sycl::queue &queue, std::int64_t n, std::complex<double> alpha,
                cl::sycl::buffer<std::complex<double>,1> &x, std::int64_t incx, std::int64_t stridex,
                cl::sycl::buffer<std::complex<double>,1> &y, std::int64_t incy, std::int64_t stridey,
                std::int64_t batch_size) {
#ifndef ONEMKL_DISABLE_PREDICATES
...
inline void gemv_batch_precondition(cl::sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
...
inline void gemv_batch_postcondition(cl::sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
                        float alpha, cl::sycl::buffer<float, 1> &a, std::int64_t lda, std::int64_t stridea,
                        cl::sycl::buffer<float, 1> &x, std::int64_t incx, std::int64_t stridex, float beta,
                        cl::sycl::buffer<float, 1> &y, std::int64_t incy, std::int64_t stridey, std::int64_t batch_size) {
#ifndef ONEMKL_DISABLE_PREDICATES
...
inline void dgmm_batch_precondition(cl::sycl::queue &queue, side left_right,
...
inline void dgmm_batch_postcondition(cl::sycl::queue &queue, side left_right,
              std::int64_t m, std::int64_t n, 
              cl::sycl::buffer<float, 1> &a, std::int64_t lda, std::int64_t stridea,
              cl::sycl::buffer<float, 1> &x, std::int64_t incx, std::int64_t stridex,
              cl::sycl::buffer<float, 1> &c, std::int64_t ldc, std::int64_t stridec, std::int64_t batch_size) {
...
inline void gemm_precondition(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
...
inline void gemm_postcondition(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
                        std::int64_t n, std::int64_t k, float alpha, cl::sycl::buffer<bfloat16, 1> &a,
                        std::int64_t lda, cl::sycl::buffer<bfloat16, 1> &b, std::int64_t ldb,
                        float beta, cl::sycl::buffer<float, 1> &c, std::int64_t ldc) {
#ifndef ONEMKL_DISABLE_PREDICATES
...
inline void gemm_batch_precondition(cl::sycl::queue &queue, transpose *transa, transpose *transb,
                                    std::int64_t *m, std::int64_t *n, std::int64_t *k,
                                    half *alpha, const half **a, std::int64_t *lda,
...
inline void axpby_precondition(cl::sycl::queue &queue, std::int64_t n, float alpha, const float *x, std::int64_t incx, const float beta, 
...
inline void axpby_postcondition(cl::sycl::queue &queue, std::int64_t n, float alpha, const float *x, std::int64_t incx, const float beta, 
    float *y, std::int64_t incy, const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
#ifndef ONEMKL_DISABLE_PREDICATES
    /* add postchecks to queue here for input args.  */
#endif
...
inline void axpby_precondition(cl::sycl::queue &queue, std::int64_t n, double alpha, const double *x, std::int64_t incx, const double beta, 
...
inline void axpby_postcondition(cl::sycl::queue &queue, std::int64_t n, double alpha, const double *x, std::int64_t incx, const double beta, 
    double *y, std::int64_t incy, const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
#ifndef ONEMKL_DISABLE_PREDICATES
    /* add postchecks to queue here for input args.  */
#endif
...
inline void axpby_precondition(cl::sycl::queue &queue, std::int64_t n, std::complex<float> alpha, const std::complex<float> *x, std::int64_t incx, const std::complex<float> beta, 
...
inline void axpby_postcondition(cl::sycl::queue &queue, std::int64_t n, std::complex<float> alpha, const std::complex<float> *x, std::int64_t incx, const std::complex<float> beta, 
    std::complex<float> *y, std::int64_t incy, const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
#ifndef ONEMKL_DISABLE_PREDICATES
    /* add postchecks to queue here for input args.  */
#endif
...
inline void axpby_precondition(cl::sycl::queue &queue, std::int64_t n, std::complex<double> alpha, const std::complex<double> *x, std::int64_t incx, const std::complex<double> beta, 
...
inline void axpby_postcondition(cl::sycl::queue &queue, std::int64_t n, std::complex<double> alpha, const std::complex<double> *x, std::int64_t incx, const std::complex<double> beta, 
    std::complex<double> *y, std::int64_t incy, const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
#ifndef ONEMKL_DISABLE_PREDICATES
    /* add postchecks to queue here for input args.  */
#endif
...
inline void gemv_batch_precondition(cl::sycl::queue &queue, transpose trans,
              std::int64_t m, std::int64_t n, float alpha,
...
inline void gemv_batch_postcondition(cl::sycl::queue &queue, transpose trans,
              std::int64_t m, std::int64_t n, float alpha,
              const float *a, std::int64_t lda, std::int64_t stridea,
              const float *x, std::int64_t incx, std::int64_t stridex, float beta,
              float *y, std::int64_t incy, std::int64_t stridey, std::int64_t batch_size,
...
inline dgmm_batch_precondition(cl::sycl::queue &queue, side left_right,
              std::int64_t m, std::int64_t n,
              const float *a, std::int64_t lda, std::int64_t stridea,
              const float *x, std::int64_t incx, std::int64_t stridex,
...
inline dgmm_batch_postcondition(cl::sycl::queue &queue, side left_right,
              std::int64_t m, std::int64_t n,
              const float *a, std::int64_t lda, std::int64_t stridea,
              const float *x, std::int64_t incx, std::int64_t stridex,
              float *c, std::int64_t ldc, std::int64_t stridec, std::int64_t batch_size,
...
inline void gemm_precondition(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
...
inline void gemm_postcondition(cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m, std::int64_t n,
    std::int64_t k, float alpha, const half *a, std::int64_t lda, const half *b,
    std::int64_t ldb, float beta, float *c, std::int64_t ldc,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
#ifndef ONEMKL_DISABLE_PREDICATES
