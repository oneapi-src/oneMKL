...
void omatcopy(backend_selector<backend::syclblas> selector, transpose trans, std::int64_t m,
              std::int64_t n, float alpha, sycl::buffer<float, 1> &a, std::int64_t lda,
              sycl::buffer<float, 1> &b, std::int64_t ldb) {
    oneapi::mkl::blas::syclblas::MAJOR::omatcopy(selector.get_queue(), trans, m, n, alpha, a, lda,
                                                 b, ldb);
}
...
void imatcopy(backend_selector<backend::syclblas> selector, transpose trans, std::int64_t m,
              std::int64_t n, float alpha, sycl::buffer<float, 1> &ab, std::int64_t lda,
              std::int64_t ldb) {
    oneapi::mkl::blas::syclblas::MAJOR::imatcopy(selector.get_queue(), trans, m, n, alpha, ab, lda,
                                                 ldb);
}
...
void omatadd(backend_selector<backend::syclblas> selector, transpose transa, transpose transb,
             std::int64_t m, std::int64_t n, float alpha, sycl::buffer<float, 1> &a,
             std::int64_t lda, float beta, sycl::buffer<float, 1> &b, std::int64_t ldb,
             sycl::buffer<float, 1> &c, std::int64_t ldc) {
    oneapi::mkl::blas::syclblas::MAJOR::omatadd(selector.get_queue(), transa, transb, m, n, alpha,
...
sycl::event omatcopy(backend_selector<backend::syclblas> selector, transpose trans, std::int64_t m,
                     std::int64_t n, float alpha, const float *a, std::int64_t lda, float *b,
                     std::int64_t ldb, const std::vector<sycl::event> &dependencies) {
    auto done = oneapi::mkl::blas::syclblas::MAJOR::omatcopy(selector.get_queue(), trans, m, n,
...
sycl::event imatcopy(backend_selector<backend::syclblas> selector, transpose trans, std::int64_t m,
                     std::int64_t n, float alpha, float *ab, std::int64_t lda, std::int64_t ldb,
                     const std::vector<sycl::event> &dependencies) {
    auto done = oneapi::mkl::blas::syclblas::MAJOR::imatcopy(selector.get_queue(), trans, m, n,
...
sycl::event omatadd(backend_selector<backend::syclblas> selector, transpose transa,
                    ...
                    std::int64_t ldc, const std::vector<sycl::event> &dependencies) {
    auto done = oneapi::mkl::blas::syclblas::MAJOR::omatadd(selector.get_queue(), transa, transb, m,
