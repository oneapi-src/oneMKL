...
void herk(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::mklcpu::MAJOR::herk(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c,
                                            ldc);
...
void scal(backend_selector<backend::mklcpu> selector, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::scal(selector.get_queue(), n, alpha, x, incx);
...
void trmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::mklcpu::MAJOR::trmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x,
                                            incx);
...
void tpmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::mklcpu::MAJOR::tpmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx);
...
void spr(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::spr(selector.get_queue(), upper_lower, n, alpha, x, incx, a);
...
void gemm_batch(backend_selector<backend::mklcpu> selector, transpose transa, transpose transb,
    ...
    gemm_batch_precondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, stride_a, b, ldb,
                            stride_b, beta, c, ldc, stride_c, batch_size);
    oneapi::mkl::mklcpu::MAJOR::gemm_batch(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda,
                                                  stride_a, b, ldb, stride_b, beta, c, ldc,
                                                  stride_c, batch_size);
    gemm_batch_postcondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, stride_a, b, ldb,
                             stride_b, beta, c, ldc, stride_c, batch_size);
}
...
void syrk(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::mklcpu::MAJOR::syrk(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c,
                                            ldc);
...
void her2(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::her2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
...
void hbmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, std::int64_t k,
    ...
    hbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy);
    oneapi::mkl::mklcpu::MAJOR::hbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta,
                                            y, incy);
    hbmv_postcondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy);
}
...
void rot(backend_selector<backend::mklcpu> selector, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::rot(selector.get_queue(), n, x, incx, y, incy, c, s);
...
void rot(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
...
void rot(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
...
void axpy(backend_selector<backend::mklcpu> selector, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::axpy(selector.get_queue(), n, alpha, x, incx, y, incy);
...
void sdsdot(backend_selector<backend::mklcpu> selector, std::int64_t n, float sb,
    ...
    oneapi::mkl::mklcpu::MAJOR::sdsdot(selector.get_queue(), n, sb, x, incx, y, incy, result);
...
void gerc(backend_selector<backend::mklcpu> selector, std::int64_t m, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::gerc(selector.get_queue(), m, n, alpha, x, incx, y, incy, a, lda);
...
void syr2k(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
                            ...
                            cl::sycl::buffer<float, 1> &c, std::int64_t ldc) {
    syr2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc);
    oneapi::mkl::mklcpu::MAJOR::syr2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb,
                                             beta, c, ldc);
    syr2k_postcondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc);
}
...
void gemv(backend_selector<backend::mklcpu> selector, transpose trans, std::int64_t m, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::gemv(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx, beta, y,
                                            incy);
...
void her(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::her(selector.get_queue(), upper_lower, n, alpha, x, incx, a, lda);
...
void hpr(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::hpr(selector.get_queue(), upper_lower, n, alpha, x, incx, a);
...
void iamin(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
    iamin_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::mklcpu::MAJOR::iamin(selector.get_queue(), n, x, incx, result);
    iamin_postcondition(selector.get_queue(), n, x, incx, result);
}

void iamin(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
    iamin_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::mklcpu::MAJOR::iamin(selector.get_queue(), n, x, incx, result);
    iamin_postcondition(selector.get_queue(), n, x, incx, result);
...
void hpmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::hpmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y,
                                            incy);
...
void spmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::spmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y,
                                            incy);
    spmv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y, incy);
}

void spmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, double alpha,
...
void gemm_bias(backend_selector<backend::mklcpu> selector, transpose transa, transpose transb,
    ...
    gemm_bias_precondition(selector.get_queue(), transa, transb, offsetc, m, n, k, alpha, a, lda, ao, b, ldb, bo,
                           beta, c, ldc, co);
    oneapi::mkl::mklcpu::MAJOR::gemm_bias(selector.get_queue(), transa, transb, offsetc, m, n, k, alpha, a,
                                                 lda, ao, b, ldb, bo, beta, c, ldc, co);
    gemm_bias_postcondition(selector.get_queue(), transa, transb, offsetc, m, n, k, alpha, a, lda, ao, b, ldb, bo,
                            beta, c, ldc, co);
}

void swap(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy) {
    swap_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::mklcpu::MAJOR::swap(selector.get_queue(), n, x, incx, y, incy);
    swap_postcondition(selector.get_queue(), n, x, incx, y, incy);
}

void swap(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy) {
    swap_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::mklcpu::MAJOR::swap(selector.get_queue(), n, x, incx, y, incy);
    swap_postcondition(selector.get_queue(), n, x, incx, y, incy);
...
void geru(backend_selector<backend::mklcpu> selector, std::int64_t m, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::geru(selector.get_queue(), m, n, alpha, x, incx, y, incy, a, lda);
...
void nrm2(backend_selector<backend::mklcpu> selector, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::nrm2(selector.get_queue(), n, x, incx, result);
...
void nrm2(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
...
void nrm2(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
...
void gemm(backend_selector<backend::mklcpu> selector, transpose transa, transpose transb,
                           ...
                           cl::sycl::buffer<float, 1> &b, std::int64_t ldb, float beta,
                           cl::sycl::buffer<float, 1> &c, std::int64_t ldc) {
    gemm_precondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc);
    oneapi::mkl::mklcpu::MAJOR::gemm(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb,
                                            beta, c, ldc);
    gemm_postcondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc);
}
...
void syr2(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::syr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
    syr2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
}

void syr2(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, double alpha,
                           cl::sycl::buffer<double, 1> &x, std::int64_t incx,
                           cl::sycl::buffer<double, 1> &y, std::int64_t incy,
                           cl::sycl::buffer<double, 1> &a, std::int64_t lda) {
    syr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
...
void ger(backend_selector<backend::mklcpu> selector, std::int64_t m, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::ger(selector.get_queue(), m, n, alpha, x, incx, y, incy, a, lda);
...
void trsm(backend_selector<backend::mklcpu> selector, side left_right, uplo upper_lower,
    ...
    trsm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                      ldb);
    oneapi::mkl::mklcpu::MAJOR::trsm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n,
                                            alpha, a, lda, b, ldb);
    trsm_postcondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                       ldb);
}
...
void dotu(backend_selector<backend::mklcpu> selector, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::dotu(selector.get_queue(), n, x, incx, y, incy, result);
...
void hemm(backend_selector<backend::mklcpu> selector, side left_right, uplo upper_lower,
                           ...
                           std::complex<float> beta, cl::sycl::buffer<std::complex<float>, 1> &c,
                           std::int64_t ldc) {
    hemm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc);
    oneapi::mkl::mklcpu::MAJOR::hemm(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b,
                                            ldb, beta, c, ldc);
    hemm_postcondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc);
}
...
void hpr2(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::hpr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
...
void gbmv(backend_selector<backend::mklcpu> selector, transpose trans, std::int64_t m, std::int64_t n,
                           std::int64_t kl, std::int64_t ku, float alpha,
                           cl::sycl::buffer<float, 1> &a, std::int64_t lda,
                           cl::sycl::buffer<float, 1> &x, std::int64_t incx, float beta,
                           cl::sycl::buffer<float, 1> &y, std::int64_t incy) {
    gbmv_precondition(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx, beta, y, incy);
    oneapi::mkl::mklcpu::MAJOR::gbmv(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx,
                                            beta, y, incy);
    gbmv_postcondition(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx, beta, y, incy);
}
...
void tbmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::mklcpu::MAJOR::tbmv(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x,
                                            incx);
...
void symm(backend_selector<backend::mklcpu> selector, side left_right, uplo upper_lower,
                           ...
                           cl::sycl::buffer<float, 1> &b, std::int64_t ldb, float beta,
                           cl::sycl::buffer<float, 1> &c, std::int64_t ldc) {
    symm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc);
    oneapi::mkl::mklcpu::MAJOR::symm(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b,
                                            ldb, beta, c, ldc);
    symm_postcondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc);
}
...
void dotc(backend_selector<backend::mklcpu> selector, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::dotc(selector.get_queue(), n, x, incx, y, incy, result);
...
void syr(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::syr(selector.get_queue(), upper_lower, n, alpha, x, incx, a, lda);
...
void trmm(backend_selector<backend::mklcpu> selector, side left_right, uplo upper_lower,
                           ...
                           float alpha, cl::sycl::buffer<float, 1> &a, std::int64_t lda,
                           cl::sycl::buffer<float, 1> &b, std::int64_t ldb) {
    trmm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                      ldb);
    oneapi::mkl::mklcpu::MAJOR::trmm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n,
                                            alpha, a, lda, b, ldb);
    trmm_postcondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                       ldb);
}
...
void rotmg(backend_selector<backend::mklcpu> selector, cl::sycl::buffer<float, 1> &d1,
    ...
    oneapi::mkl::mklcpu::MAJOR::rotmg(selector.get_queue(), d1, d2, x1, y1, param);
    rotmg_postcondition(selector.get_queue(), d1, d2, x1, y1, param);
}

void rotmg(backend_selector<backend::mklcpu> selector, cl::sycl::buffer<double, 1> &d1,
...
void tpsv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::mklcpu::MAJOR::tpsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx);
...
void trsv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::mklcpu::MAJOR::trsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x,
                                            incx);
...
void copy(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy) {
    copy_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::mklcpu::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy);
    copy_postcondition(selector.get_queue(), n, x, incx, y, incy);
}

void copy(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy) {
    copy_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::mklcpu::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy);
    copy_postcondition(selector.get_queue(), n, x, incx, y, incy);
...
void hemv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::hemv(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y,
                                            incy);
...
void gemmt(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose transa,
                            ...
                            cl::sycl::buffer<float, 1> &b, std::int64_t ldb, float beta,
                            cl::sycl::buffer<float, 1> &c, std::int64_t ldc) {
    gemmt_precondition(selector.get_queue(), upper_lower, transa, transb, n, k, alpha, a, lda, b, ldb, beta, c,
                       ldc);
    oneapi::mkl::mklcpu::MAJOR::gemmt(selector.get_queue(), upper_lower, transa, transb, n, k, alpha, a,
                                             lda, b, ldb, beta, c, ldc);
    gemmt_postcondition(selector.get_queue(), upper_lower, transa, transb, n, k, alpha, a, lda, b, ldb, beta, c,
                        ldc);
}
...
void asum(backend_selector<backend::mklcpu> selector, std::int64_t n,
    ...
    oneapi::mkl::mklcpu::MAJOR::asum(selector.get_queue(), n, x, incx, result);
...
void asum(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<float, 1> &result) {
    asum_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::mklcpu::MAJOR::asum(selector.get_queue(), n, x, incx, result);
    asum_postcondition(selector.get_queue(), n, x, incx, result);
...
void asum(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &result) {
    asum_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::mklcpu::MAJOR::asum(selector.get_queue(), n, x, incx, result);
    asum_postcondition(selector.get_queue(), n, x, incx, result);
...
void sbmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, std::int64_t k,
                           float alpha, cl::sycl::buffer<float, 1> &a, std::int64_t lda,
                           cl::sycl::buffer<float, 1> &x, std::int64_t incx, float beta,
                           cl::sycl::buffer<float, 1> &y, std::int64_t incy) {
    sbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy);
    oneapi::mkl::mklcpu::MAJOR::sbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta,
                                            y, incy);
    sbmv_postcondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy);
}
...
void tbsv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::mklcpu::MAJOR::tbsv(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x,
                                            incx);
...
void spr2(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::spr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
    spr2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
}

void spr2(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, double alpha,
                           cl::sycl::buffer<double, 1> &x, std::int64_t incx,
                           cl::sycl::buffer<double, 1> &y, std::int64_t incy,
                           cl::sycl::buffer<double, 1> &a) {
    spr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
...
void iamax(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
    iamax_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::mklcpu::MAJOR::iamax(selector.get_queue(), n, x, incx, result);
    iamax_postcondition(selector.get_queue(), n, x, incx, result);
}

void iamax(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
    iamax_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::mklcpu::MAJOR::iamax(selector.get_queue(), n, x, incx, result);
    iamax_postcondition(selector.get_queue(), n, x, incx, result);
...
void rotm(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy,
                           cl::sycl::buffer<float, 1> &param) {
    rotm_precondition(selector.get_queue(), n, x, incx, y, incy, param);
    oneapi::mkl::mklcpu::MAJOR::rotm(selector.get_queue(), n, x, incx, y, incy, param);
    rotm_postcondition(selector.get_queue(), n, x, incx, y, incy, param);
}

void rotm(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy,
...
void dot(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                          std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy,
                          cl::sycl::buffer<float, 1> &result) {
    dot_precondition(selector.get_queue(), n, x, incx, y, incy, result);
    oneapi::mkl::mklcpu::MAJOR::dot(selector.get_queue(), n, x, incx, y, incy, result);
    dot_postcondition(selector.get_queue(), n, x, incx, y, incy, result);
}

void dot(backend_selector<backend::mklcpu> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                          std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy,
                          cl::sycl::buffer<double, 1> &result) {
    dot_precondition(selector.get_queue(), n, x, incx, y, incy, result);
    oneapi::mkl::mklcpu::MAJOR::dot(selector.get_queue(), n, x, incx, y, incy, result);
...
void trsm_batch(backend_selector<backend::mklcpu> selector, side left_right, uplo upper_lower,
    ...
    trsm_batch_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda,
                            stride_a, b, ldb, stride_b, batch_size);
    oneapi::mkl::mklcpu::MAJOR::trsm_batch(selector.get_queue(), left_right, upper_lower, trans, unit_diag,
                                                  m, n, alpha, a, lda, stride_a, b, ldb, stride_b,
                                                  batch_size);
    trsm_batch_postcondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda,
                             stride_a, b, ldb, stride_b, batch_size);
}
...
void her2k(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
                            ...
                            float beta, cl::sycl::buffer<std::complex<float>, 1> &c,
                            std::int64_t ldc) {
    her2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc);
    oneapi::mkl::mklcpu::MAJOR::her2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb,
                                             beta, c, ldc);
    her2k_postcondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc);
}
...
void rotg(backend_selector<backend::mklcpu> selector, cl::sycl::buffer<float, 1> &a,
                           cl::sycl::buffer<float, 1> &b, cl::sycl::buffer<float, 1> &c,
                           cl::sycl::buffer<float, 1> &s) {
    rotg_precondition(selector.get_queue(), a, b, c, s);
    oneapi::mkl::mklcpu::MAJOR::rotg(selector.get_queue(), a, b, c, s);
    rotg_postcondition(selector.get_queue(), a, b, c, s);
}

void rotg(backend_selector<backend::mklcpu> selector, cl::sycl::buffer<double, 1> &a,
...
void rotg(backend_selector<backend::mklcpu> selector, cl::sycl::buffer<std::complex<float>, 1> &a,
...
void rotg(backend_selector<backend::mklcpu> selector, cl::sycl::buffer<std::complex<double>, 1> &a,
...
void symv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::mklcpu::MAJOR::symv(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y,
                                            incy);
    symv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy);
}

void symv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n, double alpha,
                           cl::sycl::buffer<double, 1> &a, std::int64_t lda,
                           cl::sycl::buffer<double, 1> &x, std::int64_t incx, double beta,
                           cl::sycl::buffer<double, 1> &y, std::int64_t incy) {
    symv_precondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy);
...
cl::sycl::event syr2(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    syr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::syr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
                                                        incy, a, lda, dependencies);
    syr2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda, dependencies);
    return done;
}
...
cl::sycl::event scal(backend_selector<backend::mklcpu> selector, std::int64_t n, float alpha, float *x,
                                      std::int64_t incx,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    scal_precondition(selector.get_queue(), n, alpha, x, incx, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::scal(selector.get_queue(), n, alpha, x, incx, dependencies);
...
cl::sycl::event trmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
                                      ...
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    trmv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x, incx, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::trmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
                                                        lda, x, incx, dependencies);
    trmv_postcondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x, incx, dependencies);
    return done;
}
...
cl::sycl::event tpmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
                                      ...
                                      std::int64_t incx,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    tpmv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::tpmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
                                                        x, incx, dependencies);
    tpmv_postcondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx, dependencies);
    return done;
}
...
cl::sycl::event spr(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::spr(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       dependencies);
...
cl::sycl::event hpmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
                                      std::complex<float> alpha, const std::complex<float> *a,
                                      const std::complex<float> *x, std::int64_t incx,
                                      std::complex<float> beta, std::complex<float> *y,
                                      std::int64_t incy,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    hpmv_precondition(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y, incy, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::hpmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx,
                                                        beta, y, incy, dependencies);
    hpmv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y, incy, dependencies);
    return done;
}
...
cl::sycl::event syrk(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
                                      ...
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    syrk_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c, ldc, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::syrk(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
                                                        lda, beta, c, ldc, dependencies);
    syrk_postcondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c, ldc, dependencies);
    return done;
}
...
cl::sycl::event her2(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
                                      ...
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    her2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::her2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
                                                        incy, a, lda, dependencies);
    her2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda, dependencies);
    return done;
}
...
cl::sycl::event hbmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    hbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::hbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x,
...
cl::sycl::event rot(backend_selector<backend::mklcpu> selector, std::int64_t n, std::complex<float> *x,
    ...
    auto done =
        oneapi::mkl::mklcpu::MAJOR::rot(selector.get_queue(), n, x, incx, y, incy, c, s, dependencies);
...
cl::sycl::event axpy(backend_selector<backend::mklcpu> selector, std::int64_t n, float alpha,
    ...
    auto done =
        oneapi::mkl::mklcpu::MAJOR::axpy(selector.get_queue(), n, alpha, x, incx, y, incy, dependencies);
...
cl::sycl::event axpy_batch(
    backend_selector<backend::mklcpu> selector, std::int64_t *n, float *alpha, const float **x, std::int64_t *incx,
    float **y, std::int64_t *incy, std::int64_t group_count, std::int64_t *group_size,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    axpy_batch_precondition(selector.get_queue(), n, alpha, x, incx, y, incy, group_count, group_size,
                            dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::axpy_batch(
        selector.get_queue(), n, alpha, x, incx, y, incy, group_count, group_size, dependencies);
    axpy_batch_postcondition(selector.get_queue(), n, alpha, x, incx, y, incy, group_count, group_size,
                             dependencies);
    return done;
}

cl::sycl::event axpy_batch(
    backend_selector<backend::mklcpu> selector, std::int64_t *n, double *alpha, const double **x, std::int64_t *incx,
...
cl::sycl::event axpy_batch(
    backend_selector<backend::mklcpu> selector, std::int64_t *n, std::complex<float> *alpha,
...
cl::sycl::event axpy_batch(
    backend_selector<backend::mklcpu> selector, std::int64_t *n, std::complex<double> *alpha,
...
cl::sycl::event gerc(backend_selector<backend::mklcpu> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::gerc(selector.get_queue(), m, n, alpha, x, incx, y, incy, a,
                                                        lda, dependencies);
...
cl::sycl::event syr2k(
    backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans, std::int64_t n, std::int64_t k,
    ...
    syr2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::syr2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
...
cl::sycl::event gemv(backend_selector<backend::mklcpu> selector, transpose trans, std::int64_t m,
                                      ...
                                      std::int64_t incy,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    gemv_precondition(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx, beta, y, incy, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::gemv(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx,
                                                        beta, y, incy, dependencies);
    gemv_postcondition(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx, beta, y, incy, dependencies);
    return done;
}
...
cl::sycl::event her(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::her(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       lda, dependencies);
...
cl::sycl::event hpr(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::hpr(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       dependencies);
...
cl::sycl::event iamin(
    backend_selector<backend::mklcpu> selector, std::int64_t n, const float *x, std::int64_t incx, std::int64_t *result,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamin_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::iamin(selector.get_queue(), n, x, incx, result, dependencies);
    iamin_postcondition(selector.get_queue(), n, x, incx, result, dependencies);
    return done;
}

cl::sycl::event iamin(
    backend_selector<backend::mklcpu> selector, std::int64_t n, const double *x, std::int64_t incx,
...
cl::sycl::event iamin(
    backend_selector<backend::mklcpu> selector, std::int64_t n, const std::complex<float> *x, std::int64_t incx,
    std::int64_t *result, const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamin_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::iamin(selector.get_queue(), n, x, incx, result, dependencies);
    iamin_postcondition(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event iamin(
    backend_selector<backend::mklcpu> selector, std::int64_t n, const std::complex<double> *x, std::int64_t incx,
    std::int64_t *result, const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamin_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::iamin(selector.get_queue(), n, x, incx, result, dependencies);
    iamin_postcondition(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event gemm_batch(
    backend_selector<backend::mklcpu> selector, transpose *transa, transpose *transb, std::int64_t *m, std::int64_t *n,
    ...
    gemm_batch_precondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                            group_count, group_size, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::gemm_batch(
        selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc, group_count,
        group_size, dependencies);
    gemm_batch_postcondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                             group_count, group_size, dependencies);
    return done;
}
...
cl::sycl::event gemm_batch(
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::gemm_batch(
        selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, stride_a, b, ldb, stride_b, beta, c, ldc,
...
cl::sycl::event spmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
                                      ...
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    spmv_precondition(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y, incy, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::spmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx,
                                                        beta, y, incy, dependencies);
    spmv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y, incy, dependencies);
    return done;
}
...
cl::sycl::event swap(backend_selector<backend::mklcpu> selector, std::int64_t n, float *x,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::swap(selector.get_queue(), n, x, incx, y, incy, dependencies);
...
cl::sycl::event geru(backend_selector<backend::mklcpu> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::geru(selector.get_queue(), m, n, alpha, x, incx, y, incy, a,
                                                        lda, dependencies);
...
cl::sycl::event nrm2(backend_selector<backend::mklcpu> selector, std::int64_t n,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::nrm2(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event gemm(backend_selector<backend::mklcpu> selector, transpose transa, transpose transb,
    ...
    gemm_precondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::gemm(selector.get_queue(), transa, transb, m, n, k, alpha, a,
                                                        lda, b, ldb, beta, c, ldc, dependencies);
    gemm_postcondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    return done;
...
cl::sycl::event herk(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
                                      ...
                                      std::complex<float> *c, std::int64_t ldc,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    herk_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c, ldc, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::herk(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
                                                        lda, beta, c, ldc, dependencies);
    herk_postcondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c, ldc, dependencies);
    return done;
}
...
cl::sycl::event ger(backend_selector<backend::mklcpu> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::ger(selector.get_queue(), m, n, alpha, x, incx, y, incy, a, lda,
                                                       dependencies);
...
cl::sycl::event trsm(backend_selector<backend::mklcpu> selector, side left_right, uplo upper_lower,
                                      ...
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    trsm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b, ldb,
                      dependencies);
    auto done =
        oneapi::mkl::mklcpu::MAJOR::trsm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m,
...
cl::sycl::event dotu(backend_selector<backend::mklcpu> selector, std::int64_t n,
    ...
    auto done =
        oneapi::mkl::mklcpu::MAJOR::dotu(selector.get_queue(), n, x, incx, y, incy, result, dependencies);
...
cl::sycl::event hemm(backend_selector<backend::mklcpu> selector, side left_right, uplo upper_lower,
                                      std::int64_t m, std::int64_t n, std::complex<float> alpha,
                                      const std::complex<float> *a, std::int64_t lda,
    ...
    hemm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::hemm(selector.get_queue(), left_right, upper_lower, m, n, alpha,
...
cl::sycl::event hpr2(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
                                      ...
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    hpr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::hpr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
                                                        incy, a, dependencies);
    hpr2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, dependencies);
    return done;
}
...
cl::sycl::event gbmv(backend_selector<backend::mklcpu> selector, transpose trans, std::int64_t m,
    ...
    gbmv_precondition(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::gbmv(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda,
...
cl::sycl::event tbmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
                                      ...
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    tbmv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x, incx, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::tbmv(selector.get_queue(), upper_lower, trans, unit_diag, n, k,
                                                        a, lda, x, incx, dependencies);
    tbmv_postcondition(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x, incx, dependencies);
    return done;
}
...
cl::sycl::event symm(backend_selector<backend::mklcpu> selector, side left_right, uplo upper_lower,
    ...
    symm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::symm(selector.get_queue(), left_right, upper_lower, m, n, alpha,
                                                        a, lda, b, ldb, beta, c, ldc, dependencies);
    symm_postcondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    return done;
...
cl::sycl::event dotc(backend_selector<backend::mklcpu> selector, std::int64_t n,
    ...
    auto done =
        oneapi::mkl::mklcpu::MAJOR::dotc(selector.get_queue(), n, x, incx, y, incy, result, dependencies);
...
cl::sycl::event syr(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::syr(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       lda, dependencies);
...
cl::sycl::event trmm(backend_selector<backend::mklcpu> selector, side left_right, uplo upper_lower,
                                      ...
                                      float *b, std::int64_t ldb,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    trmm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b, ldb,
                      dependencies);
    auto done =
        oneapi::mkl::mklcpu::MAJOR::trmm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m,
                                                n, alpha, a, lda, b, ldb, dependencies);
    trmm_postcondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                       ldb, dependencies);
    return done;
...
cl::sycl::event rotmg(
    backend_selector<backend::mklcpu> selector, float *d1, float *d2, float *x1, float y1, float *param,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    rotmg_precondition(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    auto done =
        oneapi::mkl::mklcpu::MAJOR::rotmg(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    rotmg_postcondition(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    return done;
}

cl::sycl::event rotmg(
    backend_selector<backend::mklcpu> selector, double *d1, double *d2, double *x1, double y1, double *param,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    rotmg_precondition(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    auto done =
        oneapi::mkl::mklcpu::MAJOR::rotmg(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
...
cl::sycl::event tpsv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
                                      ...
                                      std::int64_t incx,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    tpsv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::tpsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
                                                        x, incx, dependencies);
    tpsv_postcondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx, dependencies);
    return done;
}
...
cl::sycl::event trsv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
                                      ...
                                      std::int64_t lda, float *x, std::int64_t incx,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    trsv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x, incx, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::trsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
                                                        lda, x, incx, dependencies);
    trsv_postcondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x, incx, dependencies);
    return done;
}
...
cl::sycl::event copy(backend_selector<backend::mklcpu> selector, std::int64_t n, const float *x,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy, dependencies);
...
cl::sycl::event hemv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
                                      std::complex<float> alpha, const std::complex<float> *a,
                                      std::int64_t lda, const std::complex<float> *x,
                                      std::int64_t incx, std::complex<float> beta,
                                      std::complex<float> *y, std::int64_t incy,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    hemv_precondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::hemv(selector.get_queue(), upper_lower, n, alpha, a, lda, x,
                                                        incx, beta, y, incy, dependencies);
    hemv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy, dependencies);
    return done;
}
...
cl::sycl::event gemmt(
    backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose transa, transpose transb, std::int64_t n,
...
cl::sycl::event sbmv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
    ...
    sbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::sbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x,
                                                        incx, beta, y, incy, dependencies);
    sbmv_postcondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy,
                       dependencies);
    return done;
...
cl::sycl::event asum(backend_selector<backend::mklcpu> selector, std::int64_t n,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::asum(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event tbsv(backend_selector<backend::mklcpu> selector, uplo upper_lower, transpose trans,
                                      ...
                                      const float *a, std::int64_t lda, float *x, std::int64_t incx,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    tbsv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x, incx, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::tbsv(selector.get_queue(), upper_lower, trans, unit_diag, n, k,
                                                        a, lda, x, incx, dependencies);
    tbsv_postcondition(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x, incx, dependencies);
    return done;
}
...
cl::sycl::event spr2(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
                                      ...
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    spr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::spr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
                                                        incy, a, dependencies);
    spr2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, dependencies);
    return done;
}
...
cl::sycl::event iamax(
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::iamax(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event rotm(backend_selector<backend::mklcpu> selector, std::int64_t n, float *x,
    ...
    auto done =
        oneapi::mkl::mklcpu::MAJOR::rotm(selector.get_queue(), n, x, incx, y, incy, param, dependencies);
...
cl::sycl::event rotg(backend_selector<backend::mklcpu> selector, float *a, float *b, float *c,
    ...
    auto done = oneapi::mkl::mklcpu::MAJOR::rotg(selector.get_queue(), a, b, c, s, dependencies);
...
cl::sycl::event sdsdot(
    backend_selector<backend::mklcpu> selector, std::int64_t n, float sb, const float *x, std::int64_t incx,
    const float *y, std::int64_t incy, float *result,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    sdsdot_precondition(selector.get_queue(), n, sb, x, incx, y, incy, result, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::sdsdot(selector.get_queue(), n, sb, x, incx, y, incy, result,
                                                          dependencies);
...
cl::sycl::event her2k(
    ...
    her2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::her2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
                                                         lda, b, ldb, beta, c, ldc, dependencies);
    her2k_postcondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                        dependencies);
    return done;
...
cl::sycl::event dot(backend_selector<backend::mklcpu> selector, std::int64_t n, const float *x,
    ...
    auto done =
        oneapi::mkl::mklcpu::MAJOR::dot(selector.get_queue(), n, x, incx, y, incy, result, dependencies);
...
cl::sycl::event symv(backend_selector<backend::mklcpu> selector, uplo upper_lower, std::int64_t n,
                                      ...
                                      std::int64_t incx, float beta, float *y, std::int64_t incy,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    symv_precondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy, dependencies);
    auto done = oneapi::mkl::mklcpu::MAJOR::symv(selector.get_queue(), upper_lower, n, alpha, a, lda, x,
                                                        incx, beta, y, incy, dependencies);
    symv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy, dependencies);
    return done;
}
