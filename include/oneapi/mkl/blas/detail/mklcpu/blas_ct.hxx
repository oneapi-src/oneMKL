...
void axpy_batch(backend_selector<backend::mklcpu> selector, std::int64_t n, float alpha,
    ...
    axpy_batch_precondition(selector.get_queue(), n, alpha, x, incx, stridex, y, incy, stridey, batch_size);
    oneapi::mkl::blas::mklcpu::MAJOR::axpy_batch(selector.get_queue(), n, alpha, x, incx, stridex, y, incy, stridey, batch_size);
    axpy_batch_postcondition(selector.get_queue(), n, alpha, x, incx, stridex, y, incy, stridey, batch_size);
}
...
void axpy_batch(backend_selector<backend::mklcpu> selector, std::int64_t n, std::complex<float> alpha,
...
void axpy_batch(backend_selector<backend::mklcpu> selector, std::int64_t n, std::complex<double> alpha,
...
void gemv_batch(backend_selector<backend::mklcpu> selector, transpose trans, std::int64_t m, std::int64_t n,
                        ...
                        cl::sycl::buffer<float, 1> &y, std::int64_t incy, std::int64_t stridey, std::int64_t batch_size) {
    gemv_batch_precondition(selector.get_queue(), trans, m, n, alpha, a, lda, stridea, x, incx, stridex, beta, y, incy, stridey, batch_size);
    ...
    gemv_batch_postcondition(selector.get_queue(), trans, m, n, alpha, a, lda, stridea, x, incx, stridex, beta, y, incy, stridey, batch_size);
}
...
void dgmm_batch(backend_selector<backend::mklcpu> selector, side left_right,
    ...
    dgmm_batch_precondition(selector.get_queue(), left_right, m, n, a, lda, stridea, x, incx, stridex, c, ldc, stridec, batch_size);
    oneapi::mkl::blas::mklcpu::MAJOR::dgmm_batch(selector.get_queue(), left_right, m, n, a, lda, stridea, x, incx, stridex, c, ldc, stridec, batch_size);
    dgmm_batch_postcondition(selector.get_queue(), left_right, m, n, a, lda, stridea, x, incx, stridex, c, ldc, stridec, batch_size);
}
...
void gemm(backend_selector<backend::mklcpu> selector, transpose transa, transpose transb,
          std::int64_t m, std::int64_t n, std::int64_t k, float alpha, cl::sycl::buffer<bfloat16, 1> &a,
...
cl::sycl::event axpy_batch(backend_selector<backend::mklcpu> selector, std::int64_t n, float alpha,
                           ...
                           const cl::sycl::vector_class<cl::sycl::event> &dependencies = {}) {
    axpy_batch_precondition(selector.get_queue(), n, alpha, x, incx, stridex, y, incy, stridey, batch_size, dependencies);
    auto done = oneapi::mkl::blas::mklcpu::MAJOR::axpy_batch(selector.get_queue(), n, alpha, x, incx, stridex, y, incy, stridey, batch_size, dependencies);
    axpy_batch_postcondition(selector.get_queue(), n, alpha, x, incx, stridex, y, incy, stridey, batch_size, dependencies);
    return done;
}
...
cl::sycl::event axpy_batch(backend_selector<backend::mklcpu> selector, std::int64_t n, std::complex<float> alpha,
...
cl::sycl::event axpy_batch(backend_selector<backend::mklcpu> selector, std::int64_t n, std::complex<double> alpha,
...
cl::sycl::event axpby(
    backend_selector<backend::mklcpu> selector, std::int64_t n, float alpha, const float *x, std::int64_t incx, const float beta, 
    ...
    auto done = oneapi::mkl::blas::mklcpu::MAJOR::axpby(selector.get_queue(), n, alpha, x, incx, beta, y, incy, dependencies);
    axpby_postcondition(selector.get_queue(), n, alpha, x, incx, beta, y, incy, dependencies);
    return done;
}

cl::sycl::event axpby(
    backend_selector<backend::mklcpu> selector, std::int64_t n, double alpha, const double *x, std::int64_t incx, const double beta, 
...
cl::sycl::event axpby(
    backend_selector<backend::mklcpu> selector, std::int64_t n, std::complex<float> alpha, const std::complex<float> *x, std::int64_t incx, const std::complex<float> beta, 
...
cl::sycl::event axpby(
    backend_selector<backend::mklcpu> selector, std::int64_t n, std::complex<double> alpha, const std::complex<double> *x, std::int64_t incx, const std::complex<double> beta, 
...
cl::sycl::event gemv_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose trans,
              ...
              float *y, std::int64_t incy, std::int64_t stridey, std::int64_t batch_size,
              const cl::sycl::vector_class<cl::sycl::event> &dependencies = {}) {
    gemv_batch_precondition(selector.get_queue(), trans, m, n, alpha, a, lda, stridea, x, incx, stridex, beta, y, incy, stridey, batch_size, dependencies);
    auto done = oneapi::mkl::blas::mklcpu::MAJOR::gemv_batch(selector.get_queue(), trans, m, n, alpha, a, lda, stridea, x, incx, stridex, beta, y, incy, stridey, batch_size, dependencies);
    gemv_batch_postcondition(selector.get_queue(), trans, m, n, alpha, a, lda, stridea, x, incx, stridex, beta, y, incy, stridey, batch_size, dependencies);
    return done;
}
...
cl::sycl::event gemv_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose *trans,
              ...
              std::int64_t group_count, std::int64_t *group_size,
              const cl::sycl::vector_class<cl::sycl::event> &dependencies = {}) {
    gemv_batch_precondition(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx, beta, y, incy, group_count, group_size, dependencies);
    auto done = oneapi::mkl::blas::mklcpu::MAJOR::gemv_batch(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx, beta, y, incy, group_count, group_size, dependencies);
    gemv_batch_postcondition(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx, beta, y, incy, group_count, group_size, dependencies);
    return done;
}
...
cl::sycl::event dgmm_batch(backend_selector<backend::mklcpu> selector, side left_right,
              std::int64_t m, std::int64_t n,
              const float *a, std::int64_t lda, std::int64_t stridea,
              const float *x, std::int64_t incx, std::int64_t stridex,
              float *c, std::int64_t ldc, std::int64_t stridec, std::int64_t batch_size,
              const cl::sycl::vector_class<cl::sycl::event> &dependencies = {}) {
    dgmm_batch_precondition(selector.get_queue(), left_right, m, n, a, lda, stridea, x, incx, stridex, c, ldc, stridec, batch_size, dependencies);
    auto done = oneapi::mkl::blas::mklcpu::MAJOR::dgmm_batch(selector.get_queue(), left_right, m, n, a, lda, stridea, x, incx, stridex, c, ldc, stridec, batch_size, dependencies);
    dgmm_batch_postcondition(selector.get_queue(), left_right, m, n, a, lda, stridea, x, incx, stridex, c, ldc, stridec, batch_size, dependencies);
    return done;
}
...
cl::sycl::event dgmm_batch(backend_selector<backend::mklcpu> selector, side *left_right,
              ...
              std::int64_t group_count, std::int64_t *group_size,
              const cl::sycl::vector_class<cl::sycl::event> &dependencies = {}) {
    dgmm_batch_precondition(selector.get_queue(), left_right, m, n, a, lda, x, incx, c, ldc, group_count, group_size, dependencies);
    auto done = oneapi::mkl::blas::mklcpu::MAJOR::dgmm_batch(selector.get_queue(), left_right, m, n, a, lda, x, incx, c, ldc, group_count, group_size, dependencies);
    dgmm_batch_postcondition(selector.get_queue(), left_right, m, n, a, lda, x, incx, c, ldc, group_count, group_size, dependencies);
    return done;
}
...
cl::sycl::event gemm_bias(backend_selector<backend::mklcpu> selector, transpose transa, transpose transb,
                         ...
                         const cl::sycl::vector_class<cl::sycl::event> &dependencies = {}) {
    gemm_bias_precondition(selector.get_queue(), transa, transb, offsetc, m, n, k, alpha, a, lda, ao, b, ldb, bo, beta, c, ldc, co, dependencies);
    auto done = oneapi::mkl::blas::mklcpu::MAJOR::gemm_bias(selector.get_queue(), transa, transb, offsetc, m, n, k, alpha, a, lda, ao, b, ldb, bo, beta, c, ldc, co, dependencies);
    gemm_bias_postcondition(selector.get_queue(), transa, transb, offsetc, m, n, k, alpha, a, lda, ao, b, ldb, bo, beta, c, ldc, co, dependencies);
    return done;
}
...
cl::sycl::event trsm_batch(backend_selector<backend::mklcpu> selector, side left_right, uplo upper_lower, 
                           ...
                           int64_t batch_size,
                           const cl::sycl::vector_class<cl::sycl::event> &dependencies = {}) {
    trsm_batch_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, stride_a, b, ldb, stride_b, batch_size, dependencies);
    auto done = oneapi::mkl::blas::mklcpu::MAJOR::trsm_batch(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, stride_a, b, ldb, stride_b, batch_size, dependencies);
    trsm_batch_postcondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, stride_a, b, ldb, stride_b, batch_size, dependencies);
    return done;
}
...
cl::sycl::event trsm_batch(backend_selector<backend::mklcpu> selector, side *left_right, uplo *upper_lower, 
                           ...
                           const cl::sycl::vector_class<cl::sycl::event> &dependencies = {}) {
    trsm_batch_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b, ldb, group_count, group_size, dependencies);
    auto done = oneapi::mkl::blas::mklcpu::MAJOR::trsm_batch(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b, ldb, group_count, group_size, dependencies);
    trsm_batch_postcondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b, ldb, group_count, group_size, dependencies);
    return done;
}
