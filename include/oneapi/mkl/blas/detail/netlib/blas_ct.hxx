...
void herk(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::netlib::MAJOR::herk(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c,
                                            ldc);
...
void trmv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::netlib::MAJOR::trmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x,
                                            incx);
...
void tpmv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::netlib::MAJOR::tpmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx);
...
void gemm_batch(backend_selector<backend::netlib> selector, transpose transa, transpose transb,
    ...
    oneapi::mkl::netlib::MAJOR::gemm_batch(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda,
...
void syrk(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::netlib::MAJOR::syrk(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c,
                                            ldc);
...
void her2(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::netlib::MAJOR::her2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
...
void hbmv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n, std::int64_t k,
    ...
    oneapi::mkl::netlib::MAJOR::hbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta,
                                            y, incy);
...
void syr2k(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::netlib::MAJOR::syr2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb,
                                             beta, c, ldc);
...
void gemv(backend_selector<backend::netlib> selector, transpose trans, std::int64_t m, std::int64_t n,
    ...
    oneapi::mkl::netlib::MAJOR::gemv(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx, beta, y,
                                            incy);
...
void iamin(backend_selector<backend::netlib> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
...
void iamin(backend_selector<backend::netlib> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
    iamin_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::netlib::MAJOR::iamin(selector.get_queue(), n, x, incx, result);
    iamin_postcondition(selector.get_queue(), n, x, incx, result);
...
void hpmv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::netlib::MAJOR::hpmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y,
                                            incy);
...
void spmv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::netlib::MAJOR::spmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y,
                                            incy);
    spmv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y, incy);
}

void spmv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n, double alpha,
...
void gemm_bias(backend_selector<backend::netlib> selector, transpose transa, transpose transb,
    ...
    gemm_bias_precondition(selector.get_queue(), transa, transb, offsetc, m, n, k, alpha, a, lda, ao, b, ldb, bo,
                           beta, c, ldc, co);
    oneapi::mkl::netlib::MAJOR::gemm_bias(selector.get_queue(), transa, transb, offsetc, m, n, k, alpha, a,
...
void swap(backend_selector<backend::netlib> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy) {
    swap_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::netlib::MAJOR::swap(selector.get_queue(), n, x, incx, y, incy);
    swap_postcondition(selector.get_queue(), n, x, incx, y, incy);
...
void nrm2(backend_selector<backend::netlib> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
...
void gemm(backend_selector<backend::netlib> selector, transpose transa, transpose transb,
    ...
    oneapi::mkl::netlib::MAJOR::gemm(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb,
                                            beta, c, ldc);
...
void syr2(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::netlib::MAJOR::syr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
    syr2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
}

void syr2(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n, double alpha,
                           cl::sycl::buffer<double, 1> &x, std::int64_t incx,
                           cl::sycl::buffer<double, 1> &y, std::int64_t incy,
                           cl::sycl::buffer<double, 1> &a, std::int64_t lda) {
    syr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
...
void trsm(backend_selector<backend::netlib> selector, side left_right, uplo upper_lower,
    ...
    trsm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                      ldb);
    oneapi::mkl::netlib::MAJOR::trsm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n,
                                            alpha, a, lda, b, ldb);
...
void hemm(backend_selector<backend::netlib> selector, side left_right, uplo upper_lower,
    ...
    oneapi::mkl::netlib::MAJOR::hemm(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b,
                                            ldb, beta, c, ldc);
...
void hpr2(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::netlib::MAJOR::hpr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
...
void gbmv(backend_selector<backend::netlib> selector, transpose trans, std::int64_t m, std::int64_t n,
    ...
    oneapi::mkl::netlib::MAJOR::gbmv(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx,
                                            beta, y, incy);
...
void tbmv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::netlib::MAJOR::tbmv(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x,
                                            incx);
...
void symm(backend_selector<backend::netlib> selector, side left_right, uplo upper_lower,
    ...
    oneapi::mkl::netlib::MAJOR::symm(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b,
                                            ldb, beta, c, ldc);
...
void trmm(backend_selector<backend::netlib> selector, side left_right, uplo upper_lower,
    ...
    trmm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                      ldb);
    oneapi::mkl::netlib::MAJOR::trmm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n,
                                            alpha, a, lda, b, ldb);
...
void tpsv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::netlib::MAJOR::tpsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx);
...
void trsv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::netlib::MAJOR::trsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x,
                                            incx);
...
void copy(backend_selector<backend::netlib> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy) {
    copy_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::netlib::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy);
    copy_postcondition(selector.get_queue(), n, x, incx, y, incy);
...
void hemv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::netlib::MAJOR::hemv(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y,
                                            incy);
...
void gemmt(backend_selector<backend::netlib> selector, uplo upper_lower, transpose transa,
    ...
    gemmt_precondition(selector.get_queue(), upper_lower, transa, transb, n, k, alpha, a, lda, b, ldb, beta, c,
                       ldc);
    oneapi::mkl::netlib::MAJOR::gemmt(selector.get_queue(), upper_lower, transa, transb, n, k, alpha, a,
...
void asum(backend_selector<backend::netlib> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &result) {
    asum_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::netlib::MAJOR::asum(selector.get_queue(), n, x, incx, result);
    asum_postcondition(selector.get_queue(), n, x, incx, result);
...
void sbmv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n, std::int64_t k,
                           float alpha, cl::sycl::buffer<float, 1> &a, std::int64_t lda,
                           cl::sycl::buffer<float, 1> &x, std::int64_t incx, float beta,
                           cl::sycl::buffer<float, 1> &y, std::int64_t incy) {
    sbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy);
    oneapi::mkl::netlib::MAJOR::sbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta,
                                            y, incy);
...
void tbsv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::netlib::MAJOR::tbsv(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x,
                                            incx);
...
void spr2(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::netlib::MAJOR::spr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
    spr2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
}

void spr2(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n, double alpha,
                           cl::sycl::buffer<double, 1> &x, std::int64_t incx,
                           cl::sycl::buffer<double, 1> &y, std::int64_t incy,
                           cl::sycl::buffer<double, 1> &a) {
    spr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
...
void iamax(backend_selector<backend::netlib> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
...
void iamax(backend_selector<backend::netlib> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
    iamax_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::netlib::MAJOR::iamax(selector.get_queue(), n, x, incx, result);
    iamax_postcondition(selector.get_queue(), n, x, incx, result);
...
void rotm(backend_selector<backend::netlib> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy,
...
void trsm_batch(backend_selector<backend::netlib> selector, side left_right, uplo upper_lower,
    ...
    oneapi::mkl::netlib::MAJOR::trsm_batch(selector.get_queue(), left_right, upper_lower, trans, unit_diag,
...
void her2k(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::netlib::MAJOR::her2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb,
                                             beta, c, ldc);
...
void symv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::netlib::MAJOR::symv(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y,
                                            incy);
    symv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy);
}

void symv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n, double alpha,
                           cl::sycl::buffer<double, 1> &a, std::int64_t lda,
                           cl::sycl::buffer<double, 1> &x, std::int64_t incx, double beta,
                           cl::sycl::buffer<double, 1> &y, std::int64_t incy) {
    symv_precondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy);
...
cl::sycl::event syr2(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::syr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
...
cl::sycl::event scal(backend_selector<backend::netlib> selector, std::int64_t n, float alpha, float *x,
                                      std::int64_t incx,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    scal_precondition(selector.get_queue(), n, alpha, x, incx, dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::scal(selector.get_queue(), n, alpha, x, incx, dependencies);
...
cl::sycl::event trmv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::trmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
...
cl::sycl::event tpmv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::tpmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
                                                        x, incx, dependencies);
...
cl::sycl::event spr(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::spr(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       dependencies);
...
cl::sycl::event hpmv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::hpmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx,
...
cl::sycl::event syrk(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::syrk(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
...
cl::sycl::event her2(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::her2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
                                                        incy, a, lda, dependencies);
...
cl::sycl::event hbmv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    hbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::hbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x,
...
cl::sycl::event rot(backend_selector<backend::netlib> selector, std::int64_t n, std::complex<float> *x,
    ...
    auto done =
        oneapi::mkl::netlib::MAJOR::rot(selector.get_queue(), n, x, incx, y, incy, c, s, dependencies);
...
cl::sycl::event axpy(backend_selector<backend::netlib> selector, std::int64_t n, float alpha,
    ...
    auto done =
        oneapi::mkl::netlib::MAJOR::axpy(selector.get_queue(), n, alpha, x, incx, y, incy, dependencies);
...
cl::sycl::event axpy_batch(
    backend_selector<backend::netlib> selector, std::int64_t *n, float *alpha, const float **x, std::int64_t *incx,
    ...
    axpy_batch_precondition(selector.get_queue(), n, alpha, x, incx, y, incy, group_count, group_size,
                            dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::axpy_batch(
...
cl::sycl::event axpy_batch(
    backend_selector<backend::netlib> selector, std::int64_t *n, double *alpha, const double **x, std::int64_t *incx,
...
cl::sycl::event axpy_batch(
    backend_selector<backend::netlib> selector, std::int64_t *n, std::complex<float> *alpha,
...
cl::sycl::event axpy_batch(
    backend_selector<backend::netlib> selector, std::int64_t *n, std::complex<double> *alpha,
...
cl::sycl::event gerc(backend_selector<backend::netlib> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::gerc(selector.get_queue(), m, n, alpha, x, incx, y, incy, a,
                                                        lda, dependencies);
...
cl::sycl::event syr2k(
    backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans, std::int64_t n, std::int64_t k,
    ...
    syr2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::syr2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
...
cl::sycl::event gemv(backend_selector<backend::netlib> selector, transpose trans, std::int64_t m,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::gemv(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx,
                                                        beta, y, incy, dependencies);
...
cl::sycl::event her(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::her(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       lda, dependencies);
...
cl::sycl::event hpr(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::hpr(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       dependencies);
...
cl::sycl::event iamin(
    backend_selector<backend::netlib> selector, std::int64_t n, const float *x, std::int64_t incx, std::int64_t *result,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamin_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::iamin(selector.get_queue(), n, x, incx, result, dependencies);
    iamin_postcondition(selector.get_queue(), n, x, incx, result, dependencies);
    return done;
}

cl::sycl::event iamin(
    backend_selector<backend::netlib> selector, std::int64_t n, const double *x, std::int64_t incx,
...
cl::sycl::event iamin(
    backend_selector<backend::netlib> selector, std::int64_t n, const std::complex<float> *x, std::int64_t incx,
    std::int64_t *result, const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamin_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::iamin(selector.get_queue(), n, x, incx, result, dependencies);
    iamin_postcondition(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event iamin(
    backend_selector<backend::netlib> selector, std::int64_t n, const std::complex<double> *x, std::int64_t incx,
    std::int64_t *result, const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamin_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::iamin(selector.get_queue(), n, x, incx, result, dependencies);
    iamin_postcondition(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event gemm_batch(
    backend_selector<backend::netlib> selector, transpose *transa, transpose *transb, std::int64_t *m, std::int64_t *n,
...
cl::sycl::event spmv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::spmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx,
                                                        beta, y, incy, dependencies);
...
cl::sycl::event swap(backend_selector<backend::netlib> selector, std::int64_t n, float *x,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::swap(selector.get_queue(), n, x, incx, y, incy, dependencies);
...
cl::sycl::event geru(backend_selector<backend::netlib> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::geru(selector.get_queue(), m, n, alpha, x, incx, y, incy, a,
                                                        lda, dependencies);
...
cl::sycl::event nrm2(backend_selector<backend::netlib> selector, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::nrm2(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event gemm(backend_selector<backend::netlib> selector, transpose transa, transpose transb,
    ...
    gemm_precondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::gemm(selector.get_queue(), transa, transb, m, n, k, alpha, a,
                                                        lda, b, ldb, beta, c, ldc, dependencies);
    gemm_postcondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    return done;
...
cl::sycl::event herk(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::herk(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
                                                        lda, beta, c, ldc, dependencies);
...
cl::sycl::event ger(backend_selector<backend::netlib> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::ger(selector.get_queue(), m, n, alpha, x, incx, y, incy, a, lda,
                                                       dependencies);
...
cl::sycl::event trsm(backend_selector<backend::netlib> selector, side left_right, uplo upper_lower,
    ...
    trsm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b, ldb,
                      dependencies);
    auto done =
        oneapi::mkl::netlib::MAJOR::trsm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m,
...
cl::sycl::event dotu(backend_selector<backend::netlib> selector, std::int64_t n,
    ...
    auto done =
        oneapi::mkl::netlib::MAJOR::dotu(selector.get_queue(), n, x, incx, y, incy, result, dependencies);
...
cl::sycl::event hemm(backend_selector<backend::netlib> selector, side left_right, uplo upper_lower,
    ...
    hemm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::hemm(selector.get_queue(), left_right, upper_lower, m, n, alpha,
...
cl::sycl::event hpr2(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::hpr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
                                                        incy, a, dependencies);
...
cl::sycl::event gbmv(backend_selector<backend::netlib> selector, transpose trans, std::int64_t m,
    ...
    gbmv_precondition(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::gbmv(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda,
...
cl::sycl::event tbmv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::tbmv(selector.get_queue(), upper_lower, trans, unit_diag, n, k,
...
cl::sycl::event symm(backend_selector<backend::netlib> selector, side left_right, uplo upper_lower,
    ...
    symm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::symm(selector.get_queue(), left_right, upper_lower, m, n, alpha,
                                                        a, lda, b, ldb, beta, c, ldc, dependencies);
    symm_postcondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    return done;
...
cl::sycl::event dotc(backend_selector<backend::netlib> selector, std::int64_t n,
    ...
    auto done =
        oneapi::mkl::netlib::MAJOR::dotc(selector.get_queue(), n, x, incx, y, incy, result, dependencies);
...
cl::sycl::event syr(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::syr(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       lda, dependencies);
...
cl::sycl::event trmm(backend_selector<backend::netlib> selector, side left_right, uplo upper_lower,
    ...
    trmm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b, ldb,
                      dependencies);
    auto done =
        oneapi::mkl::netlib::MAJOR::trmm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m,
                                                n, alpha, a, lda, b, ldb, dependencies);
    trmm_postcondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                       ldb, dependencies);
    return done;
...
cl::sycl::event rotmg(
    backend_selector<backend::netlib> selector, float *d1, float *d2, float *x1, float y1, float *param,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    rotmg_precondition(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    auto done =
        oneapi::mkl::netlib::MAJOR::rotmg(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    rotmg_postcondition(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    return done;
}

cl::sycl::event rotmg(
    backend_selector<backend::netlib> selector, double *d1, double *d2, double *x1, double y1, double *param,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    rotmg_precondition(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    auto done =
        oneapi::mkl::netlib::MAJOR::rotmg(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
...
cl::sycl::event tpsv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::tpsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
                                                        x, incx, dependencies);
...
cl::sycl::event trsv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::trsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
                                                        lda, x, incx, dependencies);
...
cl::sycl::event copy(backend_selector<backend::netlib> selector, std::int64_t n, const float *x,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy, dependencies);
...
cl::sycl::event hemv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::hemv(selector.get_queue(), upper_lower, n, alpha, a, lda, x,
                                                        incx, beta, y, incy, dependencies);
...
cl::sycl::event gemmt(
    backend_selector<backend::netlib> selector, uplo upper_lower, transpose transa, transpose transb, std::int64_t n,
...
cl::sycl::event sbmv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    sbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::sbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x,
                                                        incx, beta, y, incy, dependencies);
    sbmv_postcondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy,
                       dependencies);
    return done;
...
cl::sycl::event asum(backend_selector<backend::netlib> selector, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::asum(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event tbsv(backend_selector<backend::netlib> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::tbsv(selector.get_queue(), upper_lower, trans, unit_diag, n, k,
                                                        a, lda, x, incx, dependencies);
...
cl::sycl::event spr2(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::spr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
                                                        incy, a, dependencies);
...
cl::sycl::event iamax(
    ...
    auto done = oneapi::mkl::netlib::MAJOR::iamax(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event rotm(backend_selector<backend::netlib> selector, std::int64_t n, float *x,
    ...
    auto done =
        oneapi::mkl::netlib::MAJOR::rotm(selector.get_queue(), n, x, incx, y, incy, param, dependencies);
...
cl::sycl::event sdsdot(
    backend_selector<backend::netlib> selector, std::int64_t n, float sb, const float *x, std::int64_t incx,
    const float *y, std::int64_t incy, float *result,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    sdsdot_precondition(selector.get_queue(), n, sb, x, incx, y, incy, result, dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::sdsdot(selector.get_queue(), n, sb, x, incx, y, incy, result,
                                                          dependencies);
...
cl::sycl::event her2k(
    ...
    her2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    auto done = oneapi::mkl::netlib::MAJOR::her2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
                                                         lda, b, ldb, beta, c, ldc, dependencies);
    her2k_postcondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                        dependencies);
    return done;
...
cl::sycl::event dot(backend_selector<backend::netlib> selector, std::int64_t n, const float *x,
    ...
    auto done =
        oneapi::mkl::netlib::MAJOR::dot(selector.get_queue(), n, x, incx, y, incy, result, dependencies);
...
cl::sycl::event symv(backend_selector<backend::netlib> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::netlib::MAJOR::symv(selector.get_queue(), upper_lower, n, alpha, a, lda, x,
                                                        incx, beta, y, incy, dependencies);
