...
cl::sycl::event syrk_batch(backend_selector<backend::netlib> selector, uplo *upper_lower,
...
cl::sycl::event gemv_batch(backend_selector<backend::netlib> selector, transpose trans,
...
cl::sycl::event gemm_bias(backend_selector<backend::netlib> selector, transpose transa,
...
cl::sycl::event trsm_batch(backend_selector<backend::netlib> selector, side left_right,
