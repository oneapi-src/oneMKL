...
ONEMKL_EXPORT void herk(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
...
ONEMKL_EXPORT void scal(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float alpha,
                        cl::sycl::buffer<float, 1> &x, std::int64_t incx);
ONEMKL_EXPORT void scal(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, double alpha,
...
ONEMKL_EXPORT void trmv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
...
ONEMKL_EXPORT void tpmv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
                        diag unit_diag, std::int64_t n, cl::sycl::buffer<float, 1> &a,
                        cl::sycl::buffer<float, 1> &x, std::int64_t incx);
ONEMKL_EXPORT void tpmv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
                        diag unit_diag, std::int64_t n, cl::sycl::buffer<double, 1> &a,
...
ONEMKL_EXPORT void spr(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void syrk(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
...
ONEMKL_EXPORT void her2(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
                        std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &x,
...
ONEMKL_EXPORT void hbmv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void axpy(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float alpha,
                        cl::sycl::buffer<float, 1> &x, std::int64_t incx,
                        cl::sycl::buffer<float, 1> &y, std::int64_t incy);
ONEMKL_EXPORT void axpy(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, double alpha,
                        cl::sycl::buffer<double, 1> &x, std::int64_t incx,
...
ONEMKL_EXPORT void gerc(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t m, std::int64_t n,
                        std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &x,
                        std::int64_t incx, cl::sycl::buffer<std::complex<float>, 1> &y,
                        std::int64_t incy, cl::sycl::buffer<std::complex<float>, 1> &a,
                        std::int64_t lda);
...
ONEMKL_EXPORT void syr2k(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
                         std::int64_t n, std::int64_t k, float alpha, cl::sycl::buffer<float, 1> &a,
...
ONEMKL_EXPORT void gemv(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose trans, std::int64_t m,
...
ONEMKL_EXPORT void her(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void hpr(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
                       float alpha, cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
...
ONEMKL_EXPORT void gemm_ext(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose transa,
                            transpose transb, std::int64_t m, std::int64_t n, std::int64_t k,
...
ONEMKL_EXPORT void hpmv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
                        std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &a,
                        cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                        std::complex<float> beta, cl::sycl::buffer<std::complex<float>, 1> &y,
                        std::int64_t incy);
...
ONEMKL_EXPORT void spmv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void rotmg(oneapi::mkl::device libkey, cl::sycl::queue &queue, cl::sycl::buffer<float, 1> &d1,
                         cl::sycl::buffer<float, 1> &d2, cl::sycl::buffer<float, 1> &x1, float y1,
                         cl::sycl::buffer<float, 1> &param);
ONEMKL_EXPORT void rotmg(oneapi::mkl::device libkey, cl::sycl::queue &queue, cl::sycl::buffer<double, 1> &d1,
...
ONEMKL_EXPORT void geru(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t m, std::int64_t n,
                        std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &x,
                        std::int64_t incx, cl::sycl::buffer<std::complex<float>, 1> &y,
                        std::int64_t incy, cl::sycl::buffer<std::complex<float>, 1> &a,
                        std::int64_t lda);
...
ONEMKL_EXPORT void gemmt(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose transa,
...
ONEMKL_EXPORT void gemm(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose transa, transpose transb,
...
ONEMKL_EXPORT void syr2(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
                        float alpha, cl::sycl::buffer<float, 1> &x, std::int64_t incx,
                        cl::sycl::buffer<float, 1> &y, std::int64_t incy,
                        cl::sycl::buffer<float, 1> &a, std::int64_t lda);
ONEMKL_EXPORT void syr2(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void ger(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t m, std::int64_t n,
                       float alpha, cl::sycl::buffer<float, 1> &x, std::int64_t incx,
                       cl::sycl::buffer<float, 1> &y, std::int64_t incy,
                       cl::sycl::buffer<float, 1> &a, std::int64_t lda);
ONEMKL_EXPORT void ger(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t m, std::int64_t n,
...
ONEMKL_EXPORT void trsm(oneapi::mkl::device libkey, cl::sycl::queue &queue, side left_right, uplo upper_lower,
...
ONEMKL_EXPORT void hemm(oneapi::mkl::device libkey, cl::sycl::queue &queue, side left_right, uplo upper_lower,
...
ONEMKL_EXPORT void hpr2(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
                        std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &x,
                        std::int64_t incx, cl::sycl::buffer<std::complex<float>, 1> &y,
                        std::int64_t incy, cl::sycl::buffer<std::complex<float>, 1> &a);
ONEMKL_EXPORT void hpr2(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void gbmv(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose trans, std::int64_t m,
...
ONEMKL_EXPORT void tbmv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
...
ONEMKL_EXPORT void symm(oneapi::mkl::device libkey, cl::sycl::queue &queue, side left_right, uplo upper_lower,
...
ONEMKL_EXPORT void syr(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
                       float alpha, cl::sycl::buffer<float, 1> &x, std::int64_t incx,
                       cl::sycl::buffer<float, 1> &a, std::int64_t lda);
ONEMKL_EXPORT void syr(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
                       double alpha, cl::sycl::buffer<double, 1> &x, std::int64_t incx,
...
ONEMKL_EXPORT void trmm(oneapi::mkl::device libkey, cl::sycl::queue &queue, side left_right, uplo upper_lower,
                        transpose trans, diag unit_diag, std::int64_t m, std::int64_t n,
                        float alpha, cl::sycl::buffer<float, 1> &a, std::int64_t lda,
                        cl::sycl::buffer<float, 1> &b, std::int64_t ldb);
ONEMKL_EXPORT void trmm(oneapi::mkl::device libkey, cl::sycl::queue &queue, side left_right, uplo upper_lower,
...
ONEMKL_EXPORT void symv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
                        float alpha, cl::sycl::buffer<float, 1> &a, std::int64_t lda,
                        cl::sycl::buffer<float, 1> &x, std::int64_t incx, float beta,
                        cl::sycl::buffer<float, 1> &y, std::int64_t incy);
ONEMKL_EXPORT void symv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void tpsv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
                        diag unit_diag, std::int64_t n, cl::sycl::buffer<float, 1> &a,
                        cl::sycl::buffer<float, 1> &x, std::int64_t incx);
ONEMKL_EXPORT void tpsv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
                        diag unit_diag, std::int64_t n, cl::sycl::buffer<double, 1> &a,
...
ONEMKL_EXPORT void trsv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
                        diag unit_diag, std::int64_t n, cl::sycl::buffer<float, 1> &a,
                        std::int64_t lda, cl::sycl::buffer<float, 1> &x, std::int64_t incx);
ONEMKL_EXPORT void trsv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
                        diag unit_diag, std::int64_t n, cl::sycl::buffer<double, 1> &a,
...
ONEMKL_EXPORT void hemv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
                        std::complex<float> alpha, cl::sycl::buffer<std::complex<float>, 1> &a,
                        std::int64_t lda, cl::sycl::buffer<std::complex<float>, 1> &x,
...
ONEMKL_EXPORT void sbmv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void tbsv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
                        diag unit_diag, std::int64_t n, std::int64_t k,
                        cl::sycl::buffer<float, 1> &a, std::int64_t lda,
                        cl::sycl::buffer<float, 1> &x, std::int64_t incx);
ONEMKL_EXPORT void tbsv(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
...
ONEMKL_EXPORT void spr2(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
                        float alpha, cl::sycl::buffer<float, 1> &x, std::int64_t incx,
                        cl::sycl::buffer<float, 1> &y, std::int64_t incy,
                        cl::sycl::buffer<float, 1> &a);
ONEMKL_EXPORT void spr2(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void sdsdot(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float sb,
                          cl::sycl::buffer<float, 1> &x, std::int64_t incx,
                          cl::sycl::buffer<float, 1> &y, std::int64_t incy,
                          cl::sycl::buffer<float, 1> &result);

ONEMKL_EXPORT void her2k(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans,
                         std::int64_t n, std::int64_t k, std::complex<float> alpha,
                         cl::sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda,
...
ONEMKL_EXPORT void rotg(oneapi::mkl::device libkey, cl::sycl::queue &queue, cl::sycl::buffer<float, 1> &a,
                        cl::sycl::buffer<float, 1> &b, cl::sycl::buffer<float, 1> &c,
                        cl::sycl::buffer<float, 1> &s);
ONEMKL_EXPORT void rotg(oneapi::mkl::device libkey, cl::sycl::queue &queue, cl::sycl::buffer<double, 1> &a,
...
ONEMKL_EXPORT cl::sycl::event herk(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans, std::int64_t n,
...
ONEMKL_EXPORT cl::sycl::event scal(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float alpha, float *x, std::int64_t incx,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event scal(
...
ONEMKL_EXPORT cl::sycl::event scal(
    ...
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event scal(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float alpha, std::complex<float> *x,
    std::int64_t incx, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event scal(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, double alpha, std::complex<double> *x,
    std::int64_t incx, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});

ONEMKL_EXPORT cl::sycl::event trmv(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose trans, diag unit_diag,
...
ONEMKL_EXPORT cl::sycl::event spr(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower,
...
ONEMKL_EXPORT cl::sycl::event gemm_batch(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose *transa, transpose *transb, std::int64_t *m,
...
ONEMKL_EXPORT cl::sycl::event hbmv(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n, std::int64_t k,
...
ONEMKL_EXPORT cl::sycl::event rot(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n,
...
ONEMKL_EXPORT cl::sycl::event rot(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n,
                                  ...
                                  const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event rot(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float *x,
                                  std::int64_t incx, float *y, std::int64_t incy, float c, float s,
                                  const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event rot(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, double *x,
...
ONEMKL_EXPORT cl::sycl::event axpy(
    ...
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event axpy(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, double alpha, const double *x,
...
ONEMKL_EXPORT cl::sycl::event gemv(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
...
ONEMKL_EXPORT cl::sycl::event her(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower,
...
ONEMKL_EXPORT cl::sycl::event hpr(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower,
                                  std::int64_t n, float alpha, const std::complex<float> *x,
...
ONEMKL_EXPORT cl::sycl::event iamin(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, const float *x, std::int64_t incx,
    std::int64_t *result, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event iamin(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, const double *x, std::int64_t incx,
    std::int64_t *result, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event iamin(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, const std::complex<float> *x,
    std::int64_t incx, std::int64_t *result,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event iamin(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, const std::complex<double> *x,
    std::int64_t incx, std::int64_t *result,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
...
ONEMKL_EXPORT cl::sycl::event spmv(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n, float alpha,
    const float *a, const float *x, std::int64_t incx, float beta, float *y, std::int64_t incy,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event spmv(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, std::int64_t n, double alpha,
    const double *a, const double *x, std::int64_t incx, double beta, double *y, std::int64_t incy,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});

ONEMKL_EXPORT cl::sycl::event rotmg(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, float *d1, float *d2, float *x1, float y1, float *param,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event rotmg(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, double *d1, double *d2, double *x1, double y1,
    double *param, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});

ONEMKL_EXPORT cl::sycl::event swap(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float *x, std::int64_t incx, float *y,
    std::int64_t incy, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event swap(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, double *x, std::int64_t incx, double *y,
    std::int64_t incy, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event swap(
...
ONEMKL_EXPORT cl::sycl::event gemmt(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower, transpose transa, transpose transb,
...
ONEMKL_EXPORT cl::sycl::event ger(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t m,
                                  std::int64_t n, float alpha, const float *x, std::int64_t incx,
...
ONEMKL_EXPORT cl::sycl::event trsm(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, side left_right, uplo upper_lower, transpose trans,
...
ONEMKL_EXPORT cl::sycl::event hemm(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, side left_right, uplo upper_lower, std::int64_t m,
...
ONEMKL_EXPORT cl::sycl::event syr(oneapi::mkl::device libkey, cl::sycl::queue &queue, uplo upper_lower,
                                  std::int64_t n, float alpha, const float *x, std::int64_t incx,
...
ONEMKL_EXPORT cl::sycl::event dot(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n,
...
ONEMKL_EXPORT cl::sycl::event rotg(
    ...
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event rotg(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::complex<float> *a, std::complex<float> *b, float *c,
    std::complex<float> *s, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event rotg(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::complex<double> *a, std::complex<double> *b,
