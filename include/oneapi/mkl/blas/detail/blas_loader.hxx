...
ONEMKL_EXPORT void gemm_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose transa,
                              ...
                              cl::sycl::buffer<std::complex<double>, 1> &c, std::int64_t ldc,
                              std::int64_t stride_c, std::int64_t batch_size);
ONEMKL_EXPORT void gemm_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose transa, transpose transb,
...
ONEMKL_EXPORT void axpy_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float alpha,
...
ONEMKL_EXPORT void axpy_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, double alpha,
...
ONEMKL_EXPORT void axpy_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, std::complex<float> alpha,
...
ONEMKL_EXPORT void axpy_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, std::complex<double> alpha,
...
ONEMKL_EXPORT void axpby(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float alpha,
                        cl::sycl::buffer<float, 1> &x, std::int64_t incx, float beta, 
                        cl::sycl::buffer<float, 1> &y, std::int64_t incy);
ONEMKL_EXPORT void axpby(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, double alpha,
                        cl::sycl::buffer<double, 1> &x, std::int64_t incx, double beta, 
                        cl::sycl::buffer<double, 1> &y, std::int64_t incy); 
ONEMKL_EXPORT void axpby(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, std::complex<float> alpha,
                        cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx, std::complex<float> beta, 
                        cl::sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy); 
ONEMKL_EXPORT void axpby(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, std::complex<double> alpha,
...
ONEMKL_EXPORT void gemv_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose trans, std::int64_t m, std::int64_t n,
...
ONEMKL_EXPORT void dgmm_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, side left_right,
...
ONEMKL_EXPORT void gemm_bias(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose transa, transpose transb,
...
ONEMKL_EXPORT void gemm(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose transa,
                        ...
                        cl::sycl::buffer<float, 1> &c, std::int64_t ldc);
ONEMKL_EXPORT void gemm(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose transa, transpose transb, std::int64_t m,
...
ONEMKL_EXPORT cl::sycl::event gemm_batch(
    ...
    const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event gemm_batch(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose *transa, transpose *transb, std::int64_t *m, std::int64_t *n,
...
ONEMKL_EXPORT cl::sycl::event axpy_batch(
    ...
    std::int64_t *group_size, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event axpy_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float alpha,
                           const float *x, std::int64_t incx, std::int64_t stridex,
                           float *y, std::int64_t incy, std::int64_t stridey, std::int64_t batch_size,
                           const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event axpy_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, double alpha,
                           const double *x, std::int64_t incx, std::int64_t stridex,
                           double *y, std::int64_t incy, std::int64_t stridey, std::int64_t batch_size,
                           const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event axpy_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, std::complex<float> alpha,
                           const std::complex<float> *x, std::int64_t incx, std::int64_t stridex,
                           std::complex<float> *y, std::int64_t incy, std::int64_t stridey,
                           std::int64_t batch_size,
                           const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event axpy_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, std::complex<double> alpha,
...
ONEMKL_EXPORT cl::sycl::event axpby(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, float alpha, const float *x, std::int64_t incx, const float beta, 
    float *y, std::int64_t incy, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event axpby(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, double alpha, const double *x, std::int64_t incx, const double beta, 
    double *y, std::int64_t incy, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event axpby(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, std::complex<float> alpha, const std::complex<float> *x, std::int64_t incx, const std::complex<float> beta, 
    std::complex<float> *y, std::int64_t incy, const cl::sycl::vector_class<cl::sycl::event> &dependencies = {});
ONEMKL_EXPORT cl::sycl::event axpby(
    oneapi::mkl::device libkey, cl::sycl::queue &queue, std::int64_t n, std::complex<double> alpha, const std::complex<double> *x, std::int64_t incx, const std::complex<double> beta, 
...
ONEMKL_EXPORT cl::sycl::event gemv_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose trans,
...
ONEMKL_EXPORT cl::sycl::event dgmm_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, side left_right,
              std::int64_t m, std::int64_t n,
              const float *a, std::int64_t lda, std::int64_t stridea,
              const float *x, std::int64_t incx, std::int64_t stridex,
...
ONEMKL_EXPORT cl::sycl::event gemm_bias(oneapi::mkl::device libkey, cl::sycl::queue &queue, transpose transa, transpose transb,
...
ONEMKL_EXPORT cl::sycl::event trsm_batch(oneapi::mkl::device libkey, cl::sycl::queue &queue, side left_right, uplo upper_lower, 
