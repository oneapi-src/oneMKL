...
void herk(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::herk(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c,
                                            ldc);
...
void scal(backend_selector<backend::cublas> selector, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::scal(selector.get_queue(), n, alpha, x, incx);
...
void trmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::trmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x,
                                            incx);
...
void tpmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::tpmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx);
...
void spr(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::spr(selector.get_queue(), upper_lower, n, alpha, x, incx, a);
...
void gemm_batch(backend_selector<backend::cublas> selector, transpose transa, transpose transb,
    ...
    oneapi::mkl::cublas::MAJOR::gemm_batch(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda,
...
void syrk(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::syrk(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c,
                                            ldc);
...
void her2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::her2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
...
void hbmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, std::int64_t k,
    ...
    oneapi::mkl::cublas::MAJOR::hbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta,
                                            y, incy);
...
void rot(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::rot(selector.get_queue(), n, x, incx, y, incy, c, s);
...
void rot(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
...
void rot(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
...
void axpy(backend_selector<backend::cublas> selector, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::axpy(selector.get_queue(), n, alpha, x, incx, y, incy);
...
void sdsdot(backend_selector<backend::cublas> selector, std::int64_t n, float sb,
    ...
    oneapi::mkl::cublas::MAJOR::sdsdot(selector.get_queue(), n, sb, x, incx, y, incy, result);
...
void gerc(backend_selector<backend::cublas> selector, std::int64_t m, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::gerc(selector.get_queue(), m, n, alpha, x, incx, y, incy, a, lda);
...
void syr2k(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::syr2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb,
                                             beta, c, ldc);
...
void gemv(backend_selector<backend::cublas> selector, transpose trans, std::int64_t m, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::gemv(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx, beta, y,
                                            incy);
...
void her(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::her(selector.get_queue(), upper_lower, n, alpha, x, incx, a, lda);
...
void hpr(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::hpr(selector.get_queue(), upper_lower, n, alpha, x, incx, a);
...
void iamin(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
    iamin_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::cublas::MAJOR::iamin(selector.get_queue(), n, x, incx, result);
    iamin_postcondition(selector.get_queue(), n, x, incx, result);
}

void iamin(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
    iamin_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::cublas::MAJOR::iamin(selector.get_queue(), n, x, incx, result);
    iamin_postcondition(selector.get_queue(), n, x, incx, result);
...
void hpmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::hpmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y,
                                            incy);
...
void spmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::spmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y,
                                            incy);
    spmv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y, incy);
}

void spmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, double alpha,
...
void gemm_bias(backend_selector<backend::cublas> selector, transpose transa, transpose transb,
    ...
    gemm_bias_precondition(selector.get_queue(), transa, transb, offsetc, m, n, k, alpha, a, lda, ao, b, ldb, bo,
                           beta, c, ldc, co);
    oneapi::mkl::cublas::MAJOR::gemm_bias(selector.get_queue(), transa, transb, offsetc, m, n, k, alpha, a,
...
void swap(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy) {
    swap_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::cublas::MAJOR::swap(selector.get_queue(), n, x, incx, y, incy);
    swap_postcondition(selector.get_queue(), n, x, incx, y, incy);
}

void swap(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy) {
    swap_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::cublas::MAJOR::swap(selector.get_queue(), n, x, incx, y, incy);
    swap_postcondition(selector.get_queue(), n, x, incx, y, incy);
...
void geru(backend_selector<backend::cublas> selector, std::int64_t m, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::geru(selector.get_queue(), m, n, alpha, x, incx, y, incy, a, lda);
...
void nrm2(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::nrm2(selector.get_queue(), n, x, incx, result);
...
void nrm2(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
...
void nrm2(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
...
void gemm(backend_selector<backend::cublas> selector, transpose transa, transpose transb,
    ...
    oneapi::mkl::cublas::MAJOR::gemm(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb,
                                            beta, c, ldc);
...
void syr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::syr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
    syr2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
}

void syr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, double alpha,
                           cl::sycl::buffer<double, 1> &x, std::int64_t incx,
                           cl::sycl::buffer<double, 1> &y, std::int64_t incy,
                           cl::sycl::buffer<double, 1> &a, std::int64_t lda) {
    syr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda);
...
void ger(backend_selector<backend::cublas> selector, std::int64_t m, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::ger(selector.get_queue(), m, n, alpha, x, incx, y, incy, a, lda);
...
void trsm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    trsm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                      ldb);
    oneapi::mkl::cublas::MAJOR::trsm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n,
                                            alpha, a, lda, b, ldb);
...
void dotu(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::dotu(selector.get_queue(), n, x, incx, y, incy, result);
...
void hemm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    oneapi::mkl::cublas::MAJOR::hemm(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b,
                                            ldb, beta, c, ldc);
...
void hpr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::hpr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
...
void gbmv(backend_selector<backend::cublas> selector, transpose trans, std::int64_t m, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::gbmv(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx,
                                            beta, y, incy);
...
void tbmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::tbmv(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x,
                                            incx);
...
void symm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    oneapi::mkl::cublas::MAJOR::symm(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b,
                                            ldb, beta, c, ldc);
...
void dotc(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::dotc(selector.get_queue(), n, x, incx, y, incy, result);
...
void syr(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::syr(selector.get_queue(), upper_lower, n, alpha, x, incx, a, lda);
...
void trmm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    trmm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                      ldb);
    oneapi::mkl::cublas::MAJOR::trmm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n,
                                            alpha, a, lda, b, ldb);
...
void rotmg(backend_selector<backend::cublas> selector, cl::sycl::buffer<float, 1> &d1,
    ...
    oneapi::mkl::cublas::MAJOR::rotmg(selector.get_queue(), d1, d2, x1, y1, param);
    rotmg_postcondition(selector.get_queue(), d1, d2, x1, y1, param);
}

void rotmg(backend_selector<backend::cublas> selector, cl::sycl::buffer<double, 1> &d1,
...
void tpsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::tpsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx);
...
void trsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::trsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x,
                                            incx);
...
void copy(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy) {
    copy_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::cublas::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy);
    copy_postcondition(selector.get_queue(), n, x, incx, y, incy);
}

void copy(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy) {
    copy_precondition(selector.get_queue(), n, x, incx, y, incy);
    oneapi::mkl::cublas::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy);
    copy_postcondition(selector.get_queue(), n, x, incx, y, incy);
...
void hemv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::hemv(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y,
                                            incy);
...
void gemmt(backend_selector<backend::cublas> selector, uplo upper_lower, transpose transa,
    ...
    gemmt_precondition(selector.get_queue(), upper_lower, transa, transb, n, k, alpha, a, lda, b, ldb, beta, c,
                       ldc);
    oneapi::mkl::cublas::MAJOR::gemmt(selector.get_queue(), upper_lower, transa, transb, n, k, alpha, a,
...
void asum(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::asum(selector.get_queue(), n, x, incx, result);
...
void asum(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<float, 1> &result) {
    asum_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::cublas::MAJOR::asum(selector.get_queue(), n, x, incx, result);
    asum_postcondition(selector.get_queue(), n, x, incx, result);
...
void asum(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &result) {
    asum_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::cublas::MAJOR::asum(selector.get_queue(), n, x, incx, result);
    asum_postcondition(selector.get_queue(), n, x, incx, result);
...
void sbmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, std::int64_t k,
                           float alpha, cl::sycl::buffer<float, 1> &a, std::int64_t lda,
                           cl::sycl::buffer<float, 1> &x, std::int64_t incx, float beta,
                           cl::sycl::buffer<float, 1> &y, std::int64_t incy) {
    sbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy);
    oneapi::mkl::cublas::MAJOR::sbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta,
                                            y, incy);
...
void tbsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::tbsv(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x,
                                            incx);
...
void spr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::spr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
    spr2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
}

void spr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, double alpha,
                           cl::sycl::buffer<double, 1> &x, std::int64_t incx,
                           cl::sycl::buffer<double, 1> &y, std::int64_t incy,
                           cl::sycl::buffer<double, 1> &a) {
    spr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a);
...
void iamax(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
    iamax_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::cublas::MAJOR::iamax(selector.get_queue(), n, x, incx, result);
    iamax_postcondition(selector.get_queue(), n, x, incx, result);
}

void iamax(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                            std::int64_t incx, cl::sycl::buffer<std::int64_t, 1> &result) {
    iamax_precondition(selector.get_queue(), n, x, incx, result);
    oneapi::mkl::cublas::MAJOR::iamax(selector.get_queue(), n, x, incx, result);
    iamax_postcondition(selector.get_queue(), n, x, incx, result);
...
void rotm(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy,
                           cl::sycl::buffer<float, 1> &param) {
    rotm_precondition(selector.get_queue(), n, x, incx, y, incy, param);
    oneapi::mkl::cublas::MAJOR::rotm(selector.get_queue(), n, x, incx, y, incy, param);
    rotm_postcondition(selector.get_queue(), n, x, incx, y, incy, param);
}

void rotm(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                           std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy,
...
void dot(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<float, 1> &x,
                          std::int64_t incx, cl::sycl::buffer<float, 1> &y, std::int64_t incy,
                          cl::sycl::buffer<float, 1> &result) {
    dot_precondition(selector.get_queue(), n, x, incx, y, incy, result);
    oneapi::mkl::cublas::MAJOR::dot(selector.get_queue(), n, x, incx, y, incy, result);
    dot_postcondition(selector.get_queue(), n, x, incx, y, incy, result);
}

void dot(backend_selector<backend::cublas> selector, std::int64_t n, cl::sycl::buffer<double, 1> &x,
                          std::int64_t incx, cl::sycl::buffer<double, 1> &y, std::int64_t incy,
                          cl::sycl::buffer<double, 1> &result) {
    dot_precondition(selector.get_queue(), n, x, incx, y, incy, result);
    oneapi::mkl::cublas::MAJOR::dot(selector.get_queue(), n, x, incx, y, incy, result);
...
void trsm_batch(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    oneapi::mkl::cublas::MAJOR::trsm_batch(selector.get_queue(), left_right, upper_lower, trans, unit_diag,
...
void her2k(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::her2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb,
                                             beta, c, ldc);
...
void rotg(backend_selector<backend::cublas> selector, cl::sycl::buffer<float, 1> &a,
                           cl::sycl::buffer<float, 1> &b, cl::sycl::buffer<float, 1> &c,
                           cl::sycl::buffer<float, 1> &s) {
    rotg_precondition(selector.get_queue(), a, b, c, s);
    oneapi::mkl::cublas::MAJOR::rotg(selector.get_queue(), a, b, c, s);
    rotg_postcondition(selector.get_queue(), a, b, c, s);
}

void rotg(backend_selector<backend::cublas> selector, cl::sycl::buffer<double, 1> &a,
...
void rotg(backend_selector<backend::cublas> selector, cl::sycl::buffer<std::complex<float>, 1> &a,
...
void rotg(backend_selector<backend::cublas> selector, cl::sycl::buffer<std::complex<double>, 1> &a,
...
void symv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::symv(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y,
                                            incy);
    symv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy);
}

void symv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, double alpha,
                           cl::sycl::buffer<double, 1> &a, std::int64_t lda,
                           cl::sycl::buffer<double, 1> &x, std::int64_t incx, double beta,
                           cl::sycl::buffer<double, 1> &y, std::int64_t incy) {
    symv_precondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy);
...
cl::sycl::event syr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::syr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
...
cl::sycl::event scal(backend_selector<backend::cublas> selector, std::int64_t n, float alpha, float *x,
                                      std::int64_t incx,
                                      const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    scal_precondition(selector.get_queue(), n, alpha, x, incx, dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::scal(selector.get_queue(), n, alpha, x, incx, dependencies);
...
cl::sycl::event trmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::trmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
...
cl::sycl::event tpmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::tpmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
                                                        x, incx, dependencies);
...
cl::sycl::event spr(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::spr(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       dependencies);
...
cl::sycl::event hpmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::hpmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx,
...
cl::sycl::event syrk(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::syrk(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
...
cl::sycl::event her2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::her2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
                                                        incy, a, lda, dependencies);
...
cl::sycl::event hbmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    hbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::hbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x,
...
cl::sycl::event rot(backend_selector<backend::cublas> selector, std::int64_t n, std::complex<float> *x,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::rot(selector.get_queue(), n, x, incx, y, incy, c, s, dependencies);
...
cl::sycl::event axpy(backend_selector<backend::cublas> selector, std::int64_t n, float alpha,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::axpy(selector.get_queue(), n, alpha, x, incx, y, incy, dependencies);
...
cl::sycl::event axpy_batch(
    backend_selector<backend::cublas> selector, std::int64_t *n, float *alpha, const float **x, std::int64_t *incx,
    ...
    axpy_batch_precondition(selector.get_queue(), n, alpha, x, incx, y, incy, group_count, group_size,
                            dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::axpy_batch(
...
cl::sycl::event axpy_batch(
    backend_selector<backend::cublas> selector, std::int64_t *n, double *alpha, const double **x, std::int64_t *incx,
...
cl::sycl::event axpy_batch(
    backend_selector<backend::cublas> selector, std::int64_t *n, std::complex<float> *alpha,
...
cl::sycl::event axpy_batch(
    backend_selector<backend::cublas> selector, std::int64_t *n, std::complex<double> *alpha,
...
cl::sycl::event gerc(backend_selector<backend::cublas> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::gerc(selector.get_queue(), m, n, alpha, x, incx, y, incy, a,
                                                        lda, dependencies);
...
cl::sycl::event syr2k(
    backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans, std::int64_t n, std::int64_t k,
    ...
    syr2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::syr2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
...
cl::sycl::event gemv(backend_selector<backend::cublas> selector, transpose trans, std::int64_t m,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::gemv(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx,
                                                        beta, y, incy, dependencies);
...
cl::sycl::event her(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::her(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       lda, dependencies);
...
cl::sycl::event hpr(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::hpr(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       dependencies);
...
cl::sycl::event iamin(
    backend_selector<backend::cublas> selector, std::int64_t n, const float *x, std::int64_t incx, std::int64_t *result,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamin_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::iamin(selector.get_queue(), n, x, incx, result, dependencies);
    iamin_postcondition(selector.get_queue(), n, x, incx, result, dependencies);
    return done;
}

cl::sycl::event iamin(
    backend_selector<backend::cublas> selector, std::int64_t n, const double *x, std::int64_t incx,
...
cl::sycl::event iamin(
    backend_selector<backend::cublas> selector, std::int64_t n, const std::complex<float> *x, std::int64_t incx,
    std::int64_t *result, const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamin_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::iamin(selector.get_queue(), n, x, incx, result, dependencies);
    iamin_postcondition(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event iamin(
    backend_selector<backend::cublas> selector, std::int64_t n, const std::complex<double> *x, std::int64_t incx,
    std::int64_t *result, const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    iamin_precondition(selector.get_queue(), n, x, incx, result, dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::iamin(selector.get_queue(), n, x, incx, result, dependencies);
    iamin_postcondition(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event gemm_batch(
    backend_selector<backend::cublas> selector, transpose *transa, transpose *transb, std::int64_t *m, std::int64_t *n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::gemm_batch(
...
cl::sycl::event spmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::spmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx,
                                                        beta, y, incy, dependencies);
...
cl::sycl::event swap(backend_selector<backend::cublas> selector, std::int64_t n, float *x,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::swap(selector.get_queue(), n, x, incx, y, incy, dependencies);
...
cl::sycl::event geru(backend_selector<backend::cublas> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::geru(selector.get_queue(), m, n, alpha, x, incx, y, incy, a,
                                                        lda, dependencies);
...
cl::sycl::event nrm2(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::nrm2(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event gemm(backend_selector<backend::cublas> selector, transpose transa, transpose transb,
    ...
    gemm_precondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::gemm(selector.get_queue(), transa, transb, m, n, k, alpha, a,
                                                        lda, b, ldb, beta, c, ldc, dependencies);
    gemm_postcondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    return done;
...
cl::sycl::event herk(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::herk(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
                                                        lda, beta, c, ldc, dependencies);
...
cl::sycl::event ger(backend_selector<backend::cublas> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::ger(selector.get_queue(), m, n, alpha, x, incx, y, incy, a, lda,
                                                       dependencies);
...
cl::sycl::event trsm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    trsm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b, ldb,
                      dependencies);
    auto done =
        oneapi::mkl::cublas::MAJOR::trsm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m,
...
cl::sycl::event dotu(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::dotu(selector.get_queue(), n, x, incx, y, incy, result, dependencies);
...
cl::sycl::event hemm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
                                      std::int64_t m, std::int64_t n, std::complex<float> alpha,
                                      const std::complex<float> *a, std::int64_t lda,
    ...
    hemm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::hemm(selector.get_queue(), left_right, upper_lower, m, n, alpha,
...
cl::sycl::event hpr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::hpr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
                                                        incy, a, dependencies);
...
cl::sycl::event gbmv(backend_selector<backend::cublas> selector, transpose trans, std::int64_t m,
    ...
    gbmv_precondition(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::gbmv(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda,
...
cl::sycl::event tbmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::tbmv(selector.get_queue(), upper_lower, trans, unit_diag, n, k,
...
cl::sycl::event symm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    symm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::symm(selector.get_queue(), left_right, upper_lower, m, n, alpha,
                                                        a, lda, b, ldb, beta, c, ldc, dependencies);
    symm_postcondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    return done;
...
cl::sycl::event dotc(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::dotc(selector.get_queue(), n, x, incx, y, incy, result, dependencies);
...
cl::sycl::event syr(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::syr(selector.get_queue(), upper_lower, n, alpha, x, incx, a,
                                                       lda, dependencies);
...
cl::sycl::event trmm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    trmm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b, ldb,
                      dependencies);
    auto done =
        oneapi::mkl::cublas::MAJOR::trmm(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m,
                                                n, alpha, a, lda, b, ldb, dependencies);
    trmm_postcondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha, a, lda, b,
                       ldb, dependencies);
    return done;
...
cl::sycl::event rotmg(
    backend_selector<backend::cublas> selector, float *d1, float *d2, float *x1, float y1, float *param,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    rotmg_precondition(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    auto done =
        oneapi::mkl::cublas::MAJOR::rotmg(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    rotmg_postcondition(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    return done;
}

cl::sycl::event rotmg(
    backend_selector<backend::cublas> selector, double *d1, double *d2, double *x1, double y1, double *param,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    rotmg_precondition(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
    auto done =
        oneapi::mkl::cublas::MAJOR::rotmg(selector.get_queue(), d1, d2, x1, y1, param, dependencies);
...
cl::sycl::event tpsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::tpsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
                                                        x, incx, dependencies);
...
cl::sycl::event trsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::trsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a,
                                                        lda, x, incx, dependencies);
...
cl::sycl::event copy(backend_selector<backend::cublas> selector, std::int64_t n, const float *x,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy, dependencies);
...
cl::sycl::event hemv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
                                      std::complex<float> alpha, const std::complex<float> *a,
                                      std::int64_t lda, const std::complex<float> *x,
                                      std::int64_t incx, std::complex<float> beta,
                                      std::complex<float> *y, std::int64_t incy,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::hemv(selector.get_queue(), upper_lower, n, alpha, a, lda, x,
                                                        incx, beta, y, incy, dependencies);
...
cl::sycl::event gemmt(
    backend_selector<backend::cublas> selector, uplo upper_lower, transpose transa, transpose transb, std::int64_t n,
...
cl::sycl::event sbmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    sbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::sbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x,
                                                        incx, beta, y, incy, dependencies);
    sbmv_postcondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y, incy,
                       dependencies);
    return done;
...
cl::sycl::event asum(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::asum(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event tbsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::tbsv(selector.get_queue(), upper_lower, trans, unit_diag, n, k,
                                                        a, lda, x, incx, dependencies);
...
cl::sycl::event spr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::spr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y,
                                                        incy, a, dependencies);
...
cl::sycl::event iamax(
    ...
    auto done = oneapi::mkl::cublas::MAJOR::iamax(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event rotm(backend_selector<backend::cublas> selector, std::int64_t n, float *x,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::rotm(selector.get_queue(), n, x, incx, y, incy, param, dependencies);
...
cl::sycl::event rotg(backend_selector<backend::cublas> selector, float *a, float *b, float *c,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::rotg(selector.get_queue(), a, b, c, s, dependencies);
...
cl::sycl::event sdsdot(
    backend_selector<backend::cublas> selector, std::int64_t n, float sb, const float *x, std::int64_t incx,
    const float *y, std::int64_t incy, float *result,
    const cl::sycl::vector_class<cl::sycl::event> &dependencies) {
    sdsdot_precondition(selector.get_queue(), n, sb, x, incx, y, incy, result, dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::sdsdot(selector.get_queue(), n, sb, x, incx, y, incy, result,
                                                          dependencies);
...
cl::sycl::event her2k(
    ...
    her2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                       dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::her2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
                                                         lda, b, ldb, beta, c, ldc, dependencies);
    her2k_postcondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta, c, ldc,
                        dependencies);
    return done;
...
cl::sycl::event dot(backend_selector<backend::cublas> selector, std::int64_t n, const float *x,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::dot(selector.get_queue(), n, x, incx, y, incy, result, dependencies);
...
cl::sycl::event symv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::symv(selector.get_queue(), upper_lower, n, alpha, a, lda, x,
                                                        incx, beta, y, incy, dependencies);
