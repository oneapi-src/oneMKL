...
void herk(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::herk(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda,
                                     beta, c, ldc);
...
void trmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::trmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda,
                                     x, incx);
...
void tpmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::tpmv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x,
                                     incx);
...
void gemm_batch(backend_selector<backend::cublas> selector, transpose transa, transpose transb,
    ...
    oneapi::mkl::cublas::MAJOR::gemm_batch(selector.get_queue(), transa, transb, m, n, k, alpha, a,
...
void syrk(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::syrk(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda,
                                     beta, c, ldc);
...
void her2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::her2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy,
                                     a, lda);
...
void hbmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    hbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y,
                      incy);
    oneapi::mkl::cublas::MAJOR::hbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x,
                                     incx, beta, y, incy);
...
void syr2k(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    syr2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta,
                       c, ldc);
    oneapi::mkl::cublas::MAJOR::syr2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda,
                                      b, ldb, beta, c, ldc);
...
void gemv(backend_selector<backend::cublas> selector, transpose trans, std::int64_t m,
    ...
    oneapi::mkl::cublas::MAJOR::gemv(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx,
                                     beta, y, incy);
...
void hpmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::hpmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta,
                                     y, incy);
...
void spmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::spmv(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta,
                                     y, incy);
...
void gemm_bias(backend_selector<backend::cublas> selector, transpose transa, transpose transb,
    ...
    oneapi::mkl::cublas::MAJOR::gemm_bias(selector.get_queue(), transa, transb, offsetc, m, n, k,
...
void gemm(backend_selector<backend::cublas> selector, transpose transa, transpose transb,
    ...
    gemm_precondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c,
                      ldc);
    oneapi::mkl::cublas::MAJOR::gemm(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda,
                                     b, ldb, beta, c, ldc);
...
void syr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::syr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy,
                                     a, lda);
...
void trsm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    trsm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha,
                      a, lda, b, ldb);
    oneapi::mkl::cublas::MAJOR::trsm(selector.get_queue(), left_right, upper_lower, trans,
...
void hemm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    hemm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb,
                      beta, c, ldc);
    oneapi::mkl::cublas::MAJOR::hemm(selector.get_queue(), left_right, upper_lower, m, n, alpha, a,
...
void hpr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::hpr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy,
                                     a);
...
void gbmv(backend_selector<backend::cublas> selector, transpose trans, std::int64_t m,
    ...
    gbmv_precondition(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx, beta, y,
                      incy);
    oneapi::mkl::cublas::MAJOR::gbmv(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x,
                                     incx, beta, y, incy);
...
void tbmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::tbmv(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a,
                                     lda, x, incx);
...
void symm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    symm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb,
                      beta, c, ldc);
    oneapi::mkl::cublas::MAJOR::symm(selector.get_queue(), left_right, upper_lower, m, n, alpha, a,
                                     lda, b, ldb, beta, c, ldc);
...
void trmm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    trmm_precondition(selector.get_queue(), left_right, upper_lower, trans, unit_diag, m, n, alpha,
                      a, lda, b, ldb);
    oneapi::mkl::cublas::MAJOR::trmm(selector.get_queue(), left_right, upper_lower, trans,
                                     unit_diag, m, n, alpha, a, lda, b, ldb);
...
void tpsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::tpsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x,
                                     incx);
...
void trsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::trsv(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda,
                                     x, incx);
...
void hemv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    oneapi::mkl::cublas::MAJOR::hemv(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx,
                                     beta, y, incy);
...
void gemmt(backend_selector<backend::cublas> selector, uplo upper_lower, transpose transa,
    ...
    gemmt_precondition(selector.get_queue(), upper_lower, transa, transb, n, k, alpha, a, lda, b,
                       ldb, beta, c, ldc);
    oneapi::mkl::cublas::MAJOR::gemmt(selector.get_queue(), upper_lower, transa, transb, n, k,
...
void sbmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    sbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y,
                      incy);
    oneapi::mkl::cublas::MAJOR::sbmv(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x,
                                     incx, beta, y, incy);
...
void tbsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    oneapi::mkl::cublas::MAJOR::tbsv(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a,
                                     lda, x, incx);
...
void spr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::spr2(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy,
                                     a);
...
void trsm_batch(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    oneapi::mkl::cublas::MAJOR::trsm_batch(selector.get_queue(), left_right, upper_lower, trans,
...
void her2k(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    her2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta,
                       c, ldc);
    oneapi::mkl::cublas::MAJOR::her2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda,
                                      b, ldb, beta, c, ldc);
...
void symv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n, float alpha,
    ...
    oneapi::mkl::cublas::MAJOR::symv(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx,
                                     beta, y, incy);
...
cl::sycl::event syr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    syr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::syr2(selector.get_queue(), upper_lower, n, alpha, x,
...
cl::sycl::event scal(backend_selector<backend::cublas> selector, std::int64_t n, float alpha,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::scal(selector.get_queue(), n, alpha, x, incx, dependencies);
...
cl::sycl::event trmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    trmv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x, incx,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::trmv(selector.get_queue(), upper_lower, trans,
...
cl::sycl::event tpmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    tpmv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::tpmv(selector.get_queue(), upper_lower, trans,
...
cl::sycl::event spr(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::spr(selector.get_queue(), upper_lower, n, alpha, x,
                                                incx, a, dependencies);
...
cl::sycl::event hpmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    hpmv_precondition(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::hpmv(selector.get_queue(), upper_lower, n, alpha, a, x,
...
cl::sycl::event syrk(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    syrk_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::syrk(selector.get_queue(), upper_lower, trans, n, k,
...
cl::sycl::event her2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    her2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::her2(selector.get_queue(), upper_lower, n, alpha, x,
                                                 incx, y, incy, a, lda, dependencies);
    her2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a, lda,
                       dependencies);
    return done;
...
cl::sycl::event hbmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    hbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y,
                      incy, dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::hbmv(selector.get_queue(), upper_lower, n, k, alpha, a,
...
cl::sycl::event rot(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::rot(selector.get_queue(), n, x, incx, y, incy, c, s,
                                                dependencies);
...
cl::sycl::event axpy(backend_selector<backend::cublas> selector, std::int64_t n, float alpha,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::axpy(selector.get_queue(), n, alpha, x, incx, y, incy,
                                                 dependencies);
...
cl::sycl::event axpy_batch(backend_selector<backend::cublas> selector, std::int64_t *n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::axpy_batch(selector.get_queue(), n, alpha, x, incx, y,
...
cl::sycl::event gerc(backend_selector<backend::cublas> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::gerc(selector.get_queue(), m, n, alpha, x, incx, y,
...
cl::sycl::event syr2k(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    syr2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta,
                       c, ldc, dependencies);
    auto done =
        oneapi::mkl::cublas::MAJOR::syr2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
...
cl::sycl::event gemv(backend_selector<backend::cublas> selector, transpose trans, std::int64_t m,
    ...
    gemv_precondition(selector.get_queue(), trans, m, n, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::gemv(selector.get_queue(), trans, m, n, alpha, a, lda,
...
cl::sycl::event her(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::her(selector.get_queue(), upper_lower, n, alpha, x,
...
cl::sycl::event hpr(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::hpr(selector.get_queue(), upper_lower, n, alpha, x,
                                                incx, a, dependencies);
...
cl::sycl::event iamin(backend_selector<backend::cublas> selector, std::int64_t n, const float *x,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::iamin(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event gemm_batch(backend_selector<backend::cublas> selector, transpose *transa,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::gemm_batch(selector.get_queue(), transa, transb, m, n,
...
cl::sycl::event spmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    spmv_precondition(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::spmv(selector.get_queue(), upper_lower, n, alpha, a, x,
                                                 incx, beta, y, incy, dependencies);
    spmv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, x, incx, beta, y, incy,
                       dependencies);
    return done;
...
cl::sycl::event swap(backend_selector<backend::cublas> selector, std::int64_t n, float *x,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::swap(selector.get_queue(), n, x, incx, y, incy, dependencies);
...
cl::sycl::event geru(backend_selector<backend::cublas> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::geru(selector.get_queue(), m, n, alpha, x, incx, y,
                                                 incy, a, lda, dependencies);
...
cl::sycl::event nrm2(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::nrm2(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event gemm(backend_selector<backend::cublas> selector, transpose transa, transpose transb,
    ...
    gemm_precondition(selector.get_queue(), transa, transb, m, n, k, alpha, a, lda, b, ldb, beta, c,
                      ldc, dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::gemm(selector.get_queue(), transa, transb, m, n, k,
...
cl::sycl::event herk(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    herk_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c, ldc,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::herk(selector.get_queue(), upper_lower, trans, n, k,
                                                 alpha, a, lda, beta, c, ldc, dependencies);
    herk_postcondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, beta, c, ldc,
                       dependencies);
    return done;
...
cl::sycl::event ger(backend_selector<backend::cublas> selector, std::int64_t m, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::ger(selector.get_queue(), m, n, alpha, x, incx, y, incy,
                                                a, lda, dependencies);
...
cl::sycl::event dotu(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::dotu(selector.get_queue(), n, x, incx, y, incy, result,
                                                 dependencies);
...
cl::sycl::event hemm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::hemm(selector.get_queue(), left_right, upper_lower, m, n, alpha,
...
cl::sycl::event hpr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    hpr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::hpr2(selector.get_queue(), upper_lower, n, alpha, x,
...
cl::sycl::event gbmv(backend_selector<backend::cublas> selector, transpose trans, std::int64_t m,
    ...
    gbmv_precondition(selector.get_queue(), trans, m, n, kl, ku, alpha, a, lda, x, incx, beta, y,
                      incy, dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::gbmv(selector.get_queue(), trans, m, n, kl, ku, alpha,
...
cl::sycl::event tbmv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    tbmv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x, incx,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::tbmv(selector.get_queue(), upper_lower, trans,
...
cl::sycl::event symm(backend_selector<backend::cublas> selector, side left_right, uplo upper_lower,
    ...
    symm_precondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb,
                      beta, c, ldc, dependencies);
    auto done =
        oneapi::mkl::cublas::MAJOR::symm(selector.get_queue(), left_right, upper_lower, m, n, alpha,
                                         a, lda, b, ldb, beta, c, ldc, dependencies);
    symm_postcondition(selector.get_queue(), left_right, upper_lower, m, n, alpha, a, lda, b, ldb,
                       beta, c, ldc, dependencies);
    return done;
...
cl::sycl::event dotc(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::dotc(selector.get_queue(), n, x, incx, y, incy, result,
                                                 dependencies);
...
cl::sycl::event syr(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::syr(selector.get_queue(), upper_lower, n, alpha, x,
                                                incx, a, lda, dependencies);
...
cl::sycl::event rotmg(backend_selector<backend::cublas> selector, float *d1, float *d2, float *x1,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::rotmg(selector.get_queue(), d1, d2, x1, y1, param,
                                                  dependencies);
...
cl::sycl::event tpsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    tpsv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::tpsv(selector.get_queue(), upper_lower, trans,
                                                 unit_diag, n, a, x, incx, dependencies);
    tpsv_postcondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, x, incx,
                       dependencies);
    return done;
...
cl::sycl::event trsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    trsv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x, incx,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::trsv(selector.get_queue(), upper_lower, trans,
                                                 unit_diag, n, a, lda, x, incx, dependencies);
    trsv_postcondition(selector.get_queue(), upper_lower, trans, unit_diag, n, a, lda, x, incx,
                       dependencies);
    return done;
...
cl::sycl::event copy(backend_selector<backend::cublas> selector, std::int64_t n, const float *x,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::copy(selector.get_queue(), n, x, incx, y, incy, dependencies);
...
cl::sycl::event hemv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    hemv_precondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::hemv(selector.get_queue(), upper_lower, n, alpha, a,
                                                 lda, x, incx, beta, y, incy, dependencies);
    hemv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy,
                       dependencies);
    return done;
...
cl::sycl::event gemmt(backend_selector<backend::cublas> selector, uplo upper_lower,
...
cl::sycl::event sbmv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    sbmv_precondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y,
                      incy, dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::sbmv(selector.get_queue(), upper_lower, n, k, alpha, a,
                                                 lda, x, incx, beta, y, incy, dependencies);
    sbmv_postcondition(selector.get_queue(), upper_lower, n, k, alpha, a, lda, x, incx, beta, y,
                       incy, dependencies);
    return done;
...
cl::sycl::event asum(backend_selector<backend::cublas> selector, std::int64_t n,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::asum(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event tbsv(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
    ...
    tbsv_precondition(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x, incx,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::tbsv(selector.get_queue(), upper_lower, trans,
                                                 unit_diag, n, k, a, lda, x, incx, dependencies);
    tbsv_postcondition(selector.get_queue(), upper_lower, trans, unit_diag, n, k, a, lda, x, incx,
                       dependencies);
    return done;
...
cl::sycl::event spr2(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    spr2_precondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::spr2(selector.get_queue(), upper_lower, n, alpha, x,
                                                 incx, y, incy, a, dependencies);
    spr2_postcondition(selector.get_queue(), upper_lower, n, alpha, x, incx, y, incy, a,
                       dependencies);
    return done;
...
cl::sycl::event iamax(backend_selector<backend::cublas> selector, std::int64_t n, const float *x,
    ...
    auto done =
        oneapi::mkl::cublas::MAJOR::iamax(selector.get_queue(), n, x, incx, result, dependencies);
...
cl::sycl::event rotm(backend_selector<backend::cublas> selector, std::int64_t n, float *x,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::rotm(selector.get_queue(), n, x, incx, y, incy, param,
                                                 dependencies);
...
cl::sycl::event sdsdot(backend_selector<backend::cublas> selector, std::int64_t n, float sb,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::sdsdot(selector.get_queue(), n, sb, x, incx, y, incy,
                                                   result, dependencies);
    sdsdot_postcondition(selector.get_queue(), n, sb, x, incx, y, incy, result, dependencies);
    return done;
}

cl::sycl::event her2k(backend_selector<backend::cublas> selector, uplo upper_lower, transpose trans,
                      std::int64_t n, std::int64_t k, std::complex<float> alpha,
                      const std::complex<float> *a, std::int64_t lda, const std::complex<float> *b,
    ...
    her2k_precondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta,
                       c, ldc, dependencies);
    auto done =
        oneapi::mkl::cublas::MAJOR::her2k(selector.get_queue(), upper_lower, trans, n, k, alpha, a,
                                          lda, b, ldb, beta, c, ldc, dependencies);
    her2k_postcondition(selector.get_queue(), upper_lower, trans, n, k, alpha, a, lda, b, ldb, beta,
                        c, ldc, dependencies);
    return done;
...
cl::sycl::event dot(backend_selector<backend::cublas> selector, std::int64_t n, const float *x,
    ...
    auto done = oneapi::mkl::cublas::MAJOR::dot(selector.get_queue(), n, x, incx, y, incy, result,
                                                dependencies);
...
cl::sycl::event symv(backend_selector<backend::cublas> selector, uplo upper_lower, std::int64_t n,
    ...
    symv_precondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy,
                      dependencies);
    auto done = oneapi::mkl::cublas::MAJOR::symv(selector.get_queue(), upper_lower, n, alpha, a,
                                                 lda, x, incx, beta, y, incy, dependencies);
    symv_postcondition(selector.get_queue(), upper_lower, n, alpha, a, lda, x, incx, beta, y, incy,
                       dependencies);
    return done;
