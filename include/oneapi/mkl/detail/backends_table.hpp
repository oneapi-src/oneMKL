...
static std::map<domain, std::map<device, std::vector<const char*>>> libraries = {
...
#endif
#ifdef ONEAPI_ONEMKL_ENABLE_PORTBLAS_BACKEND_INTEL_GPU
              LIB_NAME("blas_portblas"),
#endif
          } },
        { device::amdgpu,
...
#endif
#ifdef ONEAPI_ONEMKL_ENABLE_PORTBLAS_BACKEND_AMD_GPU
              LIB_NAME("blas_portblas"),
#endif
          } },
        { device::nvidiagpu,
...
#endif
#ifdef ONEAPI_ONEMKL_ENABLE_PORTBLAS_BACKEND_NVIDIA_GPU
              LIB_NAME("blas_portblas"),
#endif
          } },
      ...
      { { device::x86cpu,
          {
              ...
              LIB_NAME("dft_mklcpu")
#endif
#ifdef ONEAPI_ONEMKL_ENABLE_PORTFFT_BACKEND
        ...
        { device::amdgpu,
          {
#ifdef ONEAPI_ONEMKL_ENABLE_ROCFFT_BACKEND
              LIB_NAME("dft_rocfft")
#endif
#ifdef ONEAPI_ONEMKL_ENABLE_PORTFFT_BACKEND
                  LIB_NAME("dft_portfft")
        ...
        { device::nvidiagpu,
          {
#ifdef ONEAPI_ONEMKL_ENABLE_CUFFT_BACKEND
              LIB_NAME("dft_cufft")
#endif
#ifdef ONEAPI_ONEMKL_ENABLE_PORTFFT_BACKEND
                  LIB_NAME("dft_portfft")
    ...
    { domain::lapack,
      { { device::x86cpu,
        ...
        { device::amdgpu,
          {
#ifdef ONEAPI_ONEMKL_ENABLE_ROCSOLVER_BACKEND
              LIB_NAME("lapack_rocsolver")
#endif
          } },
        { device::nvidiagpu,
          {
#ifdef ONEAPI_ONEMKL_ENABLE_CUSOLVER_BACKEND
