...
ONEMATH_EXPORT std::int64_t orgbr_scratchpad_size<double>(sycl::queue &queue,
                                                         ...
                                                         std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t orgtr_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t orgtr_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t orgqr_scratchpad_size<double>(sycl::queue &queue, std::int64_t m,
                                                         ...
                                                         std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t ormrq_scratchpad_size<float>(sycl::queue &queue, oneapi::math::side side,
                                                        oneapi::math::transpose trans,
                                                        std::int64_t m, std::int64_t n,
                                                        std::int64_t k, std::int64_t lda,
                                                        std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormrq_scratchpad_size<double>(sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
                                                         std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormqr_scratchpad_size<float>(sycl::queue &queue, oneapi::math::side side,
                                                        oneapi::math::transpose trans,
                                                        std::int64_t m, std::int64_t n,
                                                        std::int64_t k, std::int64_t lda,
                                                        std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormqr_scratchpad_size<double>(sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
                                                         std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormtr_scratchpad_size<float>(sycl::queue &queue, oneapi::math::side side,
                                                        oneapi::math::uplo uplo,
                                                        oneapi::math::transpose trans,
                                                        std::int64_t m, std::int64_t n,
                                                        std::int64_t lda, std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormtr_scratchpad_size<double>(sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::uplo uplo,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t lda, std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t potrf_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potrf_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t potrf_scratchpad_size<std::complex<double>>(sycl::queue &queue,
                                                                       ...
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potrs_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t nrhs,
                                                        std::int64_t lda, std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t potrs_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t nrhs,
                                                         std::int64_t lda, std::int64_t ldb);
template <>
...
ONEMATH_EXPORT std::int64_t potrs_scratchpad_size<std::complex<double>>(
    ...
    std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t potri_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potri_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t potri_scratchpad_size<std::complex<double>>(sycl::queue &queue,
                                                                       ...
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrf_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrf_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t syevd_scratchpad_size<float>(sycl::queue &queue, oneapi::math::job jobz,
                                                        ...
                                                        std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t syevd_scratchpad_size<double>(sycl::queue &queue, oneapi::math::job jobz,
                                                         oneapi::math::uplo uplo, std::int64_t n,
                                                         std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t sygvd_scratchpad_size<double>(sycl::queue &queue, std::int64_t itype,
                                                         ...
                                                         std::int64_t lda, std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t sytrd_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrd_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t trtrs_scratchpad_size<float>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                        oneapi::math::transpose trans,
                                                        oneapi::math::diag diag, std::int64_t n,
                                                        std::int64_t nrhs, std::int64_t lda,
                                                        std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t trtrs_scratchpad_size<double>(sycl::queue &queue, oneapi::math::uplo uplo,
                                                         oneapi::math::transpose trans,
                                                         oneapi::math::diag diag, std::int64_t n,
                                                         std::int64_t nrhs, std::int64_t lda,
                                                         std::int64_t ldb);
