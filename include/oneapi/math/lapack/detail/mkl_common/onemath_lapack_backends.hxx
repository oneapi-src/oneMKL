...
ONEMATH_EXPORT void gebrd(sycl::queue &queue, std::int64_t m, std::int64_t n,
                         ...
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void gebrd(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<float> &a,
...
ONEMATH_EXPORT void gebrd(sycl::queue &queue, std::int64_t m, std::int64_t n,
                         ...
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void gerqf(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<float> &a,
...
ONEMATH_EXPORT void geqrf(sycl::queue &queue, std::int64_t m, std::int64_t n,
                         sycl::buffer<double> &a, std::int64_t lda, sycl::buffer<double> &tau,
                         sycl::buffer<double> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void geqrf(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<float> &a,
                         std::int64_t lda, sycl::buffer<float> &tau,
                         sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void geqrf(sycl::queue &queue, std::int64_t m, std::int64_t n,
                         sycl::buffer<std::complex<double>> &a, std::int64_t lda,
...
ONEMATH_EXPORT void getrf(sycl::queue &queue, std::int64_t m, std::int64_t n,
                         ...
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void getrf(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<float> &a,
...
ONEMATH_EXPORT sycl::event geqrf_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, float *a,
                                      ...
                                      float *scratchpad, std::int64_t scratchpad_size,
                                      const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event geqrf_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, double *a,
...
ONEMATH_EXPORT sycl::event getrf_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, float *a,
                                      ...
                                      float *scratchpad, std::int64_t scratchpad_size,
                                      const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event getrf_batch(sycl::queue &queue, std::int64_t m, std::int64_t n, double *a,
                                      std::int64_t lda, std::int64_t stride_a, std::int64_t *ipiv,
                                      std::int64_t stride_ipiv, std::int64_t batch_size,
                                      double *scratchpad, std::int64_t scratchpad_size,
                                      const std::vector<sycl::event> &dependencies = {});
...
template <>
ONEMATH_EXPORT std::int64_t gesvd_scratchpad_size<double>(sycl::queue &queue,
                                                         oneapi::mkl::jobsvd jobu,
                                                         oneapi::mkl::jobsvd jobvt, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda,
                                                         std::int64_t ldu, std::int64_t ldvt);
...
ONEMATH_EXPORT std::int64_t orgbr_scratchpad_size<double>(sycl::queue &queue,
                                                         ...
                                                         std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t orgtr_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t orgtr_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t orgqr_scratchpad_size<double>(sycl::queue &queue, std::int64_t m,
                                                         ...
                                                         std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t ormrq_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::side side,
                                                        oneapi::mkl::transpose trans,
                                                        std::int64_t m, std::int64_t n,
                                                        std::int64_t k, std::int64_t lda,
                                                        std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormrq_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::side side,
                                                         oneapi::mkl::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
                                                         std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormqr_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::side side,
                                                        oneapi::mkl::transpose trans,
                                                        std::int64_t m, std::int64_t n,
                                                        std::int64_t k, std::int64_t lda,
                                                        std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormqr_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::side side,
                                                         oneapi::mkl::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
                                                         std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormtr_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::side side,
                                                        oneapi::mkl::uplo uplo,
                                                        oneapi::mkl::transpose trans,
                                                        std::int64_t m, std::int64_t n,
                                                        std::int64_t lda, std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormtr_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::side side,
                                                         oneapi::mkl::uplo uplo,
                                                         oneapi::mkl::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t lda, std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t potrf_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potrf_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t potrf_scratchpad_size<std::complex<double>>(sycl::queue &queue,
                                                                       ...
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potrs_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t nrhs,
                                                        std::int64_t lda, std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t potrs_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t nrhs,
                                                         std::int64_t lda, std::int64_t ldb);
template <>
...
ONEMATH_EXPORT std::int64_t potrs_scratchpad_size<std::complex<double>>(
    ...
    std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t potri_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potri_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t potri_scratchpad_size<std::complex<double>>(sycl::queue &queue,
                                                                       ...
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrf_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrf_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t sytrf_scratchpad_size<std::complex<double>>(sycl::queue &queue,
                                                                       ...
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t syevd_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::job jobz,
                                                        oneapi::mkl::uplo uplo, std::int64_t n,
                                                        std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t syevd_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::job jobz,
                                                         oneapi::mkl::uplo uplo, std::int64_t n,
                                                         std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t sygvd_scratchpad_size<double>(sycl::queue &queue, std::int64_t itype,
                                                         ...
                                                         std::int64_t lda, std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t sytrd_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrd_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t trtrs_scratchpad_size<float>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        oneapi::mkl::transpose trans,
                                                        oneapi::mkl::diag diag, std::int64_t n,
                                                        std::int64_t nrhs, std::int64_t lda,
                                                        std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t trtrs_scratchpad_size<double>(sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         oneapi::mkl::transpose trans,
                                                         oneapi::mkl::diag diag, std::int64_t n,
                                                         std::int64_t nrhs, std::int64_t lda,
                                                         std::int64_t ldb);
