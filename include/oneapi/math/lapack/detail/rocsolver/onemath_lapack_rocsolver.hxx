...
template <typename T>
ONEMATH_EXPORT std::int64_t gebrd_scratchpad_size(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                                 std::int64_t lda);

template <typename T>
ONEMATH_EXPORT std::int64_t gerqf_scratchpad_size(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                                 std::int64_t lda);

template <typename T>
ONEMATH_EXPORT std::int64_t geqrf_scratchpad_size(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                                 std::int64_t lda);
...
template <typename T>
ONEMATH_EXPORT std::int64_t getrf_scratchpad_size(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                                 std::int64_t lda);
...
template <typename T>
ONEMATH_EXPORT std::int64_t orgqr_scratchpad_size(sycl::queue &queue, std::int64_t m, std::int64_t n,
...
template <typename T>
ONEMATH_EXPORT std::int64_t ungqr_scratchpad_size(sycl::queue &queue, std::int64_t m, std::int64_t n,
                                                 std::int64_t k, std::int64_t lda);
...
template <typename T>
ONEMATH_EXPORT std::int64_t getrs_batch_scratchpad_size(sycl::queue &queue,
	      	                                       oneapi::math::transpose trans,
                                                       std::int64_t n, std::int64_t nrhs,
                                                       std::int64_t lda, std::int64_t stride_a,
