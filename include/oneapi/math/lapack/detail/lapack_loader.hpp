...
ONEMATH_EXPORT void gebrd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
...
ONEMATH_EXPORT void gebrd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                         ...
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void gerqf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                         std::int64_t n, sycl::buffer<float> &a, std::int64_t lda,
...
ONEMATH_EXPORT void gerqf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void geqrf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                         std::int64_t n, sycl::buffer<std::complex<float>> &a, std::int64_t lda,
                         sycl::buffer<std::complex<float>> &tau,
                         sycl::buffer<std::complex<float>> &scratchpad,
                         std::int64_t scratchpad_size);
...
ONEMATH_EXPORT void geqrf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void getrf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                         std::int64_t n, sycl::buffer<std::complex<float>> &a, std::int64_t lda,
...
ONEMATH_EXPORT void getrf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void getri(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
...
ONEMATH_EXPORT void getri(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void getrs(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT void getrs(oneapi::mkl::device libkey, sycl::queue &queue,
                         ...
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void gesvd(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::jobsvd jobu,
...
ONEMATH_EXPORT void gesvd(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::jobsvd jobu,
                         ...
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void heevd(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::job jobz,
...
ONEMATH_EXPORT void heevd(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::job jobz,
                         ...
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void hegvd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t itype,
...
ONEMATH_EXPORT void hegvd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t itype,
                         ...
                         sycl::buffer<double> &w, sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void hetrd(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         std::int64_t n, sycl::buffer<std::complex<float>> &a, std::int64_t lda,
                         sycl::buffer<float> &d, sycl::buffer<float> &e,
                         sycl::buffer<std::complex<float>> &tau,
                         sycl::buffer<std::complex<float>> &scratchpad,
...
ONEMATH_EXPORT void hetrd(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void hetrf(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         std::int64_t n, sycl::buffer<std::complex<float>> &a, std::int64_t lda,
                         sycl::buffer<std::int64_t> &ipiv,
                         sycl::buffer<std::complex<float>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void hetrf(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void orgbr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::generate vec,
...
ONEMATH_EXPORT void orgbr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::generate vec,
                         ...
                         sycl::buffer<double> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void orgqr(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
...
ONEMATH_EXPORT void orgqr(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                         ...
                         sycl::buffer<float> &tau, sycl::buffer<float> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void orgtr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         std::int64_t n, sycl::buffer<float> &a, std::int64_t lda,
                         sycl::buffer<float> &tau, sycl::buffer<float> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void orgtr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         ...
                         sycl::buffer<double> &tau, sycl::buffer<double> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void ormtr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
...
ONEMATH_EXPORT void ormtr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
                         ...
                         sycl::buffer<double> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void ormrq(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
...
ONEMATH_EXPORT void ormrq(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
                         ...
                         sycl::buffer<double> &tau, sycl::buffer<double> &c, std::int64_t ldc,
                         sycl::buffer<double> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void ormqr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
                         oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
                         std::int64_t k, sycl::buffer<double> &a, std::int64_t lda,
                         sycl::buffer<double> &tau, sycl::buffer<double> &c, std::int64_t ldc,
                         sycl::buffer<double> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void ormqr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
                         ...
                         sycl::buffer<float> &tau, sycl::buffer<float> &c, std::int64_t ldc,
                         sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void potrf(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         std::int64_t n, sycl::buffer<float> &a, std::int64_t lda,
                         sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void potrf(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         std::int64_t n, sycl::buffer<double> &a, std::int64_t lda,
...
ONEMATH_EXPORT void potrf(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void potri(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         std::int64_t n, sycl::buffer<float> &a, std::int64_t lda,
                         sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void potri(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         std::int64_t n, sycl::buffer<double> &a, std::int64_t lda,
...
ONEMATH_EXPORT void potri(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void potrs(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
...
ONEMATH_EXPORT void potrs(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void syevd(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::job jobz,
...
ONEMATH_EXPORT void syevd(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::job jobz,
                         ...
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void sygvd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t itype,
                         oneapi::mkl::job jobz, oneapi::mkl::uplo uplo, std::int64_t n,
...
ONEMATH_EXPORT void sygvd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t itype,
                         ...
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void sytrd(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         std::int64_t n, sycl::buffer<double> &a, std::int64_t lda,
                         sycl::buffer<double> &d, sycl::buffer<double> &e,
                         sycl::buffer<double> &tau, sycl::buffer<double> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void sytrd(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         ...
                         sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void sytrf(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         std::int64_t n, sycl::buffer<float> &a, std::int64_t lda,
                         sycl::buffer<std::int64_t> &ipiv, sycl::buffer<float> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void sytrf(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
...
ONEMATH_EXPORT void sytrf(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void trtrs(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
...
ONEMATH_EXPORT void trtrs(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void ungbr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::generate vec,
...
ONEMATH_EXPORT void ungbr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::generate vec,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void ungqr(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
...
ONEMATH_EXPORT void ungqr(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void ungtr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         std::int64_t n, sycl::buffer<std::complex<float>> &a, std::int64_t lda,
                         sycl::buffer<std::complex<float>> &tau,
                         sycl::buffer<std::complex<float>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void ungtr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::uplo uplo,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void unmrq(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
                         oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
...
ONEMATH_EXPORT void unmrq(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void unmqr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
                         oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
                         std::int64_t k, sycl::buffer<std::complex<float>> &a, std::int64_t lda,
                         sycl::buffer<std::complex<float>> &tau,
                         sycl::buffer<std::complex<float>> &c, std::int64_t ldc,
...
ONEMATH_EXPORT void unmqr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void unmtr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
                         oneapi::mkl::uplo uplo, oneapi::mkl::transpose trans, std::int64_t m,
                         std::int64_t n, sycl::buffer<std::complex<float>> &a, std::int64_t lda,
                         sycl::buffer<std::complex<float>> &tau,
                         sycl::buffer<std::complex<float>> &c, std::int64_t ldc,
...
ONEMATH_EXPORT void unmtr(oneapi::mkl::device libkey, sycl::queue &queue, oneapi::mkl::side side,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void geqrf_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                               std::int64_t n, sycl::buffer<float> &a, std::int64_t lda,
...
ONEMATH_EXPORT void geqrf_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                               ...
                               sycl::buffer<std::complex<double>> &scratchpad,
                               std::int64_t scratchpad_size);
ONEMATH_EXPORT void getri_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
...
ONEMATH_EXPORT void getri_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                               ...
                               sycl::buffer<std::complex<double>> &scratchpad,
                               std::int64_t scratchpad_size);
ONEMATH_EXPORT void getrs_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                               oneapi::mkl::transpose trans, std::int64_t n, std::int64_t nrhs,
                               sycl::buffer<float> &a, std::int64_t lda, std::int64_t stride_a,
                               sycl::buffer<std::int64_t> &ipiv, std::int64_t stride_ipiv,
...
ONEMATH_EXPORT void getrs_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                               ...
                               sycl::buffer<std::complex<double>> &scratchpad,
                               std::int64_t scratchpad_size);
ONEMATH_EXPORT void getrf_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                               std::int64_t n, sycl::buffer<float> &a, std::int64_t lda,
                               std::int64_t stride_a, sycl::buffer<std::int64_t> &ipiv,
                               std::int64_t stride_ipiv, std::int64_t batch_size,
                               sycl::buffer<float> &scratchpad, std::int64_t scratchpad_size);
...
ONEMATH_EXPORT void getrf_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                               ...
                               sycl::buffer<std::complex<double>> &scratchpad,
                               std::int64_t scratchpad_size);
ONEMATH_EXPORT void orgqr_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
...
ONEMATH_EXPORT void orgqr_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                               ...
                               std::int64_t stride_tau, std::int64_t batch_size,
                               sycl::buffer<double> &scratchpad, std::int64_t scratchpad_size);
ONEMATH_EXPORT void potrf_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                               oneapi::mkl::uplo uplo, std::int64_t n, sycl::buffer<float> &a,
...
ONEMATH_EXPORT void potrf_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                               ...
                               sycl::buffer<std::complex<double>> &scratchpad,
                               std::int64_t scratchpad_size);
ONEMATH_EXPORT void potrs_batch(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT void potrs_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                               ...
                               sycl::buffer<std::complex<double>> &scratchpad,
                               std::int64_t scratchpad_size);
ONEMATH_EXPORT void ungqr_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                               std::int64_t n, std::int64_t k, sycl::buffer<std::complex<float>> &a,
                               std::int64_t lda, std::int64_t stride_a,
                               sycl::buffer<std::complex<float>> &tau, std::int64_t stride_tau,
                               std::int64_t batch_size,
...
ONEMATH_EXPORT void ungqr_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                               ...
                               sycl::buffer<std::complex<double>> &scratchpad,
                               std::int64_t scratchpad_size);
ONEMATH_EXPORT sycl::event gebrd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
...
ONEMATH_EXPORT sycl::event gebrd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event gerqf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
...
ONEMATH_EXPORT sycl::event gerqf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event geqrf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                                std::int64_t n, std::complex<float> *a, std::int64_t lda,
                                std::complex<float> *tau, std::complex<float> *scratchpad,
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event geqrf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event getrf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                                std::int64_t n, std::complex<float> *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event getrf(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event getri(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
...
ONEMATH_EXPORT sycl::event getri(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                                ...
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event getrs(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::transpose trans, std::int64_t n, std::int64_t nrhs,
                                std::complex<float> *a, std::int64_t lda, std::int64_t *ipiv,
...
ONEMATH_EXPORT sycl::event getrs(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::complex<double> *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event gesvd(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event gesvd(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::complex<double> *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event heevd(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::job jobz, oneapi::mkl::uplo uplo, std::int64_t n,
...
ONEMATH_EXPORT sycl::event heevd(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::complex<double> *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event hegvd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t itype,
                                oneapi::mkl::job jobz, oneapi::mkl::uplo uplo, std::int64_t n,
...
ONEMATH_EXPORT sycl::event hegvd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t itype,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event hetrd(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event hetrd(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::complex<double> *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event hetrf(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::uplo uplo, std::int64_t n, std::complex<float> *a,
...
ONEMATH_EXPORT sycl::event hetrf(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::complex<double> *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event orgbr(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event orgbr(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                double *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event orgqr(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
...
ONEMATH_EXPORT sycl::event orgqr(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                                ...
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event orgtr(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event orgtr(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                double *tau, double *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event ormtr(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event ormtr(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event ormrq(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event ormrq(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                double *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event ormqr(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::side side, oneapi::mkl::transpose trans,
                                std::int64_t m, std::int64_t n, std::int64_t k, double *a,
                                std::int64_t lda, double *tau, double *c, std::int64_t ldc,
                                double *scratchpad, std::int64_t scratchpad_size,
...
ONEMATH_EXPORT sycl::event ormqr(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                float *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event potrf(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::uplo uplo, std::int64_t n, float *a, std::int64_t lda,
                                float *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event potrf(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event potrf(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event potri(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::uplo uplo, std::int64_t n, float *a, std::int64_t lda,
                                float *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event potri(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event potri(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event potrs(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event potrs(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event syevd(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::job jobz, oneapi::mkl::uplo uplo, std::int64_t n,
...
ONEMATH_EXPORT sycl::event syevd(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event sygvd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t itype,
                                oneapi::mkl::job jobz, oneapi::mkl::uplo uplo, std::int64_t n,
...
ONEMATH_EXPORT sycl::event sygvd(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t itype,
                                ...
                                float *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event sytrd(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::uplo uplo, std::int64_t n, double *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event sytrd(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event sytrf(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::uplo uplo, std::int64_t n, float *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event sytrf(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::complex<double> *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event trtrs(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event trtrs(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event ungbr(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::generate vec, std::int64_t m, std::int64_t n,
...
ONEMATH_EXPORT sycl::event ungbr(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event ungqr(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
...
ONEMATH_EXPORT sycl::event ungqr(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                                ...
                                std::complex<double> *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event ungtr(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::uplo uplo, std::int64_t n, std::complex<float> *a,
                                std::int64_t lda, std::complex<float> *tau,
                                std::complex<float> *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event ungtr(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::complex<double> *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event unmrq(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::side side, oneapi::mkl::transpose trans,
                                std::int64_t m, std::int64_t n, std::int64_t k,
...
ONEMATH_EXPORT sycl::event unmrq(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event unmqr(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::side side, oneapi::mkl::transpose trans,
                                std::int64_t m, std::int64_t n, std::int64_t k,
                                std::complex<float> *a, std::int64_t lda, std::complex<float> *tau,
                                std::complex<float> *c, std::int64_t ldc,
...
ONEMATH_EXPORT sycl::event unmqr(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event unmtr(oneapi::mkl::device libkey, sycl::queue &queue,
                                oneapi::mkl::side side, oneapi::mkl::uplo uplo,
                                oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
                                std::complex<float> *a, std::int64_t lda, std::complex<float> *tau,
                                std::complex<float> *c, std::int64_t ldc,
...
ONEMATH_EXPORT sycl::event unmtr(oneapi::mkl::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event geqrf_batch(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event geqrf_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                      ...
                                      std::int64_t scratchpad_size,
                                      const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event getrf_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                      std::int64_t m, std::int64_t n, float *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event getrf_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                      ...
                                      std::int64_t scratchpad_size,
                                      const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event getri_batch(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event getri_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                      ...
                                      std::int64_t scratchpad_size,
                                      const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event getrs_batch(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event getrs_batch(
    ...
    const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event orgqr_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                      std::int64_t m, std::int64_t n, std::int64_t k, float *a,
...
ONEMATH_EXPORT sycl::event orgqr_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                      ...
                                      std::int64_t scratchpad_size,
                                      const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event potrf_batch(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event potrf_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                      ...
                                      std::int64_t scratchpad_size,
                                      const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event potrs_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                      oneapi::mkl::uplo uplo, std::int64_t n, std::int64_t nrhs,
...
ONEMATH_EXPORT sycl::event potrs_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                      ...
                                      std::int64_t scratchpad_size,
                                      const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event ungqr_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                      std::int64_t m, std::int64_t n, std::int64_t k,
                                      std::complex<float> *a, std::int64_t lda,
...
template <>
ONEMATH_EXPORT std::int64_t gebrd_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, std::int64_t m,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t gebrd_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t gebrd_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      std::int64_t m,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t gebrd_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       std::int64_t m,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t gerqf_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, std::int64_t m,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t gerqf_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t gerqf_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      std::int64_t m,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t gerqf_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       std::int64_t m,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t geqrf_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, std::int64_t m,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t geqrf_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t geqrf_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      std::int64_t m,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t geqrf_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       std::int64_t m,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t gesvd_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue,
                                                        ...
                                                        std::int64_t ldu, std::int64_t ldvt);
template <>
ONEMATH_EXPORT std::int64_t gesvd_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue,
                                                         oneapi::mkl::jobsvd jobu,
                                                         oneapi::mkl::jobsvd jobvt, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda,
...
ONEMATH_EXPORT std::int64_t gesvd_scratchpad_size<std::complex<double>>(
    ...
    std::int64_t ldvt);
template <>
ONEMATH_EXPORT std::int64_t getrf_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, std::int64_t m,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t getrf_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t getrf_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      std::int64_t m,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t getrf_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       std::int64_t m,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t getri_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, std::int64_t n,
                                                        std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t getri_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, std::int64_t n,
                                                         std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t getri_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t getri_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t getrs_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue,
                                                        oneapi::mkl::transpose trans,
                                                        std::int64_t n, std::int64_t nrhs,
                                                        std::int64_t lda, std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t getrs_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue,
                                                         oneapi::mkl::transpose trans,
                                                         std::int64_t n, std::int64_t nrhs,
                                                         std::int64_t lda, std::int64_t ldb);
...
ONEMATH_EXPORT std::int64_t hegvd_scratchpad_size<std::complex<double>>(
    ...
    oneapi::mkl::uplo uplo, std::int64_t n, std::int64_t lda, std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t hetrd_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      oneapi::mkl::uplo uplo,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t hetrd_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       oneapi::mkl::uplo uplo,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t hetrf_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      oneapi::mkl::uplo uplo,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t hetrf_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       oneapi::mkl::uplo uplo,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t orgbr_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue,
                                                        oneapi::mkl::generate vect, std::int64_t m,
                                                        std::int64_t n, std::int64_t k,
                                                        std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t orgbr_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue,
                                                         oneapi::mkl::generate vect, std::int64_t m,
                                                         std::int64_t n, std::int64_t k,
                                                         std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t orgtr_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t orgtr_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t orgqr_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, std::int64_t m,
                                                        std::int64_t n, std::int64_t k,
                                                        std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t orgqr_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, std::int64_t m,
                                                         std::int64_t n, std::int64_t k,
                                                         std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t ormrq_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        ...
                                                        std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormrq_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::side side,
                                                         oneapi::mkl::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
                                                         std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormqr_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, oneapi::mkl::side side,
                                                        oneapi::mkl::transpose trans,
                                                        std::int64_t m, std::int64_t n,
                                                        std::int64_t k, std::int64_t lda,
                                                        std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormqr_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::side side,
                                                         oneapi::mkl::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
                                                         std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormtr_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, oneapi::mkl::side side,
                                                        oneapi::mkl::uplo uplo,
                                                        oneapi::mkl::transpose trans,
                                                        std::int64_t m, std::int64_t n,
                                                        std::int64_t lda, std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormtr_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::side side,
                                                         oneapi::mkl::uplo uplo,
                                                         oneapi::mkl::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t lda, std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t potrf_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potrf_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potrf_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      oneapi::mkl::uplo uplo,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potrf_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       oneapi::mkl::uplo uplo,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potrs_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t nrhs,
                                                        std::int64_t lda, std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t potrs_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t nrhs,
                                                         std::int64_t lda, std::int64_t ldb);
template <>
...
ONEMATH_EXPORT std::int64_t potrs_scratchpad_size<std::complex<double>>(
    ...
    std::int64_t nrhs, std::int64_t lda, std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t potri_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potri_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potri_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      oneapi::mkl::uplo uplo,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t potri_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       oneapi::mkl::uplo uplo,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrf_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrf_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrf_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      oneapi::mkl::uplo uplo,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrf_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       oneapi::mkl::uplo uplo,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t syevd_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, oneapi::mkl::job jobz,
                                                        oneapi::mkl::uplo uplo, std::int64_t n,
                                                        std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t syevd_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::job jobz,
                                                         oneapi::mkl::uplo uplo, std::int64_t n,
                                                         std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sygvd_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, std::int64_t itype,
                                                        oneapi::mkl::job jobz,
                                                        oneapi::mkl::uplo uplo, std::int64_t n,
                                                        std::int64_t lda, std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t sygvd_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, std::int64_t itype,
                                                         oneapi::mkl::job jobz,
                                                         oneapi::mkl::uplo uplo, std::int64_t n,
                                                         std::int64_t lda, std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t sytrd_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t sytrd_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t trtrs_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                        sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                        oneapi::mkl::transpose trans,
                                                        ...
                                                        std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t trtrs_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                         sycl::queue &queue, oneapi::mkl::uplo uplo,
                                                         oneapi::mkl::transpose trans,
                                                         oneapi::mkl::diag diag, std::int64_t n,
                                                         std::int64_t nrhs, std::int64_t lda,
...
ONEMATH_EXPORT std::int64_t ungqr_scratchpad_size<std::complex<double>>(
    ...
    std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t ungtr_scratchpad_size<std::complex<float>>(oneapi::mkl::device libkey,
                                                                      sycl::queue &queue,
                                                                      oneapi::mkl::uplo uplo,
                                                                      std::int64_t n,
                                                                      std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t ungtr_scratchpad_size<std::complex<double>>(oneapi::mkl::device libkey,
                                                                       sycl::queue &queue,
                                                                       oneapi::mkl::uplo uplo,
                                                                       std::int64_t n,
                                                                       std::int64_t lda);
...
ONEMATH_EXPORT std::int64_t ungqr_batch_scratchpad_size<std::complex<double>>(
    ...
    std::int64_t lda, std::int64_t stride_a, std::int64_t stride_tau, std::int64_t batch_size);
template <>
ONEMATH_EXPORT std::int64_t getrf_batch_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                              sycl::queue &queue, std::int64_t *m,
                                                              std::int64_t *n, std::int64_t *lda,
                                                              std::int64_t group_count,
                                                              std::int64_t *group_sizes);
template <>
ONEMATH_EXPORT std::int64_t getrf_batch_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                               sycl::queue &queue, std::int64_t *m,
                                                               std::int64_t *n, std::int64_t *lda,
                                                               std::int64_t group_count,
                                                               std::int64_t *group_sizes);
...
ONEMATH_EXPORT std::int64_t getrf_batch_scratchpad_size<std::complex<double>>(
    ...
    std::int64_t *lda, std::int64_t group_count, std::int64_t *group_sizes);
template <>
ONEMATH_EXPORT std::int64_t getri_batch_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                              sycl::queue &queue, std::int64_t *n,
                                                              std::int64_t *lda,
                                                              std::int64_t group_count,
                                                              std::int64_t *group_sizes);
template <>
ONEMATH_EXPORT std::int64_t getri_batch_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                               sycl::queue &queue, std::int64_t *n,
                                                               std::int64_t *lda,
                                                               std::int64_t group_count,
                                                               std::int64_t *group_sizes);
...
ONEMATH_EXPORT std::int64_t getrs_batch_scratchpad_size<std::complex<double>>(
    ...
    std::int64_t *group_sizes);
template <>
ONEMATH_EXPORT std::int64_t geqrf_batch_scratchpad_size<float>(oneapi::mkl::device libkey,
                                                              sycl::queue &queue, std::int64_t *m,
                                                              std::int64_t *n, std::int64_t *lda,
                                                              std::int64_t group_count,
                                                              std::int64_t *group_sizes);
template <>
ONEMATH_EXPORT std::int64_t geqrf_batch_scratchpad_size<double>(oneapi::mkl::device libkey,
                                                               sycl::queue &queue, std::int64_t *m,
                                                               std::int64_t *n, std::int64_t *lda,
                                                               std::int64_t group_count,
                                                               std::int64_t *group_sizes);
