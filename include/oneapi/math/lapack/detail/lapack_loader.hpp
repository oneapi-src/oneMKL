...
ONEMATH_EXPORT void getrs(oneapi::math::device libkey, sycl::queue &queue,
                         ...
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void gesvd(oneapi::math::device libkey, sycl::queue &queue, oneapi::math::jobsvd jobu,
...
ONEMATH_EXPORT void hetrf(oneapi::math::device libkey, sycl::queue &queue, oneapi::math::uplo uplo,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void orgbr(oneapi::math::device libkey, sycl::queue &queue, oneapi::math::generate vec,
...
ONEMATH_EXPORT void trtrs(oneapi::math::device libkey, sycl::queue &queue, oneapi::math::uplo uplo,
                         ...
                         sycl::buffer<std::complex<double>> &scratchpad,
                         std::int64_t scratchpad_size);
ONEMATH_EXPORT void ungbr(oneapi::math::device libkey, sycl::queue &queue, oneapi::math::generate vec,
...
ONEMATH_EXPORT sycl::event heevd(oneapi::math::device libkey, sycl::queue &queue,
                                ...
                                std::complex<double> *scratchpad, std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event hegvd(oneapi::math::device libkey, sycl::queue &queue, std::int64_t itype,
                                oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
...
ONEMATH_EXPORT sycl::event syevd(oneapi::math::device libkey, sycl::queue &queue,
                                ...
                                std::int64_t scratchpad_size,
                                const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event sygvd(oneapi::math::device libkey, sycl::queue &queue, std::int64_t itype,
                                oneapi::math::job jobz, oneapi::math::uplo uplo, std::int64_t n,
...
ONEMATH_EXPORT std::int64_t gesvd_scratchpad_size<float>(oneapi::math::device libkey,
                                                        ...
                                                        std::int64_t ldu, std::int64_t ldvt);
template <>
ONEMATH_EXPORT std::int64_t gesvd_scratchpad_size<double>(oneapi::math::device libkey,
                                                         sycl::queue &queue,
                                                         oneapi::math::jobsvd jobu,
                                                         oneapi::math::jobsvd jobvt, std::int64_t m,
                                                         std::int64_t n, std::int64_t lda,
...
ONEMATH_EXPORT std::int64_t heevd_scratchpad_size<std::complex<float>>(
    oneapi::math::device libkey, sycl::queue &queue, oneapi::math::job jobz, oneapi::math::uplo uplo,
    std::int64_t n, std::int64_t lda);
template <>
...
ONEMATH_EXPORT std::int64_t orgqr_scratchpad_size<double>(oneapi::math::device libkey,
                                                         ...
                                                         std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t ormrq_scratchpad_size<float>(oneapi::math::device libkey,
                                                        ...
                                                        std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormrq_scratchpad_size<double>(oneapi::math::device libkey,
                                                         sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
                                                         std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormqr_scratchpad_size<float>(oneapi::math::device libkey,
                                                        sycl::queue &queue, oneapi::math::side side,
                                                        oneapi::math::transpose trans,
                                                        std::int64_t m, std::int64_t n,
                                                        std::int64_t k, std::int64_t lda,
                                                        std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormqr_scratchpad_size<double>(oneapi::math::device libkey,
                                                         sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
                                                         std::int64_t k, std::int64_t lda,
                                                         std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormtr_scratchpad_size<float>(oneapi::math::device libkey,
                                                        sycl::queue &queue, oneapi::math::side side,
                                                        oneapi::math::uplo uplo,
                                                        oneapi::math::transpose trans,
                                                        std::int64_t m, std::int64_t n,
                                                        std::int64_t lda, std::int64_t ldc);
template <>
ONEMATH_EXPORT std::int64_t ormtr_scratchpad_size<double>(oneapi::math::device libkey,
                                                         sycl::queue &queue, oneapi::math::side side,
                                                         oneapi::math::uplo uplo,
                                                         oneapi::math::transpose trans,
                                                         std::int64_t m, std::int64_t n,
...
ONEMATH_EXPORT std::int64_t sytrd_scratchpad_size<double>(oneapi::math::device libkey,
                                                         ...
                                                         std::int64_t n, std::int64_t lda);
template <>
ONEMATH_EXPORT std::int64_t trtrs_scratchpad_size<float>(oneapi::math::device libkey,
                                                        sycl::queue &queue, oneapi::math::uplo uplo,
                                                        oneapi::math::transpose trans,
                                                        ...
                                                        std::int64_t ldb);
template <>
ONEMATH_EXPORT std::int64_t trtrs_scratchpad_size<double>(oneapi::math::device libkey,
                                                         sycl::queue &queue, oneapi::math::uplo uplo,
                                                         oneapi::math::transpose trans,
                                                         oneapi::math::diag diag, std::int64_t n,
                                                         std::int64_t nrhs, std::int64_t lda,
...
ONEMATH_EXPORT std::int64_t unmtr_scratchpad_size<std::complex<float>>(
    oneapi::math::device libkey, sycl::queue &queue, oneapi::math::side side, oneapi::math::uplo uplo,
