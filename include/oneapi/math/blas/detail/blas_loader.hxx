...
ONEMATH_EXPORT sycl::event herk(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event scal(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event trmv(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event tpmv(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, diag unit_diag,
...
ONEMATH_EXPORT sycl::event spr(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event syrk(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, std::int64_t n,
...
ONEMATH_EXPORT sycl::event her2(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event hbmv(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event rot(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event axpy(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event axpby(oneapi::math::device libkey, sycl::queue &queue,
                                    std::int64_t n, float alpha, const float *x, std::int64_t incx,
...
ONEMATH_EXPORT sycl::event gerc(oneapi::math::device libkey, sycl::queue &queue,
                                   std::int64_t m, std::int64_t n, std::complex<float> alpha,
                                   const std::complex<float> *x, std::int64_t incx,
                                   const std::complex<float> *y, std::int64_t incy,
                                   std::complex<float> *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event syr2k(oneapi::math::device libkey, sycl::queue &queue,
                                    uplo upper_lower, transpose trans, std::int64_t n,
                                    std::int64_t k, float alpha, const float *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event gemv(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event her(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event hpr(oneapi::math::device libkey, sycl::queue &queue,
                                  uplo upper_lower, std::int64_t n, float alpha,
                                  const std::complex<float> *x, std::int64_t incx,
                                  std::complex<float> *a,
                                  const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event iamin(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event hpmv(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, std::complex<float> alpha,
...
ONEMATH_EXPORT sycl::event spmv(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event swap(oneapi::math::device libkey, sycl::queue &queue,
                                   std::int64_t n, float *x, std::int64_t incx, float *y,
                                   std::int64_t incy,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event swap(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event geru(oneapi::math::device libkey, sycl::queue &queue,
                                   std::int64_t m, std::int64_t n, std::complex<float> alpha,
                                   const std::complex<float> *x, std::int64_t incx,
                                   const std::complex<float> *y, std::int64_t incy,
                                   std::complex<float> *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event nrm2(oneapi::math::device libkey, sycl::queue &queue,
                                   std::int64_t n, const std::complex<float> *x, std::int64_t incx,
                                   float *result,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event nrm2(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event gemmt(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event gemm(oneapi::math::device libkey, sycl::queue &queue,
                                   transpose transa, transpose transb, std::int64_t m,
                                   std::int64_t n, std::int64_t k, float alpha, const float *a,
                                   std::int64_t lda, const float *b, std::int64_t ldb, float beta,
                                   float *c, std::int64_t ldc,
...
ONEMATH_EXPORT sycl::event syr2(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, float alpha, const float *x,
...
ONEMATH_EXPORT sycl::event ger(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event trsm(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event dotu(oneapi::math::device libkey, sycl::queue &queue,
                                   std::int64_t n, const std::complex<float> *x, std::int64_t incx,
                                   const std::complex<float> *y, std::int64_t incy,
...
ONEMATH_EXPORT sycl::event hemm(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event hpr2(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, std::complex<float> alpha,
                                   const std::complex<float> *x, std::int64_t incx,
                                   const std::complex<float> *y, std::int64_t incy,
                                   std::complex<float> *a,
...
ONEMATH_EXPORT sycl::event gbmv(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event tbmv(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, diag unit_diag,
...
ONEMATH_EXPORT sycl::event symm(oneapi::math::device libkey, sycl::queue &queue,
                                   side left_right, uplo upper_lower, std::int64_t m,
...
ONEMATH_EXPORT sycl::event dotc(oneapi::math::device libkey, sycl::queue &queue,
                                   std::int64_t n, const std::complex<float> *x, std::int64_t incx,
                                   const std::complex<float> *y, std::int64_t incy,
                                   std::complex<float> *result,
                                   const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event syr(oneapi::math::device libkey, sycl::queue &queue,
                                  uplo upper_lower, std::int64_t n, float alpha, const float *x,
...
ONEMATH_EXPORT sycl::event trmm(oneapi::math::device libkey, sycl::queue &queue,
                                   side left_right, uplo upper_lower, transpose trans,
                                   diag unit_diag, std::int64_t m, std::int64_t n, float alpha,
                                   const float *a, std::int64_t lda, float *b, std::int64_t ldb,
                                   const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event symv(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, float alpha, const float *a,
...
ONEMATH_EXPORT sycl::event tpsv(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, diag unit_diag,
                                   std::int64_t n, const float *a, float *x, std::int64_t incx,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event tpsv(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event trsv(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, diag unit_diag,
                                   std::int64_t n, const float *a, std::int64_t lda, float *x,
                                   std::int64_t incx,
                                   const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event copy(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event hemv(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, std::complex<float> alpha,
                                   const std::complex<float> *a, std::int64_t lda,
                                   const std::complex<float> *x, std::int64_t incx,
                                   std::complex<float> beta, std::complex<float> *y,
...
ONEMATH_EXPORT sycl::event iamax(oneapi::math::device libkey, sycl::queue &queue,
                                    std::int64_t n, const float *x, std::int64_t incx,
                                    std::int64_t *result,
                                    const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event iamax(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event sbmv(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event asum(oneapi::math::device libkey, sycl::queue &queue,
                                   std::int64_t n, const std::complex<float> *x, std::int64_t incx,
                                   float *result,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event asum(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event tbsv(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, diag unit_diag,
                                   std::int64_t n, std::int64_t k, const float *a, std::int64_t lda,
                                   float *x, std::int64_t incx,
                                   const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event spr2(oneapi::math::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, float alpha, const float *x,
                                   std::int64_t incx, const float *y, std::int64_t incy, float *a,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event spr2(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event rotm(oneapi::math::device libkey, sycl::queue &queue,
                                   std::int64_t n, float *x, std::int64_t incx, float *y,
...
ONEMATH_EXPORT sycl::event dot(oneapi::math::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event sdsdot(oneapi::math::device libkey, sycl::queue &queue,
                                     std::int64_t n, float sb, const float *x, std::int64_t incx,
                                     const float *y, std::int64_t incy, float *result,
                                     const std::vector<sycl::event> &dependencies = {});

ONEMATH_EXPORT sycl::event her2k(oneapi::math::device libkey, sycl::queue &queue,
                                    uplo upper_lower, transpose trans, std::int64_t n,
                                    std::int64_t k, std::complex<float> alpha,
                                    const std::complex<float> *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event rotg(oneapi::math::device libkey, sycl::queue &queue, float *a,
...
ONEMATH_EXPORT sycl::event omatcopy(oneapi::math::device libkey, sycl::queue &queue, transpose trans,
...
ONEMATH_EXPORT sycl::event omatcopy2(oneapi::math::device libkey, sycl::queue &queue, transpose trans,
                                    std::int64_t m, std::int64_t n, float alpha, const float *a,
...
ONEMATH_EXPORT sycl::event imatcopy(oneapi::math::device libkey, sycl::queue &queue, transpose trans,
...
ONEMATH_EXPORT sycl::event omatadd(oneapi::math::device libkey, sycl::queue &queue, transpose transa,
                                  transpose transb, std::int64_t m, std::int64_t n, float alpha,
