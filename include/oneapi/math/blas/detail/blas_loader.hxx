...
ONEMATH_EXPORT void herk(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void scal(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
...
ONEMATH_EXPORT void trmv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void tpmv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        transpose trans, diag unit_diag, std::int64_t n,
...
ONEMATH_EXPORT void spr(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void gemm_batch(oneapi::mkl::device libkey, sycl::queue &queue, transpose transa,
...
ONEMATH_EXPORT void syrk(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        transpose trans, std::int64_t n, std::int64_t k, float alpha,
...
ONEMATH_EXPORT void syrk_batch(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                              transpose trans, std::int64_t n, std::int64_t k, float alpha,
                              sycl::buffer<float, 1> &a, std::int64_t lda,
...
ONEMATH_EXPORT void her2(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void hbmv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void rot(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                       sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
...
ONEMATH_EXPORT void axpy(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        float alpha, sycl::buffer<float, 1> &x, std::int64_t incx,
...
ONEMATH_EXPORT void axpy_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                              float alpha, sycl::buffer<float, 1> &x, std::int64_t incx,
...
ONEMATH_EXPORT void axpby(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
...
ONEMATH_EXPORT void gerc(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                        std::int64_t n, std::complex<float> alpha,
                        sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                        sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
                        sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda);
...
ONEMATH_EXPORT void syr2k(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                         transpose trans, std::int64_t n, std::int64_t k, float alpha,
                         sycl::buffer<float, 1> &a, std::int64_t lda,
...
ONEMATH_EXPORT void gemv(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
...
ONEMATH_EXPORT void gemv_batch(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
...
ONEMATH_EXPORT void her(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void hpr(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                       std::int64_t n, float alpha, sycl::buffer<std::complex<float>, 1> &x,
                       std::int64_t incx, sycl::buffer<std::complex<float>, 1> &a);
ONEMATH_EXPORT void hpr(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                       std::int64_t n, double alpha, sycl::buffer<std::complex<double>, 1> &x,
...
ONEMATH_EXPORT void gemm_bias(oneapi::mkl::device libkey, sycl::queue &queue, transpose transa,
...
ONEMATH_EXPORT void iamin(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                         sycl::buffer<float, 1> &x, std::int64_t incx,
...
ONEMATH_EXPORT void hpmv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        std::int64_t n, std::complex<float> alpha,
                        sycl::buffer<std::complex<float>, 1> &a,
                        sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                        std::complex<float> beta, sycl::buffer<std::complex<float>, 1> &y,
...
ONEMATH_EXPORT void spmv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void rotmg(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT void swap(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        sycl::buffer<float, 1> &x, std::int64_t incx,
                        sycl::buffer<float, 1> &y, std::int64_t incy);
ONEMATH_EXPORT void swap(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        sycl::buffer<double, 1> &x, std::int64_t incx,
...
ONEMATH_EXPORT void geru(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                        std::int64_t n, std::complex<float> alpha,
                        sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                        sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
                        sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda);
...
ONEMATH_EXPORT void nrm2(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
...
ONEMATH_EXPORT void gemmt(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void gemm(oneapi::mkl::device libkey, sycl::queue &queue, transpose transa,
                        transpose transb, std::int64_t m, std::int64_t n, std::int64_t k,
                        float alpha, sycl::buffer<float, 1> &a, std::int64_t lda,
                        sycl::buffer<float, 1> &b, std::int64_t ldb, float beta,
                        sycl::buffer<float, 1> &c, std::int64_t ldc);
...
ONEMATH_EXPORT void syr2(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
...
ONEMATH_EXPORT void ger(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
                       std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
                       std::int64_t incx, sycl::buffer<float, 1> &y, std::int64_t incy,
                       sycl::buffer<float, 1> &a, std::int64_t lda);
ONEMATH_EXPORT void ger(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t m,
...
ONEMATH_EXPORT void dotu(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                        sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
...
ONEMATH_EXPORT void hpr2(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        std::int64_t n, std::complex<float> alpha,
                        sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                        sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
                        sycl::buffer<std::complex<float>, 1> &a);
...
ONEMATH_EXPORT void gbmv(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
...
ONEMATH_EXPORT void tbmv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void dotc(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                        sycl::buffer<std::complex<float>, 1> &y, std::int64_t incy,
                        sycl::buffer<std::complex<float>, 1> &result);
ONEMATH_EXPORT void dotc(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
...
ONEMATH_EXPORT void syr(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                       std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
...
ONEMATH_EXPORT void symv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        std::int64_t n, float alpha, sycl::buffer<float, 1> &a,
                        std::int64_t lda, sycl::buffer<float, 1> &x, std::int64_t incx,
                        float beta, sycl::buffer<float, 1> &y, std::int64_t incy);
ONEMATH_EXPORT void symv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void tpsv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        transpose trans, diag unit_diag, std::int64_t n,
                        sycl::buffer<float, 1> &a, sycl::buffer<float, 1> &x,
                        std::int64_t incx);
ONEMATH_EXPORT void tpsv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void trsv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        transpose trans, diag unit_diag, std::int64_t n,
                        sycl::buffer<float, 1> &a, std::int64_t lda,
                        sycl::buffer<float, 1> &x, std::int64_t incx);
ONEMATH_EXPORT void trsv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void copy(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        sycl::buffer<float, 1> &x, std::int64_t incx,
                        sycl::buffer<float, 1> &y, std::int64_t incy);
ONEMATH_EXPORT void copy(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        sycl::buffer<double, 1> &x, std::int64_t incx,
...
ONEMATH_EXPORT void copy_batch(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                              sycl::buffer<float, 1> &x, std::int64_t incx,
                              std::int64_t stridex, sycl::buffer<float, 1> &y,
                              std::int64_t incy, std::int64_t stridey, std::int64_t batch_size);
...
ONEMATH_EXPORT void hemv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        std::int64_t n, std::complex<float> alpha,
                        sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda,
                        sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                        std::complex<float> beta, sycl::buffer<std::complex<float>, 1> &y,
...
ONEMATH_EXPORT void iamax(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                         sycl::buffer<float, 1> &x, std::int64_t incx,
                         sycl::buffer<std::int64_t, 1> &result);
ONEMATH_EXPORT void iamax(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                         sycl::buffer<double, 1> &x, std::int64_t incx,
...
ONEMATH_EXPORT void sbmv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void asum(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
                        sycl::buffer<float, 1> &result);
ONEMATH_EXPORT void asum(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        sycl::buffer<std::complex<double>, 1> &x, std::int64_t incx,
...
ONEMATH_EXPORT void tbsv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        transpose trans, diag unit_diag, std::int64_t n, std::int64_t k,
                        sycl::buffer<float, 1> &a, std::int64_t lda,
                        sycl::buffer<float, 1> &x, std::int64_t incx);
ONEMATH_EXPORT void tbsv(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
...
ONEMATH_EXPORT void spr2(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                        std::int64_t n, float alpha, sycl::buffer<float, 1> &x,
                        std::int64_t incx, sycl::buffer<float, 1> &y, std::int64_t incy,
...
ONEMATH_EXPORT void rotm(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                        sycl::buffer<float, 1> &x, std::int64_t incx,
                        sycl::buffer<float, 1> &y, std::int64_t incy,
                        sycl::buffer<float, 1> &param);
ONEMATH_EXPORT void rotm(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
...
ONEMATH_EXPORT void dot(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                       sycl::buffer<float, 1> &x, std::int64_t incx,
                       sycl::buffer<float, 1> &y, std::int64_t incy,
                       sycl::buffer<float, 1> &result);
ONEMATH_EXPORT void dot(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
...
ONEMATH_EXPORT void sdsdot(oneapi::mkl::device libkey, sycl::queue &queue, std::int64_t n,
                          float sb, sycl::buffer<float, 1> &x, std::int64_t incx,
                          sycl::buffer<float, 1> &y, std::int64_t incy,
                          sycl::buffer<float, 1> &result);

ONEMATH_EXPORT void her2k(oneapi::mkl::device libkey, sycl::queue &queue, uplo upper_lower,
                         transpose trans, std::int64_t n, std::int64_t k, std::complex<float> alpha,
                         sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda,
...
ONEMATH_EXPORT void rotg(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT void omatcopy_batch(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
                                  std::int64_t m, std::int64_t n, float alpha,
                                  sycl::buffer<float, 1> &a, std::int64_t lda,
                                  std::int64_t stride_a, sycl::buffer<float, 1> &b,
                                  std::int64_t ldb, std::int64_t stride_b, std::int64_t batch_size);
...
ONEMATH_EXPORT void imatcopy_batch(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
                                  std::int64_t m, std::int64_t n, float alpha,
...
ONEMATH_EXPORT void omatadd_batch(oneapi::mkl::device libkey, sycl::queue &queue, transpose transa,
...
ONEMATH_EXPORT void omatcopy(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
                            std::int64_t m, std::int64_t n, float alpha, sycl::buffer<float, 1> &a,
                            std::int64_t lda, sycl::buffer<float, 1> &b, std::int64_t ldb);
ONEMATH_EXPORT void omatcopy(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
                            std::int64_t m, std::int64_t n, double alpha,
...
ONEMATH_EXPORT void omatcopy2(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
                             std::int64_t m, std::int64_t n, float alpha, sycl::buffer<float, 1> &a,
...
ONEMATH_EXPORT void imatcopy(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
...
ONEMATH_EXPORT void omatadd(oneapi::mkl::device libkey, sycl::queue &queue, transpose transa,
                           transpose transb, std::int64_t m, std::int64_t n, float alpha,
                           sycl::buffer<float, 1> &a, std::int64_t lda, float beta,
...
ONEMATH_EXPORT sycl::event herk(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event scal(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event trmv(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event tpmv(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, diag unit_diag,
...
ONEMATH_EXPORT sycl::event spr(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event gemm_batch(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event syrk(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, std::int64_t n,
...
ONEMATH_EXPORT sycl::event syrk_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                         uplo *upper_lower, transpose *trans, std::int64_t *n,
...
ONEMATH_EXPORT sycl::event her2(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event hbmv(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event rot(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event axpy(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event axpy_batch(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event axpby(oneapi::mkl::device libkey, sycl::queue &queue,
                                    std::int64_t n, float alpha, const float *x, std::int64_t incx,
...
ONEMATH_EXPORT sycl::event gerc(oneapi::mkl::device libkey, sycl::queue &queue,
                                   std::int64_t m, std::int64_t n, std::complex<float> alpha,
                                   const std::complex<float> *x, std::int64_t incx,
                                   const std::complex<float> *y, std::int64_t incy,
                                   std::complex<float> *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event syr2k(oneapi::mkl::device libkey, sycl::queue &queue,
                                    uplo upper_lower, transpose trans, std::int64_t n,
                                    std::int64_t k, float alpha, const float *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event gemv(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event gemv_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                         transpose trans, std::int64_t m, std::int64_t n,
...
ONEMATH_EXPORT sycl::event dgmm_batch(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event her(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event hpr(oneapi::mkl::device libkey, sycl::queue &queue,
                                  uplo upper_lower, std::int64_t n, float alpha,
                                  const std::complex<float> *x, std::int64_t incx,
                                  std::complex<float> *a,
                                  const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event iamin(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event hpmv(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, std::complex<float> alpha,
...
ONEMATH_EXPORT sycl::event spmv(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event rotmg(oneapi::mkl::device libkey, sycl::queue &queue, float *d1,
                                    float *d2, float *x1, float y1, float *param,
                                    const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event rotmg(oneapi::mkl::device libkey, sycl::queue &queue, double *d1,
                                    double *d2, double *x1, double y1, double *param,
                                    const std::vector<sycl::event> &dependencies = {});

ONEMATH_EXPORT sycl::event swap(oneapi::mkl::device libkey, sycl::queue &queue,
                                   std::int64_t n, float *x, std::int64_t incx, float *y,
                                   std::int64_t incy,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event swap(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event geru(oneapi::mkl::device libkey, sycl::queue &queue,
                                   std::int64_t m, std::int64_t n, std::complex<float> alpha,
                                   const std::complex<float> *x, std::int64_t incx,
                                   const std::complex<float> *y, std::int64_t incy,
                                   std::complex<float> *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event nrm2(oneapi::mkl::device libkey, sycl::queue &queue,
                                   std::int64_t n, const std::complex<float> *x, std::int64_t incx,
                                   float *result,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event nrm2(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event gemmt(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event gemm(oneapi::mkl::device libkey, sycl::queue &queue,
                                   transpose transa, transpose transb, std::int64_t m,
                                   std::int64_t n, std::int64_t k, float alpha, const float *a,
                                   std::int64_t lda, const float *b, std::int64_t ldb, float beta,
                                   float *c, std::int64_t ldc,
...
ONEMATH_EXPORT sycl::event gemm_bias(oneapi::mkl::device libkey, sycl::queue &queue,
                                        ...
                                        const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event gemm_bias(
    oneapi::mkl::device libkey, sycl::queue &queue, transpose transa, transpose transb,
...
ONEMATH_EXPORT sycl::event syr2(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, float alpha, const float *x,
...
ONEMATH_EXPORT sycl::event ger(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event trsm(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event trsm_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                         side left_right, uplo upper_lower, transpose trans,
...
ONEMATH_EXPORT sycl::event dotu(oneapi::mkl::device libkey, sycl::queue &queue,
                                   std::int64_t n, const std::complex<float> *x, std::int64_t incx,
                                   const std::complex<float> *y, std::int64_t incy,
...
ONEMATH_EXPORT sycl::event hemm(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event hpr2(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, std::complex<float> alpha,
                                   const std::complex<float> *x, std::int64_t incx,
                                   const std::complex<float> *y, std::int64_t incy,
                                   std::complex<float> *a,
...
ONEMATH_EXPORT sycl::event gbmv(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event tbmv(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, diag unit_diag,
...
ONEMATH_EXPORT sycl::event symm(oneapi::mkl::device libkey, sycl::queue &queue,
                                   side left_right, uplo upper_lower, std::int64_t m,
...
ONEMATH_EXPORT sycl::event dotc(oneapi::mkl::device libkey, sycl::queue &queue,
                                   std::int64_t n, const std::complex<float> *x, std::int64_t incx,
                                   const std::complex<float> *y, std::int64_t incy,
                                   std::complex<float> *result,
                                   const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event syr(oneapi::mkl::device libkey, sycl::queue &queue,
                                  uplo upper_lower, std::int64_t n, float alpha, const float *x,
...
ONEMATH_EXPORT sycl::event trmm(oneapi::mkl::device libkey, sycl::queue &queue,
                                   side left_right, uplo upper_lower, transpose trans,
                                   diag unit_diag, std::int64_t m, std::int64_t n, float alpha,
                                   const float *a, std::int64_t lda, float *b, std::int64_t ldb,
                                   const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event symv(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, float alpha, const float *a,
...
ONEMATH_EXPORT sycl::event tpsv(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, diag unit_diag,
                                   std::int64_t n, const float *a, float *x, std::int64_t incx,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event tpsv(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event trsv(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, diag unit_diag,
                                   std::int64_t n, const float *a, std::int64_t lda, float *x,
                                   std::int64_t incx,
                                   const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event copy(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event copy_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                         std::int64_t *n, const float **x, std::int64_t *incx,
...
ONEMATH_EXPORT sycl::event hemv(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, std::complex<float> alpha,
                                   const std::complex<float> *a, std::int64_t lda,
                                   const std::complex<float> *x, std::int64_t incx,
                                   std::complex<float> beta, std::complex<float> *y,
...
ONEMATH_EXPORT sycl::event iamax(oneapi::mkl::device libkey, sycl::queue &queue,
                                    std::int64_t n, const float *x, std::int64_t incx,
                                    std::int64_t *result,
                                    const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event iamax(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event sbmv(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event asum(oneapi::mkl::device libkey, sycl::queue &queue,
                                   std::int64_t n, const std::complex<float> *x, std::int64_t incx,
                                   float *result,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event asum(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event tbsv(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, transpose trans, diag unit_diag,
                                   std::int64_t n, std::int64_t k, const float *a, std::int64_t lda,
                                   float *x, std::int64_t incx,
                                   const std::vector<sycl::event> &dependencies = {});
...
ONEMATH_EXPORT sycl::event spr2(oneapi::mkl::device libkey, sycl::queue &queue,
                                   uplo upper_lower, std::int64_t n, float alpha, const float *x,
                                   std::int64_t incx, const float *y, std::int64_t incy, float *a,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event spr2(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event rotm(oneapi::mkl::device libkey, sycl::queue &queue,
                                   std::int64_t n, float *x, std::int64_t incx, float *y,
...
ONEMATH_EXPORT sycl::event dot(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event sdsdot(oneapi::mkl::device libkey, sycl::queue &queue,
                                     std::int64_t n, float sb, const float *x, std::int64_t incx,
                                     const float *y, std::int64_t incy, float *result,
                                     const std::vector<sycl::event> &dependencies = {});

ONEMATH_EXPORT sycl::event her2k(oneapi::mkl::device libkey, sycl::queue &queue,
                                    uplo upper_lower, transpose trans, std::int64_t n,
                                    std::int64_t k, std::complex<float> alpha,
                                    const std::complex<float> *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event rotg(oneapi::mkl::device libkey, sycl::queue &queue, float *a,
                                   float *b, float *c, float *s,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event rotg(oneapi::mkl::device libkey, sycl::queue &queue, double *a,
                                   double *b, double *c, double *s,
                                   const std::vector<sycl::event> &dependencies = {});
ONEMATH_EXPORT sycl::event rotg(oneapi::mkl::device libkey, sycl::queue &queue,
...
ONEMATH_EXPORT sycl::event omatcopy_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                         transpose trans, std::int64_t m, std::int64_t n,
                                         float alpha, const float *a, std::int64_t lda,
...
ONEMATH_EXPORT sycl::event imatcopy_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                         transpose trans, std::int64_t m, std::int64_t n,
...
ONEMATH_EXPORT sycl::event omatadd_batch(oneapi::mkl::device libkey, sycl::queue &queue,
                                        transpose transa, transpose transb, std::int64_t m,
...
ONEMATH_EXPORT sycl::event omatcopy(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
...
ONEMATH_EXPORT sycl::event omatcopy2(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
                                    std::int64_t m, std::int64_t n, float alpha, const float *a,
...
ONEMATH_EXPORT sycl::event imatcopy(oneapi::mkl::device libkey, sycl::queue &queue, transpose trans,
...
ONEMATH_EXPORT sycl::event omatadd(oneapi::mkl::device libkey, sycl::queue &queue, transpose transa,
                                  transpose transb, std::int64_t m, std::int64_t n, float alpha,
