...
ONEMKL_EXPORT void symm(cl::sycl::queue &queue, onemkl::side left_right, onemkl::uplo upper_lower,
...
ONEMKL_EXPORT void hemm(cl::sycl::queue &queue, onemkl::side left_right, onemkl::uplo upper_lower,
                        std::int64_t m, std::int64_t n, std::complex<float> alpha,
                        cl::sycl::buffer<std::complex<float>, 1> &a, std::int64_t lda,
                        cl::sycl::buffer<std::complex<float>, 1> &b, std::int64_t ldb,
                        std::complex<float> beta, cl::sycl::buffer<std::complex<float>, 1> &c,
...
ONEMKL_EXPORT void syrk(cl::sycl::queue &queue, onemkl::uplo upper_lower, onemkl::transpose trans,
...
ONEMKL_EXPORT void herk(cl::sycl::queue &queue, onemkl::uplo upper_lower, onemkl::transpose trans,
...
ONEMKL_EXPORT void gbmv(cl::sycl::queue &queue, onemkl::transpose trans, std::int64_t m,
...
ONEMKL_EXPORT void hbmv(cl::sycl::queue &queue, onemkl::uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void her(cl::sycl::queue &queue, onemkl::uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void hpr(cl::sycl::queue &queue, onemkl::uplo upper_lower, std::int64_t n,
                       float alpha, cl::sycl::buffer<std::complex<float>, 1> &x, std::int64_t incx,
...
ONEMKL_EXPORT void sbmv(cl::sycl::queue &queue, onemkl::uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void symv(cl::sycl::queue &queue, onemkl::uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void syr(cl::sycl::queue &queue, onemkl::uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void syr2(cl::sycl::queue &queue, onemkl::uplo upper_lower, std::int64_t n,
                        float alpha, cl::sycl::buffer<float, 1> &x, std::int64_t incx,
                        cl::sycl::buffer<float, 1> &y, std::int64_t incy,
                        cl::sycl::buffer<float, 1> &a, std::int64_t lda);
...
ONEMKL_EXPORT void spmv(cl::sycl::queue &queue, onemkl::uplo upper_lower, std::int64_t n,
...
ONEMKL_EXPORT void spr(cl::sycl::queue &queue, onemkl::uplo upper_lower, std::int64_t n,
                       float alpha, cl::sycl::buffer<float, 1> &x, std::int64_t incx,
...
ONEMKL_EXPORT void spr2(cl::sycl::queue &queue, onemkl::uplo upper_lower, std::int64_t n,
                        float alpha, cl::sycl::buffer<float, 1> &x, std::int64_t incx,
                        cl::sycl::buffer<float, 1> &y, std::int64_t incy,
                        cl::sycl::buffer<float, 1> &a);
...
ONEMKL_EXPORT void trsm_batch(cl::sycl::queue &queue, onemkl::side left_right,
                              onemkl::uplo upper_lower, onemkl::transpose trans,
                              onemkl::diag unit_diag, std::int64_t m, std::int64_t n, double alpha,
                              cl::sycl::buffer<double, 1> &a, std::int64_t lda,
...
ONEMKL_EXPORT void gemm_ext(cl::sycl::queue &queue, onemkl::transpose transa,
                            onemkl::transpose transb, std::int64_t m, std::int64_t n,
