...
*       an Intel CPU SYCL device with Unified Shared Memory(USM) API.
*
...
bool run_uniform_example(const sycl::device &dev) {
    ...
    oneapi::mkl::rng::default_engine engine(oneapi::mkl::backend_selector<oneapi::mkl::backend::mklcpu> {queue}, seed);
...
int main (int argc, char ** argv) {
    ...
    if (my_dev.is_cpu()) std::cout << "Running tests on CPU device. Device name is: " << my_dev.get_info<sycl::info::device::name>() << ".\n";
